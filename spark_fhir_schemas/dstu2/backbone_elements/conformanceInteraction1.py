...
class ConformanceInteraction1Schema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.extension import ExtensionSchema
        from spark_fhir_schemas.dstu2.complex_types.systemrestfulinteractioncode import (
        ...
        if (
            max_recursion_limit
            and nesting_list.count("ConformanceInteraction1") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "code",
                    SystemRestfulInteractionCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
