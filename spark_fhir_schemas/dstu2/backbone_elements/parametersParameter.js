...
class ParametersParameter extends Element {
     ...
     * @param {ElementDefinition|undefined} [valueElementDefinition],
    ...
    */
    ...
    processing a resource are required to check for modifier extensions.
        ...
        */
        ...
        /**
         * @description None
         * @property {ElementDefinition|undefined}
        */
        Object.defineProperty(this, 'valueElementDefinition', {
            // https://www.w3schools.com/js/js_object_es5.asp
            enumerable: true,
            configurable: true,
            get: () => this.__data.valueElementDefinition,
            set: valueProvided => {
                if (valueProvided === undefined || valueProvided === null || (Array.isArray(valueProvided) && valueProvided.length === 0)) {
                    return;
                }
                let ElementDefinition = require('../complex_types/elementDefinition.js');
                this.__data.valueElementDefinition = new ElementDefinition(valueProvided);
            }
        });
        ...
        */
        ...
        /**
         * @description A named part of a parameter. In many implementation context, a set of named
        ...
        */
        Object.defineProperty(this, 'part', {
            ...
            set: valueProvided => {
                ...
                this.__data.part = Array.isArray(valueProvided) ? valueProvided.map(v => new ParametersParameter(v)) : [new ParametersParameter(valueProvided)];
            }
        });
