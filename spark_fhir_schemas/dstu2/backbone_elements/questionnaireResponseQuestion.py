...
class QuestionnaireResponseQuestionSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        linkId: Identifies the question from the Questionnaire that corresponds to this
    question in the QuestionnaireResponse resource.
        ...
        my_nesting_list: List[str] = nesting_list+["QuestionnaireResponseQuestion"]
        schema = StructType(
            [
                # None
