...
class ImagingObjectSelection.FramesSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        frameNumbers: The frame numbers in the frame set.
        url: WADO-RS URL to retrieve the DICOM frames.
        """
        # id
        ...
        if (max_recursion_limit and nesting_list.count("ImagingObjectSelectionFrames") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list+["ImagingObjectSelectionFrames"]
        schema = StructType(
            [
                # None
                ...
                StructField("frameNumbers", unsignedIntSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
