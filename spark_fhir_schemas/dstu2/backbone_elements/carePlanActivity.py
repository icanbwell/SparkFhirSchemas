...
class CarePlanActivitySchema:
    ...
    processing a resource are required to check for modifier extensions.
        actionResulting: Resources that describe follow-on actions resulting from the plan, such as
    ...
    procedure etc.
        ...
        # detail
        from spark_fhir_schemas.dstu2.backbone_elements.careplandetail import CarePlanDetailSchema
        ...
        my_nesting_list: List[str] = nesting_list+["CarePlanActivity"]
        schema = StructType(
            [
                # None
                ...
                # drug prescriptions, encounter records, appointments, etc.
                StructField("actionResulting", ReferenceSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Notes about the adherence/status/progress of the activity.
                StructField("progress", AnnotationSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
