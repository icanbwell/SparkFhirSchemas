...
class ValueSetFilterSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.extension import ExtensionSchema
        from spark_fhir_schemas.dstu2.complex_types.element import ElementSchema
        from spark_fhir_schemas.dstu2.complex_types.filteroperatorcode import (
            FilterOperatorCodeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.element import ElementSchema

        if (
            max_recursion_limit
            and nesting_list.count("ValueSetFilter") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "op",
                    FilterOperatorCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
