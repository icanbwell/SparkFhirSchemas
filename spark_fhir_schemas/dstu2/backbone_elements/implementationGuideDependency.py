...
class ImplementationGuideDependencySchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        ...
        from spark_fhir_schemas.dstu2.complex_types.extension import ExtensionSchema
        from spark_fhir_schemas.dstu2.complex_types.guidedependencytypecode import GuideDependencyTypeCodeSchema
        from spark_fhir_schemas.dstu2.complex_types.element import ElementSchema
        ...
        my_nesting_list: List[str] = nesting_list+["ImplementationGuideDependency"]
        schema = StructType(
            [
                # None
                ...
                StructField("type", GuideDependencyTypeCodeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Where the dependency is located.
                StructField("uri", ElementSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
