...
class ClaimResponseDetailSchema:
    ...
    processing a resource are required to check for modifier extensions.
        ...
        # adjudication
        from spark_fhir_schemas.dstu2.backbone_elements.claimresponseadjudication1 import ClaimResponseAdjudication1Schema
        # subDetail
        from spark_fhir_schemas.dstu2.backbone_elements.claimresponsesubdetail import ClaimResponseSubDetailSchema
