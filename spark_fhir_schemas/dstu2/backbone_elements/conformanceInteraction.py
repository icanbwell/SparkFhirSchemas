...
class ConformanceInteractionSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.extension import ExtensionSchema
        from spark_fhir_schemas.dstu2.complex_types.typerestfulinteractioncode import (
            TypeRestfulInteractionCodeSchema,
        )
        from spark_fhir_schemas.dstu2.simple_types.element import ElementSchema

        if (
            max_recursion_limit
            and nesting_list.count("ConformanceInteraction") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["ConformanceInteraction"]
        schema = StructType(
            [
                # None
                StructField(
                ...
                StructField(
                    "code",
                    TypeRestfulInteractionCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
