...
class Provenance.RelatedAgentSchema:
    """
    ...
    identifier.
        ...
        if (max_recursion_limit and nesting_list.count("ProvenanceRelatedAgent") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
