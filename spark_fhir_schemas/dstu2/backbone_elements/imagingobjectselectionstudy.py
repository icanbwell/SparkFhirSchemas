...
class ImagingObjectSelectionStudySchema:
    ...
    def get_schema(
        ...
        # series
        from spark_fhir_schemas.dstu2.backbone_elements.imagingobjectselectionseries import (
            ImagingObjectSelectionSeriesSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("ImagingObjectSelectionStudy") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "series",
                    ArrayType(
                        ImagingObjectSelectionSeriesSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
