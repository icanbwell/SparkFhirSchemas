...
class Provenance.AgentSchema:
    ...
    another's behest.
        ...
        # relatedAgent
        from spark_fhir_schemas.dstu2.complex_types.provenance.relatedagent import Provenance.RelatedAgentSchema
        ...
        my_nesting_list: List[str] = nesting_list+["ProvenanceAgent"]
        schema = StructType(
            [
                # None
                ...
                StructField("actor", ReferenceSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                ...
                # For example, this human author used this device, or one person acted on
                # another's behest.
                StructField("relatedAgent", Provenance.RelatedAgentSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
