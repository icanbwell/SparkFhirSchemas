...
class ProvenanceAgentSchema:
    ...
    another's behest.
        ...
        # relatedAgent
        from spark_fhir_schemas.dstu2.backbone_elements.provenancerelatedagent import ProvenanceRelatedAgentSchema
        ...
        schema = StructType(
            [
                ...
                # For example, this human author used this device, or one person acted on
                # another's behest.
                StructField("relatedAgent", ProvenanceRelatedAgentSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
