...
class DocumentReferenceContext extends Element {
     ...
     * @param {DocumentReferenceRelated[]|undefined} [related],
    */
    constructor(
        {
            id,
        ...
        */
        Object.defineProperty(this, 'event', {
            ...
            set: valueProvided => {
                ...
                this.__data.event = Array.isArray(valueProvided) ? valueProvided.map(v => new CodeableConcept(v)) : [new CodeableConcept(valueProvided)];
            }
        });
    ...
    reference to a version specific, or contained.
        ...
        */
         ...
         * @property {DocumentReferenceRelated[]|undefined}
        */
        Object.defineProperty(this, 'related', {
            ...
            set: valueProvided => {
                ...
                let DocumentReferenceRelated = require('../backbone_elements/documentReferenceRelated.js');
                this.__data.related = Array.isArray(valueProvided) ? valueProvided.map(v => new DocumentReferenceRelated(v)) : [new DocumentReferenceRelated(valueProvided)];
            }
        });
