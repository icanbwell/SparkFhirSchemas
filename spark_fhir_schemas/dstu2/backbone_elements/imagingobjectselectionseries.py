...
class ImagingObjectSelectionSeriesSchema:
    ...
    def get_schema(
        ...
        # instance
        from spark_fhir_schemas.dstu2.backbone_elements.imagingobjectselectioninstance import (
            ImagingObjectSelectionInstanceSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "instance",
                    ArrayType(
                        ImagingObjectSelectionInstanceSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
