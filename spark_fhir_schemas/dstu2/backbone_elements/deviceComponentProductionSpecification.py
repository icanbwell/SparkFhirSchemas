...
class DeviceComponent.ProductionSpecificationSchema:
    """
    ...
    has a partition for private OID semantic that the manufacture can make use of.
        ...
        my_nesting_list: List[str] = nesting_list+["DeviceComponentProductionSpecification"]
        schema = StructType(
            [
                # None
                ...
                # hardware revision, software revision, etc.
                StructField("specType", CodeableConceptSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
