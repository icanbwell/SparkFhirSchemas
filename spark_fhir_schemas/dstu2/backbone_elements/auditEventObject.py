...
class AuditEventObjectSchema:
    ...
    a person's name.
        ...
        # detail
        from spark_fhir_schemas.dstu2.backbone_elements.auditeventdetail import AuditEventDetailSchema
        ...
        my_nesting_list: List[str] = nesting_list+["AuditEventObject"]
        schema = StructType(
            [
                # None
                ...
                # audited.
                StructField("role", CodingSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Identifier for the data life-cycle stage for the participant object.
                StructField("lifecycle", CodingSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Denotes security labels for the identified object.
                StructField("securityLabel", CodingSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # An instance-specific descriptor of the Participant Object ID audited, such as
                # a person's name.
                StructField("name", StringType(), True),
                # Text that describes the object in more detail.
                StructField("description", StringType(), True),
                # The actual query for a query-type participant object.
                StructField("query", base64BinarySchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Additional Information about the Object.
                StructField("detail", AuditEventDetailSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
