...
class HealthcareServiceAvailableTimeSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.extension import ExtensionSchema
        from spark_fhir_schemas.dstu2.complex_types.daysofweekcode import (
            DaysOfWeekCodeSchema,
        )
        ...
        if (
            max_recursion_limit
            and nesting_list.count("HealthcareServiceAvailableTime")
            >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "daysOfWeek",
                    DaysOfWeekCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
