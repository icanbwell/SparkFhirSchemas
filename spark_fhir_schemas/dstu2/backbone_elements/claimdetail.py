...
class ClaimDetailSchema:
    ...
    def get_schema(
        ...
        * factor Number  * points = net Amount. Quantity, factor and points are
        ...
        # subDetail
        from spark_fhir_schemas.dstu2.backbone_elements.claimsubdetail import (
            ClaimSubDetailSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("ClaimDetail") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "subDetail",
                    ArrayType(
                        ClaimSubDetailSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
