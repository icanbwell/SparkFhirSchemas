...
class ClaimResponseDetail1Schema:
    ...
    processing a resource are required to check for modifier extensions.
        ...
        # adjudication
        from spark_fhir_schemas.dstu2.backbone_elements.claimresponseadjudication4 import ClaimResponseAdjudication4Schema
        ...
        my_nesting_list: List[str] = nesting_list+["ClaimResponseDetail1"]
        schema = StructType(
            [
                # None
                ...
                StructField("adjudication", ClaimResponseAdjudication4Schema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
