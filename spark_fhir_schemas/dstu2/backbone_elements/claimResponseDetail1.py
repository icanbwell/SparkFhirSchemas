...
class ClaimResponse.Detail1Schema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        ...
        # adjudication
        from spark_fhir_schemas.dstu2.complex_types.claimresponse.adjudication4 import ClaimResponse.Adjudication4Schema
