...
class PersonLinkSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.identityassurancelevelcode import (
            IdentityAssuranceLevelCodeSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("PersonLink") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "assurance",
                    IdentityAssuranceLevelCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
