...
class ClaimMissingTeethSchema:
    ...
    processing a resource are required to check for modifier extensions.
        ...
        reason: Missing reason may be: E-extraction, O-other.
    ...
    estimate.
        ...
        my_nesting_list: List[str] = nesting_list+["ClaimMissingTeeth"]
        schema = StructType(
            [
                # None
                ...
                StructField("tooth", CodingSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Missing reason may be: E-extraction, O-other.
                StructField("reason", CodingSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # The date of the extraction either known from records or patient reported
                # estimate.
                StructField("extractionDate", ElementSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
