...
class ImagingObjectSelectionInstanceSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        ...
        # frames
        from spark_fhir_schemas.dstu2.backbone_elements.imagingobjectselectionframes import ImagingObjectSelectionFramesSchema
        ...
        my_nesting_list: List[str] = nesting_list+["ImagingObjectSelectionInstance"]
        schema = StructType(
            [
                # None
