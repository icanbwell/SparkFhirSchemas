...
class CarePlanRelatedPlanSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        code: Identifies the type of relationship this plan has to the target plan.
        plan: A reference to the plan to which a relationship is asserted.
        """
            # id
        ...
        if (max_recursion_limit and nesting_list.count("CarePlanRelatedPlan") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list+["CarePlanRelatedPlan"]
        schema = StructType(
            [
                # None
                ...
                StructField("code", CarePlanRelationshipSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
