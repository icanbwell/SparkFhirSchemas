...
class EncounterLocationSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.encounterlocationstatuscode import (
            EncounterLocationStatusCodeSchema,
        )
        ...
        my_nesting_list: List[str] = nesting_list + ["EncounterLocation"]
        schema = StructType(
            [
                # None
                StructField(
                ...
                StructField(
                    "status",
                    EncounterLocationStatusCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
