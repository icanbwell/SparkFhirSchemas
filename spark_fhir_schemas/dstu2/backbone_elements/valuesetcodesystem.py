...
class ValueSetCodeSystemSchema:
    """
    ...
    def get_schema(
        ...
        processing a resource are required to check for modifier extensions.
            system: An absolute URI that is used to reference this code system, including in
        [Coding]{datatypes.html#Coding}.system.
            version: The version of this code system that defines the codes. Note that the version
        ...
        # concept
        from spark_fhir_schemas.dstu2.backbone_elements.valuesetconcept import (
            ValueSetConceptSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("ValueSetCodeSystem") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["ValueSetCodeSystem"]
        schema = StructType(
            [
                # None
                StructField(
