...
class Specimen.CollectionSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        ...
        comment: To communicate any details or issues encountered during the specimen
    collection procedure.
        collectedDateTime: None
        collectedPeriod: None
    ...
    specimens.
        ...
        my_nesting_list: List[str] = nesting_list+["SpecimenCollection"]
        schema = StructType(
            [
                # None
                ...
                StructField("collector", ReferenceSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # To communicate any details or issues encountered during the specimen
                # collection procedure.
                StructField("comment", StringType(), True),
                # None
                StructField("collectedDateTime", dateTimeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # None
