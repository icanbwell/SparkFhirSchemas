...
class AppointmentParticipantSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.participantrequiredcode import (
            ParticipantRequiredCodeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.participationstatuscode import (
            ParticipationStatusCodeSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "required",
                    ParticipantRequiredCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "status",
                    ParticipationStatusCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
