...
class OperationOutcomeIssueSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.extension import ExtensionSchema
        from spark_fhir_schemas.dstu2.complex_types.issueseveritycode import (
            IssueSeverityCodeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.issuetypecode import (
            IssueTypeCodeSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "severity",
                    IssueSeverityCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "code",
                    IssueTypeCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
