...
class NutritionOrderEnteralFormulaSchema:
    ...
    instructions or information.
        ...
        # administration
        from spark_fhir_schemas.dstu2.backbone_elements.nutritionorderadministration import NutritionOrderAdministrationSchema
        ...
        my_nesting_list: List[str] = nesting_list+["NutritionOrderEnteralFormula"]
        schema = StructType(
            [
                # None
                ...
                # gastrointestinal  tract for purposes of providing the formula feeding, e.g.
                # nasogastric tube.
                StructField("routeofAdministration", CodeableConceptSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
