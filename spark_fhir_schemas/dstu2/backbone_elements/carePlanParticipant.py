...
class CarePlan.ParticipantSchema:
    """
    ...
    participate in the care plan.
        ...
        if (max_recursion_limit and nesting_list.count("CarePlanParticipant") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
