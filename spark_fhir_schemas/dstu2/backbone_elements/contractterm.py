...
class ContractTermSchema:
    ...
    def get_schema(
        ...
        # actor
        from spark_fhir_schemas.dstu2.backbone_elements.contractactor1 import (
            ContractActor1Schema,
        )

        # valuedItem
        from spark_fhir_schemas.dstu2.backbone_elements.contractvalueditem1 import (
            ContractValuedItem1Schema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "actor",
                    ContractActor1Schema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "valuedItem",
                    ContractValuedItem1Schema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
