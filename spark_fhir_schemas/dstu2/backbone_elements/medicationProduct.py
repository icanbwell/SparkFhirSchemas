...
class Medication.ProductSchema:
    """
    ...
    production run.
        ...
        # ingredient
        from spark_fhir_schemas.dstu2.complex_types.medication.ingredient import Medication.IngredientSchema
        # batch
        from spark_fhir_schemas.dstu2.complex_types.medication.batch import Medication.BatchSchema
        ...
        schema = StructType(
            [
                ...
                StructField("ingredient", Medication.IngredientSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Information about a group of medication produced or packaged from one
                # production run.
                StructField("batch", Medication.BatchSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
