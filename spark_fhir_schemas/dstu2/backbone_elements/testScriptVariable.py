...
class TestScriptVariableSchema:
    """
    ...
    sourceId is pointing to.
        path: XPath or JSONPath against the fixture body.  When variables are defined,
    ...
    within this variable.
        ...
        my_nesting_list: List[str] = nesting_list+["TestScriptVariable"]
        schema = StructType(
            [
                # None
