...
class TestScript.MetadataSchema:
    """
    ...
    server being tested.
        ...
        # link
        from spark_fhir_schemas.dstu2.complex_types.testscript.link import TestScript.LinkSchema
        # capability
        from spark_fhir_schemas.dstu2.complex_types.testscript.capability import TestScript.CapabilitySchema
        ...
        schema = StructType(
            [
                ...
                StructField("link", TestScript.LinkSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Capabilities that must exist and are assumed to function correctly on the FHIR
                # server being tested.
                StructField("capability", TestScript.CapabilitySchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
