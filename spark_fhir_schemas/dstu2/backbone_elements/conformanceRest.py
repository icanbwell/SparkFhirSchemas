...
class ConformanceRestSchema:
    ...
    by the system.
        ...
        # resource
        from spark_fhir_schemas.dstu2.backbone_elements.conformanceresource import ConformanceResourceSchema
        # interaction
        from spark_fhir_schemas.dstu2.backbone_elements.conformanceinteraction1 import ConformanceInteraction1Schema
        # searchParam
        from spark_fhir_schemas.dstu2.backbone_elements.conformancesearchparam import ConformanceSearchParamSchema
        # operation
        from spark_fhir_schemas.dstu2.backbone_elements.conformanceoperation import ConformanceOperationSchema
        # compartment
