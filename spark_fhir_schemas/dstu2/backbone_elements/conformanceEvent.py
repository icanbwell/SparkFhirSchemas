...
class ConformanceEventSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.messagesignificancecategorycode import (
            MessageSignificanceCategoryCodeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.conformanceeventmodecode import (
            ConformanceEventModeCodeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.element import ElementSchema
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "category",
                    MessageSignificanceCategoryCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "mode",
                    ConformanceEventModeCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
