...
class DocumentReference.RelatedSchema:
    """
    ...
    they shall refer to the same thing.
        ...
        if (max_recursion_limit and nesting_list.count("DocumentReferenceRelated") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list+["DocumentReferenceRelated"]
        schema = StructType(
            [
                # None
                ...
                # they shall refer to the same thing.
                StructField("ref", ReferenceSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
