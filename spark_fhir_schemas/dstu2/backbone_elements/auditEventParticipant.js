...
AuditEvent.Participant
    ...
    usage.
*/
class AuditEventParticipant extends Element {
    /**
     ...
     * @param {Coding[]|undefined} [purposeOfUse],
    */
    constructor(
        {
            id,
    ...
    processing a resource are required to check for modifier extensions.
        ...
        */
        ...
        /**
         * @description Specification of the role(s) the user plays when performing the event. Usually
    ...
    access control security system used in the local context.
        ...
        */
        ...
        /**
         * @description Alternative Participant Identifier. For a human, this should be a user
    ...
    network location.
        ...
        */
        ...
        /**
         * @description The reason (purpose of use), specific to this participant, that was used
        ...
        */
        Object.defineProperty(this, 'purposeOfUse', {
            ...
            set: valueProvided => {
                ...
                let Coding = require('../complex_types/coding.js');
                this.__data.purposeOfUse = Array.isArray(valueProvided) ? valueProvided.map(v => new Coding(v)) : [new Coding(valueProvided)];
            }
        });
