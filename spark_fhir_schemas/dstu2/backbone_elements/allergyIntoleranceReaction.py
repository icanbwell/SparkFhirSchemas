...
class AllergyIntoleranceReactionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.allergyintolerancecertaintycode import (
            AllergyIntoleranceCertaintyCodeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.codeableconcept import (
            CodeableConceptSchema,
        )
        ...
        from spark_fhir_schemas.dstu2.complex_types.element import ElementSchema
        from spark_fhir_schemas.dstu2.complex_types.allergyintoleranceseveritycode import (
            AllergyIntoleranceSeverityCodeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.codeableconcept import (
            CodeableConceptSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "certainty",
                    AllergyIntoleranceCertaintyCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "severity",
                    AllergyIntoleranceSeverityCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
