...
class ProvenanceEntitySchema:
    ...
    def get_schema(
        ...
        # agent
        from spark_fhir_schemas.dstu2.backbone_elements.provenanceagent import (
            ProvenanceAgentSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("ProvenanceEntity") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "agent",
                    ProvenanceAgentSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
