...
class DocumentReference.ContentSchema:
    """
    ...
    document conforms to beyond the base format indicated in the mimeType.
        ...
        my_nesting_list: List[str] = nesting_list+["DocumentReferenceContent"]
        schema = StructType(
            [
                # None
                ...
                # content has integrity.
                StructField("attachment", AttachmentSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # An identifier of the document encoding, structure, and template that the
                # document conforms to beyond the base format indicated in the mimeType.
                StructField("format", CodingSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
