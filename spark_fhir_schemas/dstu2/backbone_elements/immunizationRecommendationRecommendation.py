...
class ImmunizationRecommendationRecommendationSchema:
    ...
    def get_schema(
        ...
        # dateCriterion
        from spark_fhir_schemas.dstu2.backbone_elements.immunizationrecommendationdatecriterion import (
            ImmunizationRecommendationDateCriterionSchema,
        )

        # protocol
        from spark_fhir_schemas.dstu2.backbone_elements.immunizationrecommendationprotocol import (
            ImmunizationRecommendationProtocolSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "dateCriterion",
                    ImmunizationRecommendationDateCriterionSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "protocol",
                    ImmunizationRecommendationProtocolSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
