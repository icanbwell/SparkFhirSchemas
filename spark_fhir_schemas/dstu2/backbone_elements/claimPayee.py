...
class Claim.PayeeSchema:
    ...
    processing a resource are required to check for modifier extensions.
        ...
        provider: The provider who is to be reimbursed for the claim (the party to whom any
    benefit is assigned).
        organization: The organization who is to be reimbursed for the claim (the party to whom any
    benefit is assigned).
    ...
    (the party to whom any benefit is assigned).
        ...
        my_nesting_list: List[str] = nesting_list+["ClaimPayee"]
        schema = StructType(
            [
                # None
                ...
                # The person other than the subscriber who is to be reimbursed for the claim
                # (the party to whom any benefit is assigned).
                StructField("person", ReferenceSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
