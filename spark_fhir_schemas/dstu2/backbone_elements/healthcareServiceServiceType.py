...
class HealthcareService.ServiceTypeSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        type: The specific type of service being delivered or performed.
    ...
    medical term.
        ...
        if (max_recursion_limit and nesting_list.count("HealthcareServiceServiceType") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list+["HealthcareServiceServiceType"]
        schema = StructType(
            [
                # None
