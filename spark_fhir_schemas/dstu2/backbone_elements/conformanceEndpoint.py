...
class ConformanceEndpointSchema:
    """
    ...
    addresses for routing, it can be just an identifier.
        ...
        my_nesting_list: List[str] = nesting_list+["ConformanceEndpoint"]
        schema = StructType(
            [
                # None
                ...
                # endpoint.
                StructField("protocol", CodingSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # The network address of the end-point. For solutions that do not use network
                # addresses for routing, it can be just an identifier.
                StructField("address", ElementSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
