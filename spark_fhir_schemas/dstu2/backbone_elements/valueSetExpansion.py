...
class ValueSetExpansionSchema:
    ...
    suitable for a particular purpose, or to pick the correct expansion.
        ...
        # parameter
        from spark_fhir_schemas.dstu2.backbone_elements.valuesetparameter import ValueSetParameterSchema
        # contains
        from spark_fhir_schemas.dstu2.backbone_elements.valuesetcontains import ValueSetContainsSchema
        ...
        my_nesting_list: List[str] = nesting_list+["ValueSetExpansion"]
        schema = StructType(
            [
                # None
                ...
                # may re-use the same identifier as long as the expansion and the definition
                # remain the same, but are not required to do so.
                StructField("identifier", uriSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
