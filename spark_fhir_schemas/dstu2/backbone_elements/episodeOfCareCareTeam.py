...
class EpisodeOfCare.CareTeamSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        role: The role this team member is taking within this episode of care.
        period: The period of time this practitioner is performing some role within the
    episode of care.
        member: The practitioner (or Organization) within the team.
        """
        # id
        ...
        if (max_recursion_limit and nesting_list.count("EpisodeOfCareCareTeam") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list+["EpisodeOfCareCareTeam"]
        schema = StructType(
            [
                # None
                ...
                StructField("member", ReferenceSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
