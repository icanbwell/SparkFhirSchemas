...
class NutritionOrder.OralDietSchema:
    """
    ...
    diet.
        ...
        # nutrient
        from spark_fhir_schemas.dstu2.complex_types.nutritionorder.nutrient import NutritionOrder.NutrientSchema
        # texture
        from spark_fhir_schemas.dstu2.complex_types.nutritionorder.texture import NutritionOrder.TextureSchema
        # instruction
        # type = string
        ...
        schema = StructType(
            [
                ...
                # for the oral diet.
                StructField("nutrient", NutritionOrder.NutrientSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Class that describes any texture modifications required for the patient to
                # safely consume various types of solid foods.
                StructField("texture", NutritionOrder.TextureSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
