...
class CarePlanActivitySchema:
    ...
    def get_schema(
        ...
        # detail
        from spark_fhir_schemas.dstu2.backbone_elements.careplandetail import (
            CarePlanDetailSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("CarePlanActivity") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "detail",
                    CarePlanDetailSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
