...
class ContractTermSchema:
    ...
    contract term for specific valued item, e.g. disability payment.
        ...
        # actor
        from spark_fhir_schemas.dstu2.backbone_elements.contractactor1 import ContractActor1Schema
        # valuedItem
        from spark_fhir_schemas.dstu2.backbone_elements.contractvalueditem1 import ContractValuedItem1Schema
