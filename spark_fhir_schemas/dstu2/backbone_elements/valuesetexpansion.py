...
class ValueSetExpansionSchema:
    ...
    def get_schema(
        ...
        # parameter
        from spark_fhir_schemas.dstu2.backbone_elements.valuesetparameter import (
            ValueSetParameterSchema,
        )

        # contains
        from spark_fhir_schemas.dstu2.backbone_elements.valuesetcontains import (
            ValueSetContainsSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("ValueSetExpansion") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "parameter",
                    ValueSetParameterSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
