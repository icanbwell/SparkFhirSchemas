    ...
    not be adjudicated.
        ...
        schema = StructType(
            [
                ...
                # contains the error. This value is omitted when the error is not related to an
                # Addition.
                StructField("detailSequenceLinkId", ElementSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # The sequence number of the addition within the line item submitted which
                # contains the error. This value is omitted when the error is not related to an
                # Addition.
                StructField("subdetailSequenceLinkId", ElementSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
