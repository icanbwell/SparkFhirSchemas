...
class ImplementationGuidePackageSchema:
    ...
    def get_schema(
        ...
        # resource
        from spark_fhir_schemas.dstu2.backbone_elements.implementationguideresource import (
            ImplementationGuideResourceSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("ImplementationGuidePackage") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "resource",
                    ArrayType(
                        ImplementationGuideResourceSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
