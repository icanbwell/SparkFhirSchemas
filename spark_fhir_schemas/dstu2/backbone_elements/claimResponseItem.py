...
class ClaimResponseItemSchema:
    ...
    processing a resource are required to check for modifier extensions.
        ...
        # adjudication
        from spark_fhir_schemas.dstu2.backbone_elements.claimresponseadjudication import ClaimResponseAdjudicationSchema
        # detail
        from spark_fhir_schemas.dstu2.backbone_elements.claimresponsedetail import ClaimResponseDetailSchema
        ...
        schema = StructType(
            [
                ...
                StructField("adjudication", ClaimResponseAdjudicationSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # The second tier service adjudications for submitted services.
                StructField("detail", ClaimResponseDetailSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
