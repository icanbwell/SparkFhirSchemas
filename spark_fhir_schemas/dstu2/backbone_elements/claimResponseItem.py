...
class ClaimResponse.ItemSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        ...
        # adjudication
        from spark_fhir_schemas.dstu2.complex_types.claimresponse.adjudication import ClaimResponse.AdjudicationSchema
        # detail
        from spark_fhir_schemas.dstu2.complex_types.claimresponse.detail import ClaimResponse.DetailSchema
        if (max_recursion_limit and nesting_list.count("ClaimResponseItem") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list+["ClaimResponseItem"]
        schema = StructType(
            [
                # None
                ...
                StructField("noteNumber", positiveIntSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # The adjudications results.
                StructField("adjudication", ClaimResponse.AdjudicationSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # The second tier service adjudications for submitted services.
                StructField("detail", ClaimResponse.DetailSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
