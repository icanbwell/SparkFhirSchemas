...
class AuditEventNetworkSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.auditeventparticipantnetworktypecode import (
            AuditEventParticipantNetworkTypeCodeSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("AuditEventNetwork") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "type",
                    AuditEventParticipantNetworkTypeCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
