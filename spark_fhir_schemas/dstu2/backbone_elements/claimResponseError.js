...
class ClaimResponseError extends Element {
     ...
     * @param {Int|undefined} [detailSequenceLinkId],
     * @param {Int|undefined} [subdetailSequenceLinkId],
     * @param {Coding} code,
    */
    constructor(
        {
    ...
    value is omitted when the error is elsewhere.
        ...
        */
        ...
        /**
         * @description The sequence number of the addition within the line item submitted which
        ...
        */
        Object.defineProperty(this, 'detailSequenceLinkId', {
            ...
            set: valueProvided => {
                ...
                this.__data.detailSequenceLinkId = valueProvided;
            }
        });
        ...
        */
        Object.defineProperty(this, 'subdetailSequenceLinkId', {
            ...
            set: valueProvided => {
                ...
                this.__data.subdetailSequenceLinkId = valueProvided;
            }
        });

        /**
         * @description An error code,froma specified code system, which details why the claim could
    not be adjudicated.
         * @property {Coding}
        */
