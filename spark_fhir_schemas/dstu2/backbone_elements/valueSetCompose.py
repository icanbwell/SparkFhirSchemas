...
class ValueSetComposeSchema:
    ...
    this value set. This is an absolute URI that is a reference to ValueSet.uri.
        ...
        # include
        from spark_fhir_schemas.dstu2.backbone_elements.valuesetinclude import ValueSetIncludeSchema
        ...
        schema = StructType(
            [
                ...
                StructField("include", ValueSetIncludeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Exclude one or more codes from the value set.
                StructField("exclude", ValueSetIncludeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
