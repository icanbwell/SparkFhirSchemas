...
class ValueSet.ComposeSchema:
    ...
    processing a resource are required to check for modifier extensions.
        import: Includes the contents of the referenced value set as a part of the contents of
    this value set. This is an absolute URI that is a reference to ValueSet.uri.
        ...
        # include
        from spark_fhir_schemas.dstu2.complex_types.valueset.include import ValueSet.IncludeSchema
        ...
        my_nesting_list: List[str] = nesting_list+["ValueSetCompose"]
        schema = StructType(
            [
                # None
                ...
                # this value set. This is an absolute URI that is a reference to ValueSet.uri.
                StructField("import", uriSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Include one or more codes from a code system.
                StructField("include", ValueSet.IncludeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Exclude one or more codes from the value set.
                StructField("exclude", ValueSet.IncludeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
