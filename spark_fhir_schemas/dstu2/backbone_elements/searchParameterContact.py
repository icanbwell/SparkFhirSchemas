...
class SearchParameter.ContactSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        name: The name of an individual to contact regarding the search parameter.
        ...
        if (max_recursion_limit and nesting_list.count("SearchParameterContact") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list+["SearchParameterContact"]
        schema = StructType(
            [
                # None
