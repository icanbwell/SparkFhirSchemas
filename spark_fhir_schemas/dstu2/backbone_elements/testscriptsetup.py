...
class TestScriptSetupSchema:
    ...
    def get_schema(
        ...
        # action
        from spark_fhir_schemas.dstu2.backbone_elements.testscriptaction import (
            TestScriptActionSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("TestScriptSetup") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "action",
                    ArrayType(
                        TestScriptActionSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
