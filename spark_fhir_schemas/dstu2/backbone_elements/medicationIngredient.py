...
class Medication.IngredientSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        item: The actual ingredient - either a substance (simple ingredient) or another
    medication.
    ...
    For example, 250 mg per tablet.
        ...
        my_nesting_list: List[str] = nesting_list+["MedicationIngredient"]
        schema = StructType(
            [
                # None
                ...
                # For example, 250 mg per tablet.
                StructField("amount", RatioSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
