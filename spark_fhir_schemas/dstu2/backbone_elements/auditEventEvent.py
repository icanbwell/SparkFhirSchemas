...
class AuditEventEventSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.coding import CodingSchema
        from spark_fhir_schemas.dstu2.complex_types.auditeventactioncode import (
            AuditEventActionCodeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.element import ElementSchema
        from spark_fhir_schemas.dstu2.complex_types.auditeventoutcomecode import (
            AuditEventOutcomeCodeSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "action",
                    AuditEventActionCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "outcome",
                    AuditEventOutcomeCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
