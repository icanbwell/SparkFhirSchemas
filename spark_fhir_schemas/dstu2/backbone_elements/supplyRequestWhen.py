...
class SupplyRequest.WhenSchema:
    """
    ...
    processing a resource are required to check for modifier extensions.
        code: Code indicating when the request should be fulfilled.
        schedule: Formal fulfillment schedule.
        """
        # id
        ...
        if (max_recursion_limit and nesting_list.count("SupplyRequestWhen") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list+["SupplyRequestWhen"]
        schema = StructType(
            [
                # None
