...
class ImagingObjectSelectionInstanceSchema:
    ...
    def get_schema(
        ...
        # frames
        from spark_fhir_schemas.dstu2.backbone_elements.imagingobjectselectionframes import (
            ImagingObjectSelectionFramesSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("ImagingObjectSelectionInstance")
            >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "frames",
                    ArrayType(
                        ImagingObjectSelectionFramesSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
