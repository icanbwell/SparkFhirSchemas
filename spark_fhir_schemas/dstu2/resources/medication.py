...
class MedicationSchema:
    ...
    code systems.
        ...
        # product
        from spark_fhir_schemas.dstu2.complex_types.medication.product import Medication.ProductSchema
        # package
        from spark_fhir_schemas.dstu2.complex_types.medication.package import Medication.PackageSchema
        ...
        schema = StructType(
            [
                ...
                StructField("product", Medication.ProductSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Information that only applies to packages (not products).
                StructField("package", Medication.PackageSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
