...
class VisionPrescriptionSchema:
    ...
    def get_schema(
        ...
        # dispense
        from spark_fhir_schemas.dstu2.backbone_elements.visionprescriptiondispense import (
            VisionPrescriptionDispenseSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "dispense",
                    ArrayType(
                        VisionPrescriptionDispenseSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
