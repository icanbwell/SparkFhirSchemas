    ...
    stoma that delivers nutrition distal to the oral cavity.
        ...
        schema = StructType(
            [
                ...
                StructField("status", NutritionOrderStatusSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                ...
                # applies to the entire nutrition order inclusive of the oral diet, nutritional
                # supplements and enteral formula feedings.
                StructField("foodPreferenceModifier", CodeableConceptSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # This modifier is used to convey order-specific modifiers about the type of
                # food that should NOT be given. These can be derived from patient allergies,
                # intolerances, or preferences such as No Red Meat, No Soy or No Wheat or
                # Gluten-Free.  While it should not be necessary to repeat allergy or
