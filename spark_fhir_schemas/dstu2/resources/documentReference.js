...
class DocumentReference extends Resource {
     ...
     * @param {instant} indexed,
     * @param {code} status,
     * @param {CodeableConcept|undefined} [docStatus],
        ...
        */
        Object.defineProperty(this, 'indexed', {
            ...
            set: valueProvided => {
                ...
                this.__data.indexed = valueProvided;
            }
        });
        ...
        */
        Object.defineProperty(this, 'docStatus', {
            ...
            set: valueProvided => {
                ...
                let CodeableConcept = require('../complex_types/codeableConcept.js');
                this.__data.docStatus = new CodeableConcept(valueProvided);
            }
        });
