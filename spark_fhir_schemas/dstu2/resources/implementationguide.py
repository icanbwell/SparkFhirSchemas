...
class ImplementationGuideSchema:
    ...
    def get_schema(
        ...
        # contact
        from spark_fhir_schemas.dstu2.backbone_elements.implementationguidecontact import (
            ImplementationGuideContactSchema,
        )
        ...
        # dependency
        from spark_fhir_schemas.dstu2.backbone_elements.implementationguidedependency import (
            ImplementationGuideDependencySchema,
        )

        # package
        from spark_fhir_schemas.dstu2.backbone_elements.implementationguidepackage import (
            ImplementationGuidePackageSchema,
        )

        # global
        from spark_fhir_schemas.dstu2.backbone_elements.implementationguideglobal import (
            ImplementationGuideGlobalSchema,
        )

        # page
        from spark_fhir_schemas.dstu2.backbone_elements.implementationguidepage import (
            ImplementationGuidePageSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "contact",
                    ArrayType(
                        ImplementationGuideContactSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "dependency",
                    ArrayType(
                        ImplementationGuideDependencySchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "package",
                    ArrayType(
                        ImplementationGuidePackageSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "global",
                    ArrayType(
                        ImplementationGuideGlobalSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
