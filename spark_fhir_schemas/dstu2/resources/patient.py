...
class PatientSchema:
    ...
    def get_schema(
        ...
        # contact
        from spark_fhir_schemas.dstu2.backbone_elements.patientcontact import (
            PatientContactSchema,
        )

        # animal
        from spark_fhir_schemas.dstu2.backbone_elements.patientanimal import (
            PatientAnimalSchema,
        )

        # communication
        from spark_fhir_schemas.dstu2.backbone_elements.patientcommunication import (
        ...
        # link
        from spark_fhir_schemas.dstu2.backbone_elements.patientlink import (
            PatientLinkSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "contact",
                    ArrayType(
                        PatientContactSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "animal",
                    PatientAnimalSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "communication",
                    ArrayType(
                        PatientCommunicationSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
