...
class ImmunizationRecommendationSchema:
    ...
    def get_schema(
        ...
        # recommendation
        from spark_fhir_schemas.dstu2.backbone_elements.immunizationrecommendationrecommendation import (
            ImmunizationRecommendationRecommendationSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "recommendation",
                    ArrayType(
                        ImmunizationRecommendationRecommendationSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
