...
class HealthcareServiceSchema:
    ...
    def get_schema(
        ...
        # serviceType
        from spark_fhir_schemas.dstu2.backbone_elements.healthcareserviceservicetype import (
            HealthcareServiceServiceTypeSchema,
        )
        ...
        # availableTime
        from spark_fhir_schemas.dstu2.backbone_elements.healthcareserviceavailabletime import (
            HealthcareServiceAvailableTimeSchema,
        )

        # notAvailable
        from spark_fhir_schemas.dstu2.backbone_elements.healthcareservicenotavailable import (
            HealthcareServiceNotAvailableSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "serviceType",
                    HealthcareServiceServiceTypeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "availableTime",
                    HealthcareServiceAvailableTimeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "notAvailable",
                    HealthcareServiceNotAvailableSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
