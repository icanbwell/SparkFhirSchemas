...
class PaymentReconciliationSchema:
    ...
    def get_schema(
        ...
        # detail
        from spark_fhir_schemas.dstu2.backbone_elements.paymentreconciliationdetail import (
            PaymentReconciliationDetailSchema,
        )
        ...
        # note
        from spark_fhir_schemas.dstu2.backbone_elements.paymentreconciliationnote import (
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "detail",
                    ArrayType(
                        PaymentReconciliationDetailSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "note",
                    ArrayType(
                        PaymentReconciliationNoteSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
