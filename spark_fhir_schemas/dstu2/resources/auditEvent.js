...
class AuditEvent extends Resource {
     ...
     * @param {AuditEventEvent} event,
     * @param {AuditEventParticipant[]} participant,
     * @param {AuditEventSource} source,
     * @param {AuditEventObject[]|undefined} [object],
    */
    constructor(
        {
            id,
    ...
    processing a resource are required to check for modifier extensions.
        ...
        */
        Object.defineProperty(this, 'event', {
            ...
            set: valueProvided => {
                ...
                let AuditEventEvent = require('../backbone_elements/auditEventEvent.js');
                this.__data.event = new AuditEventEvent(valueProvided);
            }
        });

        /**
         * @description A person, a hardware device or software process.
         * @property {AuditEventParticipant[]}
        */
        Object.defineProperty(this, 'participant', {
            ...
            set: valueProvided => {
                ...
                let AuditEventParticipant = require('../backbone_elements/auditEventParticipant.js');
                this.__data.participant = Array.isArray(valueProvided) ? valueProvided.map(v => new AuditEventParticipant(v)) : [new AuditEventParticipant(valueProvided)];
            }
        });
        ...
        */
         ...
         * @property {AuditEventObject[]|undefined}
        */
        Object.defineProperty(this, 'object', {
            ...
            set: valueProvided => {
                ...
                let AuditEventObject = require('../backbone_elements/auditEventObject.js');
                this.__data.object = Array.isArray(valueProvided) ? valueProvided.map(v => new AuditEventObject(v)) : [new AuditEventObject(valueProvided)];
            }
        });
