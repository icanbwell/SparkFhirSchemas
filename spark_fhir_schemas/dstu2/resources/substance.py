...
class SubstanceSchema:
    ...
    def get_schema(
        ...
        # instance
        from spark_fhir_schemas.dstu2.backbone_elements.substanceinstance import (
            SubstanceInstanceSchema,
        )

        # ingredient
        from spark_fhir_schemas.dstu2.backbone_elements.substanceingredient import (
            SubstanceIngredientSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "instance",
                    ArrayType(
                        SubstanceInstanceSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "ingredient",
                    ArrayType(
                        SubstanceIngredientSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
