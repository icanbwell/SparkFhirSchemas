...
class ParametersSchema:
    ...
    constructed, and which must be understood when processing the content.
        ...
        # parameter
        from spark_fhir_schemas.dstu2.complex_types.parameters.parameter import Parameters.ParameterSchema
        ...
        schema = StructType(
            [
                ...
                StructField("parameter", Parameters.ParameterSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
