...
from pyspark.sql.types import StructType, StructField, StringType, DateType, DataType
...
class ClaimResponseSchema:
    ...
    def get_schema(
        ...
        # item
        from spark_fhir_schemas.dstu2.backbone_elements.claimresponseitem import (
            ClaimResponseItemSchema,
        )

        # addItem
        from spark_fhir_schemas.dstu2.backbone_elements.claimresponseadditem import (
            ClaimResponseAddItemSchema,
        )

        # error
        from spark_fhir_schemas.dstu2.backbone_elements.claimresponseerror import (
            ClaimResponseErrorSchema,
        )
        ...
        # note
        from spark_fhir_schemas.dstu2.backbone_elements.claimresponsenote import (
            ClaimResponseNoteSchema,
        )

        # coverage
        from spark_fhir_schemas.dstu2.backbone_elements.claimresponsecoverage import (
            ClaimResponseCoverageSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "item",
                    ClaimResponseItemSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "addItem",
                    ClaimResponseAddItemSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "error",
                    ClaimResponseErrorSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "note",
                    ClaimResponseNoteSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "coverage",
                    ClaimResponseCoverageSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
