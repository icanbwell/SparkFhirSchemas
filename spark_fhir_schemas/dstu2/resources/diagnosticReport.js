...
class DiagnosticReport extends Resource {
     ...
     * @param {instant} issued,
     * @param {Reference} performer,
     ...
     * @param {DiagnosticReportImage[]|undefined} [image],
     * @param {String|undefined} [conclusion],
     * @param {CodeableConcept[]|undefined} [codedDiagnosis],
    ...
    */
    ...
    processing a resource are required to check for modifier extensions.
        ...
        */
        ...
        /**
         * @description The local ID assigned to the report by the order filler, usually by the
    ...
    MRI). This is used for searching, sorting and display purposes.
        ...
        */
        ...
        /**
         * @description The subject of the report. Usually, but not always, this is a patient. However
    ...
    variety of other sources.
        ...
        */
        ...
        /**
         * @description The date and time that this version of the report was released from the source
    diagnostic service.
         * @property {instant}
        */
        ...
        */
        ...
        /**
         * @description Observations that are part of this diagnostic report. Observations can be
    ...
    of treated specimens (i.e. slides of interest).
         * @property {DiagnosticReportImage[]|undefined}
        */
        Object.defineProperty(this, 'image', {
            ...
            set: valueProvided => {
                ...
                let DiagnosticReportImage = require('../backbone_elements/diagnosticReportImage.js');
                this.__data.image = Array.isArray(valueProvided) ? valueProvided.map(v => new DiagnosticReportImage(v)) : [new DiagnosticReportImage(valueProvided)];
            }
        });

        /**
         * @description Concise and clinically contextualized narrative interpretation of the
    diagnostic report.
        ...
        */
        Object.defineProperty(this, 'codedDiagnosis', {
            ...
            set: valueProvided => {
                ...
                let CodeableConcept = require('../complex_types/codeableConcept.js');
                this.__data.codedDiagnosis = Array.isArray(valueProvided) ? valueProvided.map(v => new CodeableConcept(v)) : [new CodeableConcept(valueProvided)];
            }
        });
