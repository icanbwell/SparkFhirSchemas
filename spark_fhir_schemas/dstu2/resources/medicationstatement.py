...
class MedicationStatementSchema:
    ...
    def get_schema(
        ...
        # dosage
        from spark_fhir_schemas.dstu2.backbone_elements.medicationstatementdosage import (
            MedicationStatementDosageSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "dosage",
                    ArrayType(
                        MedicationStatementDosageSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
