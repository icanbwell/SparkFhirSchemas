...
class NutritionOrderSchema:
    ...
    def get_schema(
        ...
        # oralDiet
        from spark_fhir_schemas.dstu2.backbone_elements.nutritionorderoraldiet import (
            NutritionOrderOralDietSchema,
        )

        # supplement
        from spark_fhir_schemas.dstu2.backbone_elements.nutritionordersupplement import (
            NutritionOrderSupplementSchema,
        )

        # enteralFormula
        from spark_fhir_schemas.dstu2.backbone_elements.nutritionorderenteralformula import (
            NutritionOrderEnteralFormulaSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "oralDiet",
                    NutritionOrderOralDietSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "enteralFormula",
                    NutritionOrderEnteralFormulaSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
