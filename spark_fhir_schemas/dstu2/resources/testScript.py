...
class TestScriptSchema:
    ...
    processing a resource are required to check for modifier extensions.
        url: An absolute URL that is used to identify this Test Script. This SHALL be a
    URL, SHOULD be globally unique, and SHOULD be an address at which this Test
    Script is (or will be) published.
        version: The identifier that is used to identify this version of the TestScript. This
    ...
    context of FHIR.
        experimental: This TestScript was authored for testing purposes (or
    ...
    usage.
        ...
        date: The date this version of the test tcript was published. The date must change
    ...
    of Test Scripts.
        requirements: Explains why this Test Script is needed and why it's been constrained as it
    has.
    ...
    the FHIR server being tested.
        multiserver: If the tests apply to more than one FHIR server (e.g. cross-server
    ...
    executed (successfully or otherwise).
        ...
        schema = StructType(
            [
                ...
                # interoperability tests) then multiserver=true. Defaults to false if value is
                # unspecified.
                StructField("multiserver", ElementSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
