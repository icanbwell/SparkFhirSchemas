...
class ResourceSchemaIndex:
    ...
    def get(resource_type: str) -> Any:
        if resource_type is None:
            ...
            from spark_fhir_schemas.dstu2.resources.activitydefinition import (
                ActivityDefinitionSchema,
            )

            return ActivityDefinitionSchema
        elif resource_type == "AdverseEvent":
            from spark_fhir_schemas.dstu2.resources.adverseevent import AdverseEventSchema
            ...
            from spark_fhir_schemas.dstu2.resources.biologicallyderivedproduct import (
                BiologicallyDerivedProductSchema,
            )

            return BiologicallyDerivedProductSchema
        elif resource_type == "BodyStructure":
            from spark_fhir_schemas.dstu2.resources.bodystructure import (
                BodyStructureSchema,
            )
            ...
            from spark_fhir_schemas.dstu2.resources.capabilitystatement import (
            ...
            from spark_fhir_schemas.dstu2.resources.careteam import CareTeamSchema

            return CareTeamSchema
        elif resource_type == "CatalogEntry":
            from spark_fhir_schemas.dstu2.resources.catalogentry import CatalogEntrySchema

            return CatalogEntrySchema
        elif resource_type == "ChargeItem":
            from spark_fhir_schemas.dstu2.resources.chargeitem import ChargeItemSchema

            return ChargeItemSchema
        elif resource_type == "ChargeItemDefinition":
            from spark_fhir_schemas.dstu2.resources.chargeitemdefinition import (
            ...
            from spark_fhir_schemas.dstu2.resources.codesystem import CodeSystemSchema
            ...
            from spark_fhir_schemas.dstu2.resources.compartmentdefinition import (
            ...
            from spark_fhir_schemas.dstu2.resources.consent import ConsentSchema
            ...
            from spark_fhir_schemas.dstu2.resources.coverageeligibilityrequest import (
                CoverageEligibilityRequestSchema,
            )

            return CoverageEligibilityRequestSchema
        elif resource_type == "CoverageEligibilityResponse":
            from spark_fhir_schemas.dstu2.resources.coverageeligibilityresponse import (
            ...
            from spark_fhir_schemas.dstu2.resources.devicedefinition import (
                DeviceDefinitionSchema,
            )

            return DeviceDefinitionSchema
        elif resource_type == "DeviceMetric":
            from spark_fhir_schemas.dstu2.resources.devicemetric import DeviceMetricSchema

            return DeviceMetricSchema
        elif resource_type == "DeviceRequest":
            from spark_fhir_schemas.dstu2.resources.devicerequest import (
                DeviceRequestSchema,
            )
            ...
            from spark_fhir_schemas.dstu2.resources.effectevidencesynthesis import (
            ...
            from spark_fhir_schemas.dstu2.resources.endpoint import EndpointSchema
            ...
            from spark_fhir_schemas.dstu2.resources.eventdefinition import (
                EventDefinitionSchema,
            )

            return EventDefinitionSchema
        elif resource_type == "Evidence":
            from spark_fhir_schemas.dstu2.resources.evidence import EvidenceSchema

            return EvidenceSchema
        elif resource_type == "EvidenceVariable":
            from spark_fhir_schemas.dstu2.resources.evidencevariable import (
                EvidenceVariableSchema,
            )

            return EvidenceVariableSchema
        elif resource_type == "ExampleScenario":
            from spark_fhir_schemas.dstu2.resources.examplescenario import (
            ...
            from spark_fhir_schemas.dstu2.resources.graphdefinition import (
            ...
            from spark_fhir_schemas.dstu2.resources.guidanceresponse import (
            ...
            from spark_fhir_schemas.dstu2.resources.imagingstudy import ImagingStudySchema

            return ImagingStudySchema
        elif resource_type == "Immunization":
            from spark_fhir_schemas.dstu2.resources.immunization import ImmunizationSchema

            return ImmunizationSchema
        elif resource_type == "ImmunizationEvaluation":
            from spark_fhir_schemas.dstu2.resources.immunizationevaluation import (
            ...
            from spark_fhir_schemas.dstu2.resources.insuranceplan import (
                InsurancePlanSchema,
            )

            return InsurancePlanSchema
        elif resource_type == "Invoice":
            from spark_fhir_schemas.dstu2.resources.invoice import InvoiceSchema

            return InvoiceSchema
        elif resource_type == "Library":
            from spark_fhir_schemas.dstu2.resources.library import LibrarySchema

            return LibrarySchema
        elif resource_type == "Linkage":
            from spark_fhir_schemas.dstu2.resources.linkage import LinkageSchema
            ...
            from spark_fhir_schemas.dstu2.resources.measure import MeasureSchema

            return MeasureSchema
        elif resource_type == "MeasureReport":
            from spark_fhir_schemas.dstu2.resources.measurereport import (
                MeasureReportSchema,
            )
            ...
            from spark_fhir_schemas.dstu2.resources.medicationknowledge import (
                MedicationKnowledgeSchema,
            )

            return MedicationKnowledgeSchema
        elif resource_type == "MedicationRequest":
            from spark_fhir_schemas.dstu2.resources.medicationrequest import (
            ...
            from spark_fhir_schemas.dstu2.resources.medicinalproduct import (
                MedicinalProductSchema,
            )

            return MedicinalProductSchema
        elif resource_type == "MedicinalProductAuthorization":
            from spark_fhir_schemas.dstu2.resources.medicinalproductauthorization import (
            ...
            from spark_fhir_schemas.dstu2.resources.medicinalproductcontraindication import (
            ...
            from spark_fhir_schemas.dstu2.resources.medicinalproductundesirableeffect import (
            ...
            from spark_fhir_schemas.dstu2.resources.messagedefinition import (
            ...
            from spark_fhir_schemas.dstu2.resources.molecularsequence import (
                MolecularSequenceSchema,
            )

            return MolecularSequenceSchema
        elif resource_type == "NamingSystem":
            from spark_fhir_schemas.dstu2.resources.namingsystem import NamingSystemSchema
            ...
            from spark_fhir_schemas.dstu2.resources.observationdefinition import (
            ...
            from spark_fhir_schemas.dstu2.resources.organization import OrganizationSchema

            return OrganizationSchema
        elif resource_type == "OrganizationAffiliation":
            from spark_fhir_schemas.dstu2.resources.organizationaffiliation import (
            ...
            from spark_fhir_schemas.dstu2.resources.plandefinition import (
                PlanDefinitionSchema,
            )

            return PlanDefinitionSchema
        elif resource_type == "Practitioner":
            from spark_fhir_schemas.dstu2.resources.practitioner import PractitionerSchema

            return PractitionerSchema
        elif resource_type == "PractitionerRole":
            from spark_fhir_schemas.dstu2.resources.practitionerrole import (
            ...
            from spark_fhir_schemas.dstu2.resources.requestgroup import RequestGroupSchema

            return RequestGroupSchema
        elif resource_type == "ResearchDefinition":
            from spark_fhir_schemas.dstu2.resources.researchdefinition import (
                ResearchDefinitionSchema,
            )

            return ResearchDefinitionSchema
        elif resource_type == "ResearchElementDefinition":
            from spark_fhir_schemas.dstu2.resources.researchelementdefinition import (
                ResearchElementDefinitionSchema,
            )

            return ResearchElementDefinitionSchema
        elif resource_type == "ResearchStudy":
            from spark_fhir_schemas.dstu2.resources.researchstudy import (
                ResearchStudySchema,
            )

            return ResearchStudySchema
        elif resource_type == "ResearchSubject":
            from spark_fhir_schemas.dstu2.resources.researchsubject import (
            ...
            from spark_fhir_schemas.dstu2.resources.riskevidencesynthesis import (
            ...
            from spark_fhir_schemas.dstu2.resources.servicerequest import (
            ...
            from spark_fhir_schemas.dstu2.resources.specimendefinition import (
            ...
            from spark_fhir_schemas.dstu2.resources.structuremap import StructureMapSchema

            return StructureMapSchema
        elif resource_type == "Subscription":
            from spark_fhir_schemas.dstu2.resources.subscription import SubscriptionSchema
            ...
            from spark_fhir_schemas.dstu2.resources.task import TaskSchema

            return TaskSchema
        elif resource_type == "TerminologyCapabilities":
            from spark_fhir_schemas.dstu2.resources.terminologycapabilities import (
                TerminologyCapabilitiesSchema,
            )

            return TerminologyCapabilitiesSchema
        elif resource_type == "TestReport":
            from spark_fhir_schemas.dstu2.resources.testreport import TestReportSchema
            ...
            from spark_fhir_schemas.dstu2.resources.verificationresult import (
