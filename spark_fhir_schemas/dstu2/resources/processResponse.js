...
class ProcessResponse extends Resource {
     ...
     * @param {Coding|undefined} [outcome],
     ...
     * @param {ProcessResponseNotes[]|undefined} [notes],
     * @param {Coding[]|undefined} [error],
    */
    constructor(
        {
            id,
        ...
        */
        Object.defineProperty(this, 'outcome', {
            ...
            set: valueProvided => {
                ...
                this.__data.outcome = new Coding(valueProvided);
            }
        });
    ...
    patient.
        ...
        */
        ...
        /**
         * @description Suite of processing note or additional requirements is the processing has been
    held.
         * @property {ProcessResponseNotes[]|undefined}
        */
        Object.defineProperty(this, 'notes', {
            ...
            set: valueProvided => {
                ...
                let ProcessResponseNotes = require('../backbone_elements/processResponseNotes.js');
                this.__data.notes = Array.isArray(valueProvided) ? valueProvided.map(v => new ProcessResponseNotes(v)) : [new ProcessResponseNotes(valueProvided)];
            }
        });
        ...
        */
        Object.defineProperty(this, 'error', {
            ...
            set: valueProvided => {
                ...
                let Coding = require('../complex_types/coding.js');
                this.__data.error = Array.isArray(valueProvided) ? valueProvided.map(v => new Coding(v)) : [new Coding(valueProvided)];
            }
        });
    ...
    */
    copy() {
        return new ProcessResponse(this.toJSON());
    }
