        ...
        */
        Object.defineProperty(this, 'issue', {
            ...
            set: valueProvided => {
                ...
                let OperationOutcomeIssue = require('../backbone_elements/operationOutcomeIssue.js');
                this.__data.issue = Array.isArray(valueProvided) ? valueProvided.map(v => new OperationOutcomeIssue(v)) : [new OperationOutcomeIssue(valueProvided)];
            }
        });
