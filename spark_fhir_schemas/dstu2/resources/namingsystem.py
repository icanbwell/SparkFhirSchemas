...
class NamingSystemSchema:
    ...
    def get_schema(
        ...
        # contact
        from spark_fhir_schemas.dstu2.backbone_elements.namingsystemcontact import (
            NamingSystemContactSchema,
        )
        ...
        # uniqueId
        from spark_fhir_schemas.dstu2.backbone_elements.namingsystemuniqueid import (
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "contact",
                    ArrayType(
                        NamingSystemContactSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "uniqueId",
                    ArrayType(
                        NamingSystemUniqueIdSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
