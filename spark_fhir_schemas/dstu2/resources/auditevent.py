...
class AuditEventSchema:
    ...
    def get_schema(
        ...
        # event
        from spark_fhir_schemas.dstu2.backbone_elements.auditeventevent import (
            AuditEventEventSchema,
        )

        # participant
        from spark_fhir_schemas.dstu2.backbone_elements.auditeventparticipant import (
            AuditEventParticipantSchema,
        )

        # source
        from spark_fhir_schemas.dstu2.backbone_elements.auditeventsource import (
            AuditEventSourceSchema,
        )

        # object
        from spark_fhir_schemas.dstu2.backbone_elements.auditeventobject import (
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "event",
                    AuditEventEventSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "participant",
                    ArrayType(
                        AuditEventParticipantSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "source",
                    AuditEventSourceSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "object",
                    ArrayType(
                        AuditEventObjectSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
