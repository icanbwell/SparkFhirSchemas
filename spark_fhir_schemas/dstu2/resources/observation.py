...
class ObservationSchema:
    ...
    def get_schema(
        ...
        # referenceRange
        from spark_fhir_schemas.dstu2.backbone_elements.observationreferencerange import (
            ObservationReferenceRangeSchema,
        )

        # related
        from spark_fhir_schemas.dstu2.backbone_elements.observationrelated import (
            ObservationRelatedSchema,
        )

        # component
        from spark_fhir_schemas.dstu2.backbone_elements.observationcomponent import (
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "referenceRange",
                    ObservationReferenceRangeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "related",
                    ObservationRelatedSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "component",
                    ObservationComponentSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
