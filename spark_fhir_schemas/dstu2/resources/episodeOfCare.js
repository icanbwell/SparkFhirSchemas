...
class EpisodeOfCare extends Resource {
     ...
     * @param {EpisodeOfCareCareTeam[]|undefined} [careTeam],
    */
    constructor(
        {
            id,
    ...
    requiring processing the history of the resource).
        ...
        */
        ...
        /**
         * @description A classification of the type of encounter; e.g. specialist referral, disease
    management, type of funded care.
        ...
        */
        ...
        /**
         * @description A list of conditions/problems/diagnoses that this episode of care is intended
        ...
        */
        Object.defineProperty(this, 'condition', {
            ...
            set: valueProvided => {
                ...
                this.__data.condition = Array.isArray(valueProvided) ? valueProvided.map(v => new Reference(v)) : [new Reference(valueProvided)];
            }
        });
    ...
    specific purposes.
         * @property {EpisodeOfCareCareTeam[]|undefined}
        */
        Object.defineProperty(this, 'careTeam', {
            ...
            set: valueProvided => {
                ...
                let EpisodeOfCareCareTeam = require('../backbone_elements/episodeOfCareCareTeam.js');
                this.__data.careTeam = Array.isArray(valueProvided) ? valueProvided.map(v => new EpisodeOfCareCareTeam(v)) : [new EpisodeOfCareCareTeam(valueProvided)];
            }
        });
