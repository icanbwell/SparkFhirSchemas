...
class SupplyRequestSchema:
    ...
    processing a resource are required to check for modifier extensions.
        ...
        source: The Practitioner , Organization or Patient who initiated this order for the
    supply.
        date: When the request was made.
        identifier: Unique identifier for this supply request.
        status: Status of the supply request.
        kind: Category of supply, e.g.  central, non-stock, etc. This is used to support
    work flows associated with the supply process.
        ...
        from spark_fhir_schemas.dstu2.complex_types.codeableconcept import CodeableConceptSchema
        from spark_fhir_schemas.dstu2.complex_types.reference import ReferenceSchema
        Not mapped: SupplyRequestWhen
        if (max_recursion_limit and nesting_list.count("SupplyRequest") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
        ...
        schema = StructType(
            [
                ...
                StructField("status", SupplyRequestStatusCodeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Category of supply, e.g.  central, non-stock, etc. This is used to support
                # work flows associated with the supply process.
                StructField("kind", CodeableConceptSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # The item that is requested to be supplied.
                StructField("orderedItem", ReferenceSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                ...
                StructField("when", SupplyRequestWhenSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
