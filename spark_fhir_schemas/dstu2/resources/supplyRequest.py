...
class SupplyRequestSchema:
    ...
    work flows associated with the supply process.
        ...
        # when
        from spark_fhir_schemas.dstu2.complex_types.supplyrequest.when import SupplyRequest.WhenSchema
        ...
        schema = StructType(
            [
                ...
                StructField("when", SupplyRequest.WhenSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
