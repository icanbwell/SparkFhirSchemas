...
class QuestionnaireResponseSchema:
    ...
    completed) questionnaire.
        questionnaire: Indicates the Questionnaire resource that defines the form for which answers
    are being provided.
    ...
    and recorded them in the system.
        authored: The date and/or time that this version of the questionnaire response was
    authored.
        source: The person who answered the questions about the subject.
        encounter: Encounter during which this set of questionnaire response were collected. When
    ...
    questionnaire response.
        ...
        schema = StructType(
            [
                ...
                # are being provided.
                StructField("questionnaire", ReferenceSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # The lifecycle status of the questionnaire response as a whole.
                StructField("status", QuestionnaireResponseStatusCodeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                ...
                # authored.
                StructField("authored", ElementSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
