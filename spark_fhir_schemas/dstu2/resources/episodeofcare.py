...
class EpisodeOfCareSchema:
    ...
    def get_schema(
        ...
        # statusHistory
        from spark_fhir_schemas.dstu2.backbone_elements.episodeofcarestatushistory import (
            EpisodeOfCareStatusHistorySchema,
        )
        ...
        # careTeam
        from spark_fhir_schemas.dstu2.backbone_elements.episodeofcarecareteam import (
            EpisodeOfCareCareTeamSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "statusHistory",
                    ArrayType(
                        EpisodeOfCareStatusHistorySchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "careTeam",
                    ArrayType(
                        EpisodeOfCareCareTeamSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
