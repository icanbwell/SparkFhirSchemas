...
class ScheduleSchema:
    ...
    processing a resource are required to check for modifier extensions.
        ...
        type: The schedule type can be used for the categorization of healthcare services or
    ...
    custom constraints on the slot(s) that may be associated.
        ...
        if (max_recursion_limit and nesting_list.count("Schedule") >= max_recursion_limit) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
