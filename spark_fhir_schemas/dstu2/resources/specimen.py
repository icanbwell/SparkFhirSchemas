...
class SpecimenSchema:
    ...
    blood in tube in tray in rack is not addressed here.
        ...
        # collection
        from spark_fhir_schemas.dstu2.complex_types.specimen.collection import Specimen.CollectionSchema
        # treatment
        from spark_fhir_schemas.dstu2.complex_types.specimen.treatment import Specimen.TreatmentSchema
        # container
        from spark_fhir_schemas.dstu2.complex_types.specimen.container import Specimen.ContainerSchema
        ...
        schema = StructType(
            [
                ...
                StructField("collection", Specimen.CollectionSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # Details concerning treatment and processing steps for the specimen.
                StructField("treatment", Specimen.TreatmentSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # The container holding the specimen.  The recursive nature of containers; i.e.
                # blood in tube in tray in rack is not addressed here.
                StructField("container", Specimen.ContainerSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
