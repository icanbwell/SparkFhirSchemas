...
class SpecimenSchema:
    ...
    def get_schema(
        ...
        # collection
        from spark_fhir_schemas.dstu2.backbone_elements.specimencollection import (
            SpecimenCollectionSchema,
        )

        # treatment
        from spark_fhir_schemas.dstu2.backbone_elements.specimentreatment import (
            SpecimenTreatmentSchema,
        )

        # container
        from spark_fhir_schemas.dstu2.backbone_elements.specimencontainer import (
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "collection",
                    SpecimenCollectionSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "treatment",
                    ArrayType(
                        SpecimenTreatmentSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "container",
                    ArrayType(
                        SpecimenContainerSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
