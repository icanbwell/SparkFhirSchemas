...
class DocumentReferenceSchema:
    ...
    def get_schema(
        ...
        # relatesTo
        from spark_fhir_schemas.dstu2.backbone_elements.documentreferencerelatesto import (
            DocumentReferenceRelatesToSchema,
        )

        # content
        from spark_fhir_schemas.dstu2.backbone_elements.documentreferencecontent import (
            DocumentReferenceContentSchema,
        )

        # context
        from spark_fhir_schemas.dstu2.backbone_elements.documentreferencecontext import (
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "relatesTo",
                    ArrayType(
                        DocumentReferenceRelatesToSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "content",
                    ArrayType(
                        DocumentReferenceContentSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "context",
                    DocumentReferenceContextSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
