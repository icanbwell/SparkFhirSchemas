...
class CommunicationRequestSchema:
    ...
    concepts such as stat, urgent, routine.
        ...
        from spark_fhir_schemas.dstu2.complex_types.reference import ReferenceSchema
            # status
        from spark_fhir_schemas.dstu2.simple_types.communicationrequeststatus import CommunicationRequestStatusSchema
            # encounter
        from spark_fhir_schemas.dstu2.complex_types.reference import ReferenceSchema
            # scheduledDateTime
        ...
        schema = StructType(
            [
                ...
                # None
                StructField("scheduledDateTime", dateTimeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # None
                ...
                StructField("requestedOn", dateTimeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
