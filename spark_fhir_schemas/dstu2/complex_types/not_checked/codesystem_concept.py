...
class CodeSystem_ConceptSchema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.dstu2.complex_types.not_checked.codesystem_designation import (
            CodeSystem_DesignationSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.codesystem_property1 import (
