...
class ConceptMap_GroupSchema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.dstu2.complex_types.not_checked.conceptmap_element import (
            ConceptMap_ElementSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.conceptmap_unmapped import (
