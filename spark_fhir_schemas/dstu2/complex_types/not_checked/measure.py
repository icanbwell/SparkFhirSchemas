...
class MeasureSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.measure_group import (
            Measure_GroupSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.measure_supplementaldata import (
