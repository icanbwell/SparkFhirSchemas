...
class ResearchStudySchema:
    ...
    def get_schema(
        ...
        focus: The condition(s), medication(s), food(s), therapy(ies), device(s) or other
        ...
        principalInvestigator: Indicates the individual who has primary oversite of the execution of the
            study.

        site: Clinic, hospital or other healthcare location that is participating in the
            study.
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.researchstudy_arm import (
