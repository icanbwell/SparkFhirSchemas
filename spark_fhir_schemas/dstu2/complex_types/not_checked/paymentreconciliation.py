...
class PaymentReconciliationSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.paymentreconciliation_detail import (
            PaymentReconciliation_DetailSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.money import MoneySchema
        from spark_fhir_schemas.dstu2.complex_types.not_checked.paymentreconciliation_processnote import (
