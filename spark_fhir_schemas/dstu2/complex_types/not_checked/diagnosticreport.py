...
class DiagnosticReportSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.diagnosticreport_performer import (
            DiagnosticReport_PerformerSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.diagnosticreport_image import (
