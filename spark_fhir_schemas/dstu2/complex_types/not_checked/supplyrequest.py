...
class SupplyRequestSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.supplyrequest_ordereditem import (
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.supplyrequest_requester import (
