...
class ImplementationGuideSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.implementationguide_dependency import (
            ImplementationGuide_DependencySchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.implementationguide_package import (
            ImplementationGuide_PackageSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.implementationguide_global import (
            ImplementationGuide_GlobalSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.implementationguide_page import (
