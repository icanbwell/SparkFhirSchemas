...
class SpecimenSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.specimen_collection import (
            Specimen_CollectionSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.specimen_processing import (
            Specimen_ProcessingSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.specimen_container import (
