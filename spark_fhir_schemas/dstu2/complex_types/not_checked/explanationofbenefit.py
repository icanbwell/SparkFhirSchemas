...
class ExplanationOfBenefitSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_related import (
            ExplanationOfBenefit_RelatedSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_payee import (
            ExplanationOfBenefit_PayeeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_information import (
            ExplanationOfBenefit_InformationSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_careteam import (
            ExplanationOfBenefit_CareTeamSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_diagnosis import (
            ExplanationOfBenefit_DiagnosisSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_procedure import (
            ExplanationOfBenefit_ProcedureSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_insurance import (
            ExplanationOfBenefit_InsuranceSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_accident import (
            ExplanationOfBenefit_AccidentSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_item import (
            ExplanationOfBenefit_ItemSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_additem import (
            ExplanationOfBenefit_AddItemSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.money import MoneySchema
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_payment import (
            ExplanationOfBenefit_PaymentSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_processnote import (
            ExplanationOfBenefit_ProcessNoteSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.explanationofbenefit_benefitbalance import (
