...
class MessageDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.messagedefinition_focus import (
            MessageDefinition_FocusSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.messagedefinition_allowedresponse import (
