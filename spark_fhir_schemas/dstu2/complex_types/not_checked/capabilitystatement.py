...
class CapabilityStatementSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_software import (
            CapabilityStatement_SoftwareSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_implementation import (
            CapabilityStatement_ImplementationSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.reference import ReferenceSchema
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_rest import (
            CapabilityStatement_RestSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_messaging import (
            CapabilityStatement_MessagingSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_document import (
