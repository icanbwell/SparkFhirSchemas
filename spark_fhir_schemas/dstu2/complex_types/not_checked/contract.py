...
class ContractSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.contract_agent import (
            Contract_AgentSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.contract_signer import (
            Contract_SignerSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.contract_valueditem import (
            Contract_ValuedItemSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.contract_term import (
            Contract_TermSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.attachment import AttachmentSchema
        from spark_fhir_schemas.dstu2.complex_types.not_checked.contract_friendly import (
            Contract_FriendlySchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.contract_legal import (
            Contract_LegalSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.contract_rule import (
            Contract_RuleSchema,
        )
