...
class HealthcareServiceSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.healthcareservice_availabletime import (
            HealthcareService_AvailableTimeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.healthcareservice_notavailable import (
