...
class MedicationSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.medication_ingredient import (
            Medication_IngredientSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.medication_package import (
