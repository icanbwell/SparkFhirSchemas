...
class TaskSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.task_requester import (
            Task_RequesterSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.annotation import AnnotationSchema
        from spark_fhir_schemas.dstu2.complex_types.not_checked.task_restriction import (
            Task_RestrictionSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.task_input import Task_InputSchema
        from spark_fhir_schemas.dstu2.complex_types.not_checked.task_output import Task_OutputSchema
