...
class ImmunizationRecommendation_RecommendationSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.immunizationrecommendation_datecriterion import (
            ImmunizationRecommendation_DateCriterionSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.immunizationrecommendation_protocol import (
