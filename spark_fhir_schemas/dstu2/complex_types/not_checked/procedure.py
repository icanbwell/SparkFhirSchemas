...
class ProcedureSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.procedure_performer import (
            Procedure_PerformerSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.annotation import AnnotationSchema
        from spark_fhir_schemas.dstu2.complex_types.not_checked.procedure_focaldevice import (
