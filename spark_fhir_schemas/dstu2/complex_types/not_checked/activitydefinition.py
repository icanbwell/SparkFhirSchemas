...
class ActivityDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.activitydefinition_participant import (
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.activitydefinition_dynamicvalue import (
