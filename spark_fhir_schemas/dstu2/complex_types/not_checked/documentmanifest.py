...
class DocumentManifestSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.documentmanifest_content import (
            DocumentManifest_ContentSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.documentmanifest_related import (
