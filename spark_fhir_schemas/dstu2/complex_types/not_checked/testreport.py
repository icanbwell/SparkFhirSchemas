...
class TestReportSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.testreport_participant import (
            TestReport_ParticipantSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.testreport_setup import (
            TestReport_SetupSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.testreport_test import (
            TestReport_TestSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.testreport_teardown import (
