...
class SequenceSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.sequence_referenceseq import (
            Sequence_ReferenceSeqSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.sequence_variant import (
            Sequence_VariantSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.sequence_quality import (
            Sequence_QualitySchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.sequence_repository import (
