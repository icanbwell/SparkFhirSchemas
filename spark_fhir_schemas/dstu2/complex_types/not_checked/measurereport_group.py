...
class MeasureReport_GroupSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.measurereport_population import (
            MeasureReport_PopulationSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.measurereport_stratifier import (
