...
class ClaimResponseSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.claimresponse_item import (
            ClaimResponse_ItemSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.claimresponse_additem import (
            ClaimResponse_AddItemSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.claimresponse_error import (
            ClaimResponse_ErrorSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.money import MoneySchema
        from spark_fhir_schemas.dstu2.complex_types.not_checked.claimresponse_payment import (
            ClaimResponse_PaymentSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.coding import CodingSchema
        from spark_fhir_schemas.dstu2.complex_types.not_checked.claimresponse_processnote import (
            ClaimResponse_ProcessNoteSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.claimresponse_insurance import (
