...
class TestScript_MetadataSchema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.dstu2.complex_types.not_checked.testscript_link import (
            TestScript_LinkSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.testscript_capability import (
