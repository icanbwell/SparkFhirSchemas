...
class CapabilityStatement_RestSchema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_security import (
            CapabilityStatement_SecuritySchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_resource import (
            CapabilityStatement_ResourceSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_interaction1 import (
            CapabilityStatement_Interaction1Schema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_searchparam import (
            CapabilityStatement_SearchParamSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_operation import (
