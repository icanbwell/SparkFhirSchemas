...
class CompositionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.composition_attester import (
            Composition_AttesterSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.composition_relatesto import (
            Composition_RelatesToSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.composition_event import (
            Composition_EventSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.composition_section import (
