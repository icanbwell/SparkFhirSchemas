...
class PlanDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.plandefinition_goal import (
            PlanDefinition_GoalSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.plandefinition_action import (
