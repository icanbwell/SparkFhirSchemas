...
class ExpansionProfileSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.expansionprofile_fixedversion import (
            ExpansionProfile_FixedVersionSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.expansionprofile_excludedsystem import (
            ExpansionProfile_ExcludedSystemSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.expansionprofile_designation import (
