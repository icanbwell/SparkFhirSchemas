...
class Claim_ItemSchema:
    ...
    def get_schema(
        ...
        programCode: For programs which require reason codes for the inclusion or covering of this
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.claim_detail import (
            Claim_DetailSchema,
        )
