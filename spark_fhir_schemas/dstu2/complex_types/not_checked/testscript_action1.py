...
class TestScript_Action1Schema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.dstu2.complex_types.not_checked.testscript_operation import (
            TestScript_OperationSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.testscript_assert import (
