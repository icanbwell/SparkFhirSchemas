...
class PractitionerRoleSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.practitionerrole_availabletime import (
            PractitionerRole_AvailableTimeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.practitionerrole_notavailable import (
