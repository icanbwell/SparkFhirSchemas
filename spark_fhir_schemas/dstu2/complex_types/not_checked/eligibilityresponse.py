...
class EligibilityResponseSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.eligibilityresponse_insurance import (
            EligibilityResponse_InsuranceSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.eligibilityresponse_error import (
