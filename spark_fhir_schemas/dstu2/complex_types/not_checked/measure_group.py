...
class Measure_GroupSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.measure_population import (
            Measure_PopulationSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.measure_stratifier import (
