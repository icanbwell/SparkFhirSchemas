...
class ElementDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.elementdefinition_slicing import (
            ElementDefinition_SlicingSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.elementdefinition_base import (
            ElementDefinition_BaseSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.elementdefinition_type import (
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.elementdefinition_example import (
            ElementDefinition_ExampleSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.elementdefinition_constraint import (
            ElementDefinition_ConstraintSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.elementdefinition_binding import (
            ElementDefinition_BindingSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.elementdefinition_mapping import (
