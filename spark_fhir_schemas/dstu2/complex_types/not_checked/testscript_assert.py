...
class TestScript_AssertSchema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.dstu2.complex_types.not_checked.testscript_rule2 import (
            TestScript_Rule2Schema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.testscript_ruleset1 import (
