...
class CapabilityStatement_MessagingSchema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_endpoint import (
            CapabilityStatement_EndpointSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_supportedmessage import (
            CapabilityStatement_SupportedMessageSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.capabilitystatement_event import (
