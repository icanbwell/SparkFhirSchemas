...
class ValueSetSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.valueset_compose import (
            ValueSet_ComposeSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.valueset_expansion import (
