...
class StructureMapSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.structuremap_structure import (
            StructureMap_StructureSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.structuremap_group import (
