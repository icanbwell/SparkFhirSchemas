...
class DataRequirementSchema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.dstu2.complex_types.not_checked.datarequirement_codefilter import (
            DataRequirement_CodeFilterSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.datarequirement_datefilter import (
