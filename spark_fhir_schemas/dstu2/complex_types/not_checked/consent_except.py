...
class Consent_ExceptSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.consent_actor1 import (
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.consent_data1 import (
            Consent_Data1Schema,
        )
