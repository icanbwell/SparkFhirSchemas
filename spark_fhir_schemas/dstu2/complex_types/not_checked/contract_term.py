...
class Contract_TermSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.contract_agent1 import (
            Contract_Agent1Schema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.contract_valueditem1 import (
