...
class StructureMap_RuleSchema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.dstu2.complex_types.not_checked.structuremap_source import (
            StructureMap_SourceSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.structuremap_target import (
            StructureMap_TargetSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.structuremap_dependent import (
