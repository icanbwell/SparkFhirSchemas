...
class GroupSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.not_checked.group_characteristic import (
            Group_CharacteristicSchema,
        )
        from spark_fhir_schemas.dstu2.complex_types.not_checked.group_member import (
            Group_MemberSchema,
        )
