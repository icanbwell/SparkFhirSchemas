...
class ElementDefinitionSchema:
    ...
    def get_schema(
        ...
        # slicing
        from spark_fhir_schemas.dstu2.backbone_elements.elementdefinitionslicing import (
            ElementDefinitionSlicingSchema,
        )
        ...
        # base
        from spark_fhir_schemas.dstu2.backbone_elements.elementdefinitionbase import (
            ElementDefinitionBaseSchema,
        )

        # type
        from spark_fhir_schemas.dstu2.backbone_elements.elementdefinitiontype import (
            ElementDefinitionTypeSchema,
        )
        ...
        # constraint
        from spark_fhir_schemas.dstu2.backbone_elements.elementdefinitionconstraint import (
            ElementDefinitionConstraintSchema,
        )

        # binding
        from spark_fhir_schemas.dstu2.backbone_elements.elementdefinitionbinding import (
            ElementDefinitionBindingSchema,
        )

        # mapping
        from spark_fhir_schemas.dstu2.backbone_elements.elementdefinitionmapping import (
            ElementDefinitionMappingSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "slicing",
                    ElementDefinitionSlicingSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "base",
                    ElementDefinitionBaseSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "binding",
                    ElementDefinitionBindingSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
