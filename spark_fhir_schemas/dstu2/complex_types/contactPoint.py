...
class ContactPointSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.dstu2.complex_types.contactpointsystemcode import (
            ContactPointSystemCodeSchema,
        )
        from spark_fhir_schemas.dstu2.simple_types.element import ElementSchema
        from spark_fhir_schemas.dstu2.complex_types.contactpointusecode import (
            ContactPointUseCodeSchema,
        )
        from spark_fhir_schemas.dstu2.simple_types.element import ElementSchema
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "system",
                    ContactPointSystemCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "use",
                    ContactPointUseCodeSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
