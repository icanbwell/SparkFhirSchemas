...
class ElementDefinitionTypeSchema:
    """
    ...
    the extension.
        code: Name of Data type or Resource that is a(or the) type used for this element.
        profile: Identifies a profile structure or implementation Guide that SHALL hold for
    ...
    a bundle, is it included in the bundle.
        ...
        from spark_fhir_schemas.dstu2.complex_types.element import ElementSchema
        from spark_fhir_schemas.dstu2.complex_types.element import ElementSchema
        from spark_fhir_schemas.dstu2.complex_types.aggregationmodecode import AggregationModeCodeSchema
        ...
        my_nesting_list: List[str] = nesting_list+["ElementDefinitionType"]
        schema = StructType(
            [
                # None
                ...
                # aggregated - is it a contained resource, or a reference, and if the context is
                # a bundle, is it included in the bundle.
                StructField("aggregation", AggregationModeCodeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
