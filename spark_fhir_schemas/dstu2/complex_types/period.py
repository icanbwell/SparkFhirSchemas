    ...
    future, which means that period is expected/planned to end at that time.
        ...
        schema = StructType(
            [
                ...
                StructField("start", dateTimeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
                # The end of the period. If the end of the period is missing, it means that the
                # period is ongoing. The start may be in the past, and the end date in the
                # future, which means that period is expected/planned to end at that time.
                StructField("end", dateTimeSchema.get_schema(max_nesting_depth=max_nesting_depth,nesting_depth=nesting_depth+1,nesting_list=my_nesting_list,max_recursion_limit=max_recursion_limit,include_extension=include_extension,extension_fields=extension_fields, extension_depth=extension_depth+1, max_extension_depth=max_extension_depth), True),
            ]
        )
