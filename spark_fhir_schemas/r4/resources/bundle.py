    ...
    def get_schema(recursion_depth: int = 0) -> Union[StructType, DataType]:
        ...
        schema = StructType(
            [
                ...
                # placed in the bundle.
                StructField(
                    "timestamp", instantSchema.get_schema(recursion_depth + 1),
                    True
                ),
                ...
                # of entries in the Bundle.
                StructField(
                    "total", unsignedIntSchema.get_schema(recursion_depth + 1),
                    True
                ),
                ...
                StructField(
                    "entry",
                    ArrayType(
                        Bundle_EntrySchema.get_schema(recursion_depth + 1)
                    ), True
                ),
