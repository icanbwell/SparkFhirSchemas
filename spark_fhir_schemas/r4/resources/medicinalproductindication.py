...
class MedicinalProductIndicationSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.medicinalproductindication_othertherapy import (
            MedicinalProductIndication_OtherTherapySchema,
        )
        ...
        my_parent_path = (
            parent_path + ".medicinalproductindication"
            if parent_path
            else "medicinalproductindication"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "otherTherapy",
                    ArrayType(
                        MedicinalProductIndication_OtherTherapySchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
