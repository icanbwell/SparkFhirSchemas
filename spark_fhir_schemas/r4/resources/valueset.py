...
from spark_fhir_schemas.r4.resources.markdown import markdown
from spark_fhir_schemas.r4.resources.markdown import markdown
from spark_fhir_schemas.r4.resources.valueset_compose import ValueSet_Compose
from spark_fhir_schemas.r4.resources.valueset_expansion import ValueSet_Expansion
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("expansion", ValueSet_Expansion.get_schema(), True),]
        )
