...
class MedicinalProductIngredientSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.medicinalproductingredient_specifiedsubstance import MedicinalProductIngredient_SpecifiedSubstanceSchema
        from spark_fhir_schemas.r4.complex_types.medicinalproductingredient_substance import MedicinalProductIngredient_SubstanceSchema
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductIngredient") >=
            max_recursion_limit
