...
class EvidenceReportSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.evidencereport_subject import (
            EvidenceReport_SubjectSchema,
        )
        from spark_fhir_schemas.r4.complex_types.contactdetail import (
            ContactDetailSchema,
        )
        from spark_fhir_schemas.r4.complex_types.evidencereport_relatesto import (
            EvidenceReport_RelatesToSchema,
        )
        from spark_fhir_schemas.r4.complex_types.evidencereport_section import (
