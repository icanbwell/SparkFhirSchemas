...
class CitationSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.citation_summary import (
            Citation_SummarySchema,
        )
        from spark_fhir_schemas.r4.complex_types.citation_classification import (
            Citation_ClassificationSchema,
        )
        from spark_fhir_schemas.r4.complex_types.annotation import AnnotationSchema
        from spark_fhir_schemas.r4.complex_types.citation_statusdate import (
            Citation_StatusDateSchema,
        )
        from spark_fhir_schemas.r4.complex_types.citation_relatesto import (
            Citation_RelatesToSchema,
        )
        from spark_fhir_schemas.r4.complex_types.citation_citedartifact import (
