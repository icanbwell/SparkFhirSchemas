...
class InvoiceSchema:
    ...
    def get_schema(recursion_depth: int = 0) -> Union[StructType, DataType]:
        ...
        from spark_fhir_schemas.r4.complex_types.invoice_participant import Invoice_ParticipantSchema
        from spark_fhir_schemas.r4.complex_types.invoice_lineitem import Invoice_LineItemSchema
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "issuer", ReferenceSchema.get_schema(recursion_depth + 1),
                    True
                ),
                # Account which is supposed to be balanced with this Invoice.
                StructField(
                    "account", ReferenceSchema.get_schema(recursion_depth + 1),
                    True
                ),
                ...
                StructField(
                    "lineItem",
                    ArrayType(
                        Invoice_LineItemSchema.get_schema(recursion_depth + 1)
                    ), True
                ),
                ...
                StructField(
                    "totalNet", MoneySchema.get_schema(recursion_depth + 1),
                    True
                ),
                # Invoice total, tax included.
                StructField(
                    "totalGross", MoneySchema.get_schema(recursion_depth + 1),
                    True
                ),
