...
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.diagnosticreport_media import DiagnosticReport_Media
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("resultsInterpreter",ArrayType(Reference.get_schema()), True),
                StructField("specimen",ArrayType(Reference.get_schema()), True),
                StructField("result",ArrayType(Reference.get_schema()), True),
                StructField("imagingStudy",ArrayType(Reference.get_schema()), True),
                StructField("media",ArrayType(DiagnosticReport_Media.get_schema()), True),
                StructField("conclusion", StringType(), True),
                StructField("conclusionCode",ArrayType(CodeableConcept.get_schema()), True),
                StructField("presentedForm",ArrayType(Attachment.get_schema()), True),]
        )
