...
class MedicinalProductAuthorizationSchema:
    ...
    def get_schema(
        ...
        my_parent_path = (
            parent_path + ".medicinalproductauthorization"
            if parent_path
            else "medicinalproductauthorization"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".restoredate",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".dateoffirstauthorization",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".internationalbirthdate",
                    ),
                    True,
                ),
