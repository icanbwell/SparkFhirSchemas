...
from spark_fhir_schemas.r4.resources.careteam_participant import CareTeam_Participant
from spark_fhir_schemas.r4.resources.codeableconcept import CodeableConcept
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.reference import Reference
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("participant",ArrayType(CareTeam_Participant.get_schema()), True),
                ...
                StructField("managingOrganization",ArrayType(Reference.get_schema()), True),
