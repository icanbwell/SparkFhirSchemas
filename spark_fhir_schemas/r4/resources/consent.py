...
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.consent_policy import Consent_Policy
from spark_fhir_schemas.r4.resources.codeableconcept import CodeableConcept
from spark_fhir_schemas.r4.resources.consent_verification import Consent_Verification
from spark_fhir_schemas.r4.resources.consent_provision import Consent_Provision
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("organization",ArrayType(Reference.get_schema()), True),
                StructField("sourceAttachment", Attachment.get_schema(), True),
                StructField("sourceReference", Reference.get_schema(), True),
                StructField("policy",ArrayType(Consent_Policy.get_schema()), True),
                StructField("policyRule", CodeableConcept.get_schema(), True),
                StructField("verification",ArrayType(Consent_Verification.get_schema()), True),
