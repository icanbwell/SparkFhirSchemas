    ...
    def get_schema(recursion_depth: int = 0) -> Union[StructType, DataType]:
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "metadata",
                    TestScript_MetadataSchema.get_schema(recursion_depth + 1),
                    True
                ),
                ...
                StructField(
                    "setup",
                    TestScript_SetupSchema.get_schema(recursion_depth + 1),
                    True
                ),
                ...
                StructField(
                    "test",
                    ArrayType(
                        TestScript_TestSchema.get_schema(recursion_depth + 1)
                    ), True
                ),
                ...
                StructField(
                    "teardown",
                    TestScript_TeardownSchema.get_schema(recursion_depth + 1),
                    True
                ),
            ]
        )
