...
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.careplan_detail import CarePlan_Detail
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("outcomeCodeableConcept",ArrayType(CodeableConcept.get_schema()), True),
                StructField("outcomeReference",ArrayType(Reference.get_schema()), True),
                StructField("progress",ArrayType(Annotation.get_schema()), True),
