...
from spark_fhir_schemas.r4.resources.device_udicarrier import Device_UdiCarrier
...
from spark_fhir_schemas.r4.resources.string import string
from spark_fhir_schemas.r4.resources.string import string
from spark_fhir_schemas.r4.resources.device_devicename import Device_DeviceName
from spark_fhir_schemas.r4.resources.string import string
from spark_fhir_schemas.r4.resources.string import string
from spark_fhir_schemas.r4.resources.codeableconcept import CodeableConcept
from spark_fhir_schemas.r4.resources.device_specialization import Device_Specialization
from spark_fhir_schemas.r4.resources.device_version import Device_Version
from spark_fhir_schemas.r4.resources.device_property import Device_Property
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.reference import Reference
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("udiCarrier",ArrayType(Device_UdiCarrier.get_schema()), True),
                ...
                StructField("deviceName",ArrayType(Device_DeviceName.get_schema()), True),
                StructField("modelNumber", StringType(), True),
                StructField("partNumber", StringType(), True),
                StructField("type", CodeableConcept.get_schema(), True),
                StructField("specialization",ArrayType(Device_Specialization.get_schema()), True),
                StructField("version",ArrayType(Device_Version.get_schema()), True),
                StructField("property",ArrayType(Device_Property.get_schema()), True),
