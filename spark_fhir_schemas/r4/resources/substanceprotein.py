...
class SubstanceProteinSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.substanceprotein_subunit import (
            SubstanceProtein_SubunitSchema,
        )
        ...
        my_parent_path = (
            parent_path + ".substanceprotein" if parent_path else "substanceprotein"
        )
        schema = StructType(
            [
