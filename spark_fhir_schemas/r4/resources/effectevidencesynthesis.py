...
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.effectevidencesynthesis_samplesize import EffectEvidenceSynthesis_SampleSize
from spark_fhir_schemas.r4.resources.effectevidencesynthesis_resultsbyexposure import EffectEvidenceSynthesis_ResultsByExposure
from spark_fhir_schemas.r4.resources.effectevidencesynthesis_effectestimate import EffectEvidenceSynthesis_EffectEstimate
from spark_fhir_schemas.r4.resources.effectevidencesynthesis_certainty import EffectEvidenceSynthesis_Certainty
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("sampleSize", EffectEvidenceSynthesis_SampleSize.get_schema(), True),
                StructField("resultsByExposure",ArrayType(EffectEvidenceSynthesis_ResultsByExposure.get_schema()), True),
                StructField("effectEstimate",ArrayType(EffectEvidenceSynthesis_EffectEstimate.get_schema()), True),
                StructField("certainty",ArrayType(EffectEvidenceSynthesis_Certainty.get_schema()), True),]
        )
