    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "exposureAlternative", Reference.get_schema(), True
                ),
                StructField("outcome", Reference.get_schema(), True),
                StructField(
                    "sampleSize",
                    EffectEvidenceSynthesis_SampleSize.get_schema(), True
                ),
                StructField(
                    "resultsByExposure",
                    ArrayType(
                        EffectEvidenceSynthesis_ResultsByExposure.get_schema()
                    ), True
                ),
                StructField(
                    "effectEstimate",
                    ArrayType(
                        EffectEvidenceSynthesis_EffectEstimate.get_schema()
                    ), True
                ),
                StructField(
                    "certainty",
                    ArrayType(EffectEvidenceSynthesis_Certainty.get_schema()),
                    True
                ),
            ]
        )
