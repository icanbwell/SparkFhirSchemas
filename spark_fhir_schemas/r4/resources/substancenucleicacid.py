...
class SubstanceNucleicAcidSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.substancenucleicacid_subunit import (
            SubstanceNucleicAcid_SubunitSchema,
        )
        ...
        my_parent_path = (
            parent_path + ".substancenucleicacid"
            if parent_path
            else "substancenucleicacid"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    integerSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".numberofsubunits",
                    ),
                    True,
                ),
