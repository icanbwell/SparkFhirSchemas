...
from spark_fhir_schemas.r4.resources.claimresponse_detail import ClaimResponse_Detail
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("detail",ArrayType(ClaimResponse_Detail.get_schema()), True),]
        )
