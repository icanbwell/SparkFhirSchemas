...
class DeviceRequestSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.devicerequest_parameter import DeviceRequest_ParameterSchema
        ...
        my_recursion_list: List[str] = recursion_list + ["DeviceRequest"]
        schema = StructType(
            [
