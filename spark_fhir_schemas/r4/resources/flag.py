...
class Flag:
    ...
    def get_schema(recursion_depth: int = 0) -> Union[StructType, DataType]:
        ...
        identifier: Business identifiers assigned to this flag by the performer or other systems
        ...
        subject: The patient, location, group, organization, or practitioner etc. this is about
