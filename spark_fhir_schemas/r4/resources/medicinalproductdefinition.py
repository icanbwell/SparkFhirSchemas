...
class MedicinalProductDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.medicinalproductdefinition_contact import (
            MedicinalProductDefinition_ContactSchema,
        )
        from spark_fhir_schemas.r4.complex_types.coding import CodingSchema
        from spark_fhir_schemas.r4.complex_types.medicinalproductdefinition_name import (
            MedicinalProductDefinition_NameSchema,
        )
        from spark_fhir_schemas.r4.complex_types.medicinalproductdefinition_crossreference import (
            MedicinalProductDefinition_CrossReferenceSchema,
        )
        from spark_fhir_schemas.r4.complex_types.medicinalproductdefinition_operation import (
            MedicinalProductDefinition_OperationSchema,
        )
        from spark_fhir_schemas.r4.complex_types.medicinalproductdefinition_characteristic import (
