...
from spark_fhir_schemas.r4.complex_types.researchelementdefinition_characteristic import ResearchElementDefinition_Characteristic
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("characteristic",ArrayType(ResearchElementDefinition_Characteristic.get_schema()), True),
            ]
        )
