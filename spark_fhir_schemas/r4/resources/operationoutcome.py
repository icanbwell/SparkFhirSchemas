...
class OperationOutcomeSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.operationoutcome_issue import OperationOutcome_IssueSchema
        if recursion_list.count(
            "OperationOutcome"
        ) >= 2 or recursion_depth >= max_recursion_depth:
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_recursion_list: List[str] = recursion_list + ["OperationOutcome"]
        schema = StructType(
            [
