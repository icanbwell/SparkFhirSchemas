...
from spark_fhir_schemas.r4.resources.claimresponse_subdetail1 import ClaimResponse_SubDetail1
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("subDetail",ArrayType(ClaimResponse_SubDetail1.get_schema()), True),]
        )
