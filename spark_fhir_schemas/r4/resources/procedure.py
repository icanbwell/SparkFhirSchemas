...
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.procedure_performer import Procedure_Performer
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.codeableconcept import CodeableConcept
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.codeableconcept import CodeableConcept
...
from spark_fhir_schemas.r4.resources.procedure_focaldevice import Procedure_FocalDevice
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.codeableconcept import CodeableConcept
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("performer",ArrayType(Procedure_Performer.get_schema()), True),
                ...
                StructField("complication",ArrayType(CodeableConcept.get_schema()), True),
                StructField("complicationDetail",ArrayType(Reference.get_schema()), True),
                StructField("followUp",ArrayType(CodeableConcept.get_schema()), True),
                StructField("note",ArrayType(Annotation.get_schema()), True),
                StructField("focalDevice",ArrayType(Procedure_FocalDevice.get_schema()), True),
                StructField("usedReference",ArrayType(Reference.get_schema()), True),
                StructField("usedCode",ArrayType(CodeableConcept.get_schema()), True),]
        )
