...
from spark_fhir_schemas.r4.resources.chargeitemdefinition_propertygroup import ChargeItemDefinition_PropertyGroup
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("derivedFromUri",ArrayType(uri.get_schema()), True),
                ...
                StructField("instance",ArrayType(Reference.get_schema()), True),
                StructField("applicability",ArrayType(ChargeItemDefinition_Applicability.get_schema()), True),
                StructField("propertyGroup",ArrayType(ChargeItemDefinition_PropertyGroup.get_schema()), True),]
        )
