...
class TaskSchema:
    ...
    def get_schema(recursion_depth: int = 0) -> Union[StructType, DataType]:
        ...
        from spark_fhir_schemas.r4.complex_types.task_restriction import Task_RestrictionSchema
        ...
        schema = StructType(
            [
                ...
                # task (e.g., the patient).
                StructField(
                    "for", ReferenceSchema.get_schema(recursion_depth + 1),
                    True
                ),
                ...
                StructField(
                    "restriction",
                    Task_RestrictionSchema.get_schema(recursion_depth + 1),
                    True
                ),
                ...
                StructField(
                    "input",
                    ArrayType(
                        Task_InputSchema.get_schema(recursion_depth + 1)
                    ), True
                ),
                ...
                StructField(
                    "output",
                    ArrayType(
                        Task_OutputSchema.get_schema(recursion_depth + 1)
                    ), True
                ),
            ]
        )
