    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "synthesisType", CodeableConcept.get_schema(), True
                ),
                ...
                StructField(
                    "sampleSize",
                    RiskEvidenceSynthesis_SampleSize.get_schema(), True
                ),
                StructField(
                    "riskEstimate",
                    RiskEvidenceSynthesis_RiskEstimate.get_schema(), True
                ),
                StructField(
                    "certainty",
                    ArrayType(RiskEvidenceSynthesis_Certainty.get_schema()),
                    True
                ),
            ]
        )
