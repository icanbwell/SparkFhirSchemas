...
class RiskEvidenceSynthesis:
    ...
    def get_schema(recursion_depth: int = 0) -> Union[StructType, DataType]:
        ...
        from spark_fhir_schemas.r4.complex_types.riskevidencesynthesis_samplesize import RiskEvidenceSynthesis_SampleSize
        from spark_fhir_schemas.r4.complex_types.riskevidencesynthesis_riskestimate import RiskEvidenceSynthesis_RiskEstimate
        from spark_fhir_schemas.r4.complex_types.riskevidencesynthesis_certainty import RiskEvidenceSynthesis_Certainty
