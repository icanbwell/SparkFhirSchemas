    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "accessionIdentifier", Identifier.get_schema(), True
                ),
                ...
                StructField(
                    "request", ArrayType(Reference.get_schema()), True
                ),
                StructField(
                    "collection", Specimen_Collection.get_schema(), True
                ),
                StructField(
                    "processing", ArrayType(Specimen_Processing.get_schema()),
                    True
                ),
                StructField(
                    "container", ArrayType(Specimen_Container.get_schema()),
                    True
                ),
                StructField(
