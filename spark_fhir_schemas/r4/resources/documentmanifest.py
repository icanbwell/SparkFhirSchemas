...
from spark_fhir_schemas.r4.resources.reference import Reference
from spark_fhir_schemas.r4.resources.documentmanifest_related import DocumentManifest_Related
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("content",ArrayType(Reference.get_schema()), True),
                StructField("related",ArrayType(DocumentManifest_Related.get_schema()), True),]
        )
