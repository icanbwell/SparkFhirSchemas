...
from spark_fhir_schemas.r4.resources.explanationofbenefit_detail1 import ExplanationOfBenefit_Detail1
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("detail",ArrayType(ExplanationOfBenefit_Detail1.get_schema()), True),]
        )
