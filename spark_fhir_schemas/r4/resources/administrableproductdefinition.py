...
class AdministrableProductDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.administrableproductdefinition_property import (
            AdministrableProductDefinition_PropertySchema,
        )
        from spark_fhir_schemas.r4.complex_types.administrableproductdefinition_routeofadministration import (
