...
class PackagedProductDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.packagedproductdefinition_legalstatusofsupply import (
        ...
        from spark_fhir_schemas.r4.complex_types.packagedproductdefinition_package import (
