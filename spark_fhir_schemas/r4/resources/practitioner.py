...
from spark_fhir_schemas.r4.resources.practitioner_qualification import Practitioner_Qualification
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("qualification",ArrayType(Practitioner_Qualification.get_schema()), True),
