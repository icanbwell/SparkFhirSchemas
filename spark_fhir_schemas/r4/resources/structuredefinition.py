...
from spark_fhir_schemas.r4.resources.structuredefinition_mapping import StructureDefinition_Mapping
from spark_fhir_schemas.r4.resources.boolean import boolean
from spark_fhir_schemas.r4.resources.structuredefinition_context import StructureDefinition_Context
from spark_fhir_schemas.r4.resources.string import string
from spark_fhir_schemas.r4.resources.uri import uri
from spark_fhir_schemas.r4.resources.canonical import canonical
from spark_fhir_schemas.r4.resources.structuredefinition_snapshot import StructureDefinition_Snapshot
from spark_fhir_schemas.r4.resources.structuredefinition_differential import StructureDefinition_Differential
    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("mapping",ArrayType(StructureDefinition_Mapping.get_schema()), True),
                StructField("kind", StringType(), True),
                StructField("abstract", BooleanType(), True),
                StructField("context",ArrayType(StructureDefinition_Context.get_schema()), True),
                StructField("contextInvariant",ArrayType(string.get_schema()), True),
                ...
                StructField("snapshot", StructureDefinition_Snapshot.get_schema(), True),
                StructField("differential", StructureDefinition_Differential.get_schema(), True),]
        )
