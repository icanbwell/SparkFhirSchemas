...
class MedicinalProductPharmaceuticalSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.medicinalproductpharmaceutical_characteristics import (
            MedicinalProductPharmaceutical_CharacteristicsSchema,
        )
        from spark_fhir_schemas.r4.complex_types.medicinalproductpharmaceutical_routeofadministration import (
        ...
        my_parent_path = (
            parent_path + ".medicinalproductpharmaceutical"
            if parent_path
            else "medicinalproductpharmaceutical"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "characteristics",
                    ArrayType(
                        MedicinalProductPharmaceutical_CharacteristicsSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    ...
                    ArrayType(
                        MedicinalProductPharmaceutical_RouteOfAdministrationSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
