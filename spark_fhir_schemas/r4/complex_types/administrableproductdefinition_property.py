...
class AdministrableProductDefinition_PropertySchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("AdministrableProductDefinition_Property")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".administrableproductdefinition_property"
            if parent_path
            else "administrableproductdefinition_property"
        )
        schema = StructType(
            [
