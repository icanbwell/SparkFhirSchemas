...
class ManufacturedItemDefinition_PropertySchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("ManufacturedItemDefinition_Property")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".manufactureditemdefinition_property"
            if parent_path
            else "manufactureditemdefinition_property"
        )
        schema = StructType(
            [
