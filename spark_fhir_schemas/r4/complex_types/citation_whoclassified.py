...
class Citation_WhoClassifiedSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Citation_WhoClassified") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Citation_WhoClassified"]
        my_parent_path = (
            parent_path + ".citation_whoclassified"
            if parent_path
            else "citation_whoclassified"
        )
        schema = StructType(
            [
                ...
                StructField("classifierCopyright", StringType(), True),
                # Acceptable to re-use the classification.
                StructField("freeToShare", BooleanType(), True),
            ]
        )
