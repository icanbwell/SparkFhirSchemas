...
class SampledDataSchema:
    ...
    def get_schema(
        ...
        my_parent_path = parent_path + ".sampleddata" if parent_path else "sampleddata"
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    decimalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".lowerlimit",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    decimalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".upperlimit",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    positiveIntSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".dimensions",
                    ),
                    True,
                ),
