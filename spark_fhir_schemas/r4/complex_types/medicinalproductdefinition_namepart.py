...
class MedicinalProductDefinition_NamePartSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductDefinition_NamePart")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".medicinalproductdefinition_namepart"
            if parent_path
            else "medicinalproductdefinition_namepart"
        )
        schema = StructType(
            [
