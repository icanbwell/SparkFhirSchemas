    ...
    def get_schema(recursion_depth: int = 0) -> Union[StructType, DataType]:
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "min", unsignedIntSchema.get_schema(recursion_depth + 1),
                    True
                ),
                ...
                # elements/attributes must also be missing.
                StructField(
                    "fixedAge", AgeSchema.get_schema(recursion_depth + 1), True
                ),
                # Specifies a value that SHALL be exactly the value  for this element in the
                # instance. For purposes of comparison, non-significant whitespace is ignored,
                # and all values must be an exact match (case and accent sensitive). Missing
                ...
                # elements/attributes must also be missing.
                StructField(
                    "fixedCount", CountSchema.get_schema(recursion_depth + 1),
                    True
                ),
                # Specifies a value that SHALL be exactly the value  for this element in the
                # instance. For purposes of comparison, non-significant whitespace is ignored,
                ...
                # elements/attributes must also be missing.
                StructField(
                    "fixedMoney", MoneySchema.get_schema(recursion_depth + 1),
                    True
                ),
                # Specifies a value that SHALL be exactly the value  for this element in the
                # instance. For purposes of comparison, non-significant whitespace is ignored,
                ...
                # elements/attributes must also be missing.
                StructField(
                    "fixedRange", RangeSchema.get_schema(recursion_depth + 1),
                    True
                ),
                # Specifies a value that SHALL be exactly the value  for this element in the
                # instance. For purposes of comparison, non-significant whitespace is ignored,
                ...
                # elements/attributes must also be missing.
                StructField(
                    "fixedRatio", RatioSchema.get_schema(recursion_depth + 1),
                    True
                ),
                # Specifies a value that SHALL be exactly the value  for this element in the
                # instance. For purposes of comparison, non-significant whitespace is ignored,
                ...
                # elements/attributes must also be missing.
                StructField(
                    "fixedMeta", MetaSchema.get_schema(recursion_depth + 1),
                    True
                ),
                ...
                # 3. If an array: it must match (recursively) the pattern value.
                StructField(
                    "patternAge", AgeSchema.get_schema(recursion_depth + 1),
                    True
                ),
                # Specifies a value that the value in the instance SHALL follow - that is, any
                # value in the pattern must be found in the instance. Other additional values
                ...
                # 3. If an array: it must match (recursively) the pattern value.
                StructField(
                    "patternMeta", MetaSchema.get_schema(recursion_depth + 1),
                    True
                ),
