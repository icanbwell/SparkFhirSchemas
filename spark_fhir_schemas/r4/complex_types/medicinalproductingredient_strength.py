...
class MedicinalProductIngredient_StrengthSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.medicinalproductingredient_referencestrength import (
        ...
        my_parent_path = (
            parent_path + ".medicinalproductingredient_strength"
            if parent_path
            else "medicinalproductingredient_strength"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "referenceStrength",
                    ArrayType(
                        MedicinalProductIngredient_ReferenceStrengthSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
