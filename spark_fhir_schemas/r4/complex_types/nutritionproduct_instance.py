...
class NutritionProduct_InstanceSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("NutritionProduct_Instance") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["NutritionProduct_Instance"]
        my_parent_path = (
            parent_path + ".nutritionproduct_instance"
            if parent_path
            else "nutritionproduct_instance"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".expiry",
                    ),
                    True,
                ),
                # The time after which the product is no longer expected to be in proper
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".useby",
                    ),
                    True,
                ),
            ]
