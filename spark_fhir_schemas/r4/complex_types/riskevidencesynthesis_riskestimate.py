...
class RiskEvidenceSynthesis_RiskEstimateSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.riskevidencesynthesis_precisionestimate import (
        ...
        my_parent_path = (
            parent_path + ".riskevidencesynthesis_riskestimate"
            if parent_path
            else "riskevidencesynthesis_riskestimate"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    integerSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".denominatorcount",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    integerSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".numeratorcount",
                    ),
                    True,
                ),
                ...
                StructField(
                    "precisionEstimate",
                    ArrayType(
                        RiskEvidenceSynthesis_PrecisionEstimateSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
