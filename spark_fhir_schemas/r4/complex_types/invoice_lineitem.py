    ...
    def get_schema() -> StructType:
        ...
        schema = StructType(
            [
                ...
                StructField("chargeItemReference", Reference.get_schema(), True),
                StructField("chargeItemCodeableConcept", CodeableConcept.get_schema(), True),
                StructField("priceComponent",ArrayType(Invoice_PriceComponent.get_schema()), True),
            ]
        )
