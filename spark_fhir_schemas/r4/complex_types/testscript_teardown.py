...
class TestScript_TeardownSchema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.r4.complex_types.testscript_action2 import TestScript_Action2Schema
        if recursion_list.count(
            "TestScript_Teardown"
        ) >= 2 or recursion_depth >= max_recursion_depth:
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_recursion_list: List[str] = recursion_list + ["TestScript_Teardown"]
        schema = StructType(
            [
