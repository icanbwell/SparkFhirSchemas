    ...
    def get_schema(recursion_depth: int = 0) -> Union[StructType, DataType]:
        ...
        schema = StructType(
            [
                ...
                # encoding, if that is done).
                StructField(
                    "size", unsignedIntSchema.get_schema(recursion_depth + 1),
                    True
                ),
                # The calculated hash of the data using SHA-1. Represented using base64.
                StructField(
                    "hash", base64BinarySchema.get_schema(recursion_depth + 1),
                    True
                ),
                ...
                StructField(
                    "creation", dateTimeSchema.get_schema(recursion_depth + 1),
                    True
                ),
            ]
        )
