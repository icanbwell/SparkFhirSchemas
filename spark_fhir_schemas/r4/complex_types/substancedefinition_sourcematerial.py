...
class SubstanceDefinition_SourceMaterialSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubstanceDefinition_SourceMaterial")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".substancedefinition_sourcematerial"
            if parent_path
            else "substancedefinition_sourcematerial"
        )
        schema = StructType(
            [
