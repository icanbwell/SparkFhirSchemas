...
class SubscriptionTopic_NotificationShapeSchema:
    """
    ...
    def get_schema(
        ...
        resource: URL of the Resource that is the type used in this shape. This is the "focus"
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubscriptionTopic_NotificationShape")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".subscriptiontopic_notificationshape"
            if parent_path
            else "subscriptiontopic_notificationshape"
        )
        schema = StructType(
            [
                ...
                # authorized to receive them.  Clients SHOULD be prepared to receive these
                # additional resources, but SHALL function properly without them.
                StructField("revInclude", ArrayType(StringType()), True),
            ]
        )
