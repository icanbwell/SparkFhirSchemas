...
class SubstanceDefinition_MoietySchema:
    """
    ...
    def get_schema(
        ...
        molecularFormula: Molecular formula for this moiety of this substance, typically using the Hill
            system.
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubstanceDefinition_Moiety") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["SubstanceDefinition_Moiety"]
        my_parent_path = (
            parent_path + ".substancedefinition_moiety"
            if parent_path
            else "substancedefinition_moiety"
        )
        schema = StructType(
            [
