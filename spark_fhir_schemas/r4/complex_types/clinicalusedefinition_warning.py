...
class ClinicalUseDefinition_WarningSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("ClinicalUseDefinition_Warning")
            >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["ClinicalUseDefinition_Warning"]
        my_parent_path = (
            parent_path + ".clinicalusedefinition_warning"
            if parent_path
            else "clinicalusedefinition_warning"
        )
        schema = StructType(
            [
