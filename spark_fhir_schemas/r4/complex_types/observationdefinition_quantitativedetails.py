...
class ObservationDefinition_QuantitativeDetailsSchema:
    ...
    def get_schema(
        ...
        my_parent_path = (
            parent_path + ".observationdefinition_quantitativedetails"
            if parent_path
            else "observationdefinition_quantitativedetails"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    decimalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".conversionfactor",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    integerSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".decimalprecision",
                    ),
                    True,
                ),
            ]
