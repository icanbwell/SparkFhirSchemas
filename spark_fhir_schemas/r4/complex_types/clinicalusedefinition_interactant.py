...
class ClinicalUseDefinition_InteractantSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("ClinicalUseDefinition_Interactant")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".clinicalusedefinition_interactant"
            if parent_path
            else "clinicalusedefinition_interactant"
        )
        schema = StructType(
            [
