...
class MedicinalProductDefinition_NameSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.medicinalproductdefinition_namepart import (
            MedicinalProductDefinition_NamePartSchema,
        )
        from spark_fhir_schemas.r4.complex_types.medicinalproductdefinition_countrylanguage import (
