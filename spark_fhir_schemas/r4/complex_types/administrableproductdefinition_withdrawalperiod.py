...
class AdministrableProductDefinition_WithdrawalPeriodSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("AdministrableProductDefinition_WithdrawalPeriod")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".administrableproductdefinition_withdrawalperiod"
            if parent_path
            else "administrableproductdefinition_withdrawalperiod"
        )
        schema = StructType(
            [
