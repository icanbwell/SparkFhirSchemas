...
class EffectEvidenceSynthesis_PrecisionEstimateSchema:
    """
    ...
    def get_schema(
        ...
        my_parent_path = (
            parent_path + ".effectevidencesynthesis_precisionestimate"
            if parent_path
            else "effectevidencesynthesis_precisionestimate"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    decimalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".from",
                    ),
                    True,
                ),
