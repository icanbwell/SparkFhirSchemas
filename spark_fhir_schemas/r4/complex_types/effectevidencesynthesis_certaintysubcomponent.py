...
class EffectEvidenceSynthesis_CertaintySubcomponentSchema:
    """
    ...
    def get_schema(
        ...
        my_parent_path = (
            parent_path + ".effectevidencesynthesis_certaintysubcomponent"
            if parent_path
            else "effectevidencesynthesis_certaintysubcomponent"
        )
        schema = StructType(
            [
