...
class MedicinalProductPharmaceutical_WithdrawalPeriodSchema:
    """
    ...
    def get_schema(
        ...
        my_parent_path = (
            parent_path + ".medicinalproductpharmaceutical_withdrawalperiod"
            if parent_path
            else "medicinalproductpharmaceutical_withdrawalperiod"
        )
        schema = StructType(
            [
