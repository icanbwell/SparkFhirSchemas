...
class MolecularSequence_ReferenceSeqSchema:
    ...
    def get_schema(
        ...
        my_parent_path = (
            parent_path + ".molecularsequence_referenceseq"
            if parent_path
            else "molecularsequence_referenceseq"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    integerSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".windowstart",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    integerSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".windowend",
                    ),
                    True,
                ),
            ]
