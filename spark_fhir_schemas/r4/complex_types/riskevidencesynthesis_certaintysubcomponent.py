...
class RiskEvidenceSynthesis_CertaintySubcomponentSchema:
    """
    ...
    def get_schema(
        ...
        my_parent_path = (
            parent_path + ".riskevidencesynthesis_certaintysubcomponent"
            if parent_path
            else "riskevidencesynthesis_certaintysubcomponent"
        )
        schema = StructType(
            [
