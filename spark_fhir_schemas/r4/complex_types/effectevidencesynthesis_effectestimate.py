...
class EffectEvidenceSynthesis_EffectEstimateSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4.complex_types.effectevidencesynthesis_precisionestimate import (
            EffectEvidenceSynthesis_PrecisionEstimateSchema,
        )
        ...
        my_parent_path = (
            parent_path + ".effectevidencesynthesis_effectestimate"
            if parent_path
            else "effectevidencesynthesis_effectestimate"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "precisionEstimate",
                    ArrayType(
                        EffectEvidenceSynthesis_PrecisionEstimateSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
