...
class AutoMapperElasticSearchRiskEvidenceSynthesis(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        riskEstimate: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.riskevidencesynthesis_samplesize import (
            AutoMapperElasticSearchRiskEvidenceSynthesis_SampleSize as RiskEvidenceSynthesis_SampleSizeSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.riskevidencesynthesis_riskestimate import (
            AutoMapperElasticSearchRiskEvidenceSynthesis_RiskEstimate as RiskEvidenceSynthesis_RiskEstimateSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.riskevidencesynthesis_certainty import (
            AutoMapperElasticSearchRiskEvidenceSynthesis_Certainty as RiskEvidenceSynthesis_CertaintySchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("RiskEvidenceSynthesis") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "sampleSize",
                    RiskEvidenceSynthesis_SampleSizeSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "riskEstimate",
                    RiskEvidenceSynthesis_RiskEstimateSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "certainty",
                    ArrayType(
                        RiskEvidenceSynthesis_CertaintySchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
