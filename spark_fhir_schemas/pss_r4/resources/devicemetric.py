...
class AutoMapperElasticSearchDeviceMetric(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        measurementPeriod: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.devicemetric_calibration import (
            AutoMapperElasticSearchDeviceMetric_Calibration as DeviceMetric_CalibrationSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "calibration",
                    ArrayType(
                        DeviceMetric_CalibrationSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
