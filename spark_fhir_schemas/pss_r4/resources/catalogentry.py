...
class AutoMapperElasticSearchCatalogEntry(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        orderable: Optional[Any] = None,
        referencedItem: Optional[Any] = None,
        additionalIdentifier: Optional[Any] = None,
        classification: Optional[Any] = None,
        status: Optional[Any] = None,
        validityPeriod: Optional[Any] = None,
        validTo: Optional[Any] = None,
        lastUpdated: Optional[Any] = None,
        additionalCharacteristic: Optional[Any] = None,
        additionalClassification: Optional[Any] = None,
        relatedEntry: Optional[Any] = None,
    ) -> None:
        super().__init__(
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.catalogentry_relatedentry import (
            AutoMapperElasticSearchCatalogEntry_RelatedEntry as CatalogEntry_RelatedEntrySchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "relatedEntry",
                    ArrayType(
                        CatalogEntry_RelatedEntrySchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
