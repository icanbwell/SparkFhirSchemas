...
class AutoMapperElasticSearchMedication(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.medication_ingredient import (
            AutoMapperElasticSearchMedication_Ingredient as Medication_IngredientSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.medication_batch import (
            AutoMapperElasticSearchMedication_Batch as Medication_BatchSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "ingredient",
                    ArrayType(
                        Medication_IngredientSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
