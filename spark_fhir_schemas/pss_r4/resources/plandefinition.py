...
class AutoMapperElasticSearchPlanDefinition(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.plandefinition_goal import (
            AutoMapperElasticSearchPlanDefinition_Goal as PlanDefinition_GoalSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.plandefinition_action import (
            AutoMapperElasticSearchPlanDefinition_Action as PlanDefinition_ActionSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "goal",
                    ArrayType(
                        PlanDefinition_GoalSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
