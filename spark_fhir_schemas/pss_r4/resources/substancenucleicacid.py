...
class AutoMapperElasticSearchSubstanceNucleicAcid(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        areaOfHybridisation: Optional[Any] = None,
        oligoNucleotideType: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.substancenucleicacid_subunit import (
            AutoMapperElasticSearchSubstanceNucleicAcid_Subunit as SubstanceNucleicAcid_SubunitSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("SubstanceNucleicAcid") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "subunit",
                    ArrayType(
                        SubstanceNucleicAcid_SubunitSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
