...
class AutoMapperElasticSearchLinkage(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        author: Identifies the user or organization responsible for asserting the linkages as
        ...
        from spark_fhir_schemas.pss_r4.complex_types.linkage_item import (
            AutoMapperElasticSearchLinkage_Item as Linkage_ItemSchema,
        )
