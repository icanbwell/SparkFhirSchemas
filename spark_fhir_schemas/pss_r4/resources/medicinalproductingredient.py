...
class AutoMapperElasticSearchMedicinalProductIngredient(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        allergenicIndicator: Optional[Any] = None,
        manufacturer: Optional[Any] = None,
        specifiedSubstance: Optional[Any] = None,
    ...
    def schema(
        ...
        identifier: The identifier(s) of this Ingredient that are assigned by business processes
        ...
        from spark_fhir_schemas.pss_r4.complex_types.medicinalproductingredient_specifiedsubstance import (
            AutoMapperElasticSearchMedicinalProductIngredient_SpecifiedSubstance as MedicinalProductIngredient_SpecifiedSubstanceSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.medicinalproductingredient_substance import (
            AutoMapperElasticSearchMedicinalProductIngredient_Substance as MedicinalProductIngredient_SubstanceSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductIngredient") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["MedicinalProductIngredient"]
        schema = StructType(
            [
                ...
                StructField(
                    "specifiedSubstance",
                    ArrayType(
                        MedicinalProductIngredient_SpecifiedSubstanceSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "substance",
                    MedicinalProductIngredient_SubstanceSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
