...
class AutoMapperElasticSearchBiologicallyDerivedProduct(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        productCategory: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.biologicallyderivedproduct_collection import (
            AutoMapperElasticSearchBiologicallyDerivedProduct_Collection as BiologicallyDerivedProduct_CollectionSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.biologicallyderivedproduct_processing import (
            AutoMapperElasticSearchBiologicallyDerivedProduct_Processing as BiologicallyDerivedProduct_ProcessingSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.biologicallyderivedproduct_manipulation import (
            AutoMapperElasticSearchBiologicallyDerivedProduct_Manipulation as BiologicallyDerivedProduct_ManipulationSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.biologicallyderivedproduct_storage import (
            AutoMapperElasticSearchBiologicallyDerivedProduct_Storage as BiologicallyDerivedProduct_StorageSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "collection",
                    BiologicallyDerivedProduct_CollectionSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "processing",
                    ArrayType(
                        BiologicallyDerivedProduct_ProcessingSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "manipulation",
                    BiologicallyDerivedProduct_ManipulationSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "storage",
                    ArrayType(
                        BiologicallyDerivedProduct_StorageSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
