...
class AutoMapperElasticSearchPaymentReconciliation(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        paymentIssuer: Optional[Any] = None,
        request: Optional[Any] = None,
        requestor: Optional[Any] = None,
        outcome: Optional[Any] = None,
        disposition: Optional[Any] = None,
        paymentDate: Optional[Any] = None,
        paymentAmount: Optional[Any] = None,
        paymentIdentifier: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.paymentreconciliation_detail import (
            AutoMapperElasticSearchPaymentReconciliation_Detail as PaymentReconciliation_DetailSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.codeableconcept import (
            AutoMapperElasticSearchCodeableConcept as CodeableConceptSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.paymentreconciliation_processnote import (
            AutoMapperElasticSearchPaymentReconciliation_ProcessNote as PaymentReconciliation_ProcessNoteSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "detail",
                    ArrayType(
                        PaymentReconciliation_DetailSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "processNote",
                    ArrayType(
                        PaymentReconciliation_ProcessNoteSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
