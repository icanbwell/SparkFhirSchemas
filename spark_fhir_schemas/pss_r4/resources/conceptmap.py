...
class AutoMapperElasticSearchConceptMap(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        sourceUri: Optional[Any] = None,
        sourceCanonical: Optional[Any] = None,
        targetUri: Optional[Any] = None,
        targetCanonical: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.conceptmap_group import (
            AutoMapperElasticSearchConceptMap_Group as ConceptMap_GroupSchema,
        )
