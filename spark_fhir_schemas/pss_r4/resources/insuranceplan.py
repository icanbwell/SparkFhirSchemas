...
class AutoMapperElasticSearchInsurancePlan(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        ownedBy: Optional[Any] = None,
        administeredBy: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.insuranceplan_contact import (
            AutoMapperElasticSearchInsurancePlan_Contact as InsurancePlan_ContactSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.insuranceplan_coverage import (
            AutoMapperElasticSearchInsurancePlan_Coverage as InsurancePlan_CoverageSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.insuranceplan_plan import (
            AutoMapperElasticSearchInsurancePlan_Plan as InsurancePlan_PlanSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("InsurancePlan") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "contact",
                    ArrayType(
                        InsurancePlan_ContactSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "coverage",
                    ArrayType(
                        InsurancePlan_CoverageSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "plan",
                    ArrayType(
                        InsurancePlan_PlanSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
