...
class AutoMapperElasticSearchValueSet(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.valueset_compose import (
            AutoMapperElasticSearchValueSet_Compose as ValueSet_ComposeSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.valueset_expansion import (
            AutoMapperElasticSearchValueSet_Expansion as ValueSet_ExpansionSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "expansion",
                    ValueSet_ExpansionSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
