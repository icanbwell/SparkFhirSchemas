...
class AutoMapperElasticSearchQuestionnaire(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.questionnaire_item import (
            AutoMapperElasticSearchQuestionnaire_Item as Questionnaire_ItemSchema,
        )
