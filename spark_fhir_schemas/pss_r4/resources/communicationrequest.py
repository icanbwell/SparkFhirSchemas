...
class AutoMapperElasticSearchCommunicationRequest(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.communicationrequest_payload import (
            AutoMapperElasticSearchCommunicationRequest_Payload as CommunicationRequest_PayloadSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "payload",
                    ArrayType(
                        CommunicationRequest_PayloadSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
