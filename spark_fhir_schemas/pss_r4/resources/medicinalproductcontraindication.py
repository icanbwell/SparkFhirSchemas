...
class AutoMapperElasticSearchMedicinalProductContraindication(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        diseaseStatus: Optional[Any] = None,
        comorbidity: Optional[Any] = None,
        therapeuticIndication: Optional[Any] = None,
        otherTherapy: Optional[Any] = None,
    ...
    def schema(
        ...
        therapeuticIndication: Information about the use of the medicinal product in relation to other
        ...
        from spark_fhir_schemas.pss_r4.complex_types.medicinalproductcontraindication_othertherapy import (
            AutoMapperElasticSearchMedicinalProductContraindication_OtherTherapy as MedicinalProductContraindication_OtherTherapySchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.population import (
            AutoMapperElasticSearchPopulation as PopulationSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductContraindication")
            >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["MedicinalProductContraindication"]
        schema = StructType(
            [
                ...
                StructField(
                    "otherTherapy",
                    ArrayType(
                        MedicinalProductContraindication_OtherTherapySchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
