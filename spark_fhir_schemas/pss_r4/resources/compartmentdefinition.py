...
class AutoMapperElasticSearchCompartmentDefinition(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.compartmentdefinition_resource import (
            AutoMapperElasticSearchCompartmentDefinition_Resource as CompartmentDefinition_ResourceSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "resource",
                    ArrayType(
                        CompartmentDefinition_ResourceSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
