...
class AutoMapperElasticSearchCoverageEligibilityRequest(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.coverageeligibilityrequest_supportinginfo import (
            AutoMapperElasticSearchCoverageEligibilityRequest_SupportingInfo as CoverageEligibilityRequest_SupportingInfoSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.coverageeligibilityrequest_insurance import (
            AutoMapperElasticSearchCoverageEligibilityRequest_Insurance as CoverageEligibilityRequest_InsuranceSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.coverageeligibilityrequest_item import (
            AutoMapperElasticSearchCoverageEligibilityRequest_Item as CoverageEligibilityRequest_ItemSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "supportingInfo",
                    ArrayType(
                        CoverageEligibilityRequest_SupportingInfoSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "insurance",
                    ArrayType(
                        CoverageEligibilityRequest_InsuranceSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "item",
                    ArrayType(
                        CoverageEligibilityRequest_ItemSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
