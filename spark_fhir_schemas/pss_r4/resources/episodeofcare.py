...
class AutoMapperElasticSearchEpisodeOfCare(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        referralRequest: Optional[Any] = None,
        careManager: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.episodeofcare_statushistory import (
            AutoMapperElasticSearchEpisodeOfCare_StatusHistory as EpisodeOfCare_StatusHistorySchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.codeableconcept import (
            AutoMapperElasticSearchCodeableConcept as CodeableConceptSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.episodeofcare_diagnosis import (
            AutoMapperElasticSearchEpisodeOfCare_Diagnosis as EpisodeOfCare_DiagnosisSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "statusHistory",
                    ArrayType(
                        EpisodeOfCare_StatusHistorySchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "diagnosis",
                    ArrayType(
                        EpisodeOfCare_DiagnosisSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
