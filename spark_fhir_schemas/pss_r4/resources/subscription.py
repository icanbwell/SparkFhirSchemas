...
class AutoMapperElasticSearchSubscription(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.subscription_channel import (
            AutoMapperElasticSearchSubscription_Channel as Subscription_ChannelSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "channel",
                    Subscription_ChannelSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
