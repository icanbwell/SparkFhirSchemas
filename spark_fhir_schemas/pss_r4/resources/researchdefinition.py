...
class AutoMapperElasticSearchResearchDefinition(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        url: An absolute URI that is used to identify this research definition when it is
        ...
        identifier: A formal identifier that is used to identify this research definition when it
        ...
        name: A natural language name identifying the research definition. This name should
        ...
        subtitle: An explanatory or alternate title for the ResearchDefinition giving additional
            information about its content.

        status: The status of this research definition. Enables tracking the life-cycle of the
            content.
        ...
        jurisdiction: A legal or geographic region in which the research definition is intended to
            be used.
        ...
        copyright: A copyright statement relating to the research definition and/or its contents.
        ...
        effectivePeriod: The period during which the research definition content was or is planned to
            be in active use.
        ...
        exposure: A reference to a ResearchElementDefinition resource that defines the exposure
            for the research.
        ...
        outcome: A reference to a ResearchElementDefinition resomece that defines the outcome
            for the research.
        ...
        my_nesting_list: List[str] = nesting_list + ["ResearchDefinition"]
        schema = StructType(
            [
