...
class AutoMapperElasticSearchGroup(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        managingEntity: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.group_characteristic import (
            AutoMapperElasticSearchGroup_Characteristic as Group_CharacteristicSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.group_member import (
            AutoMapperElasticSearchGroup_Member as Group_MemberSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "characteristic",
                    ArrayType(
                        Group_CharacteristicSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
