...
class AutoMapperElasticSearchImagingStudy(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        numberOfSeries: Optional[Any] = None,
        numberOfInstances: Optional[Any] = None,
        procedureReference: Optional[Any] = None,
        procedureCode: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.imagingstudy_series import (
            AutoMapperElasticSearchImagingStudy_Series as ImagingStudy_SeriesSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "series",
                    ArrayType(
                        ImagingStudy_SeriesSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
