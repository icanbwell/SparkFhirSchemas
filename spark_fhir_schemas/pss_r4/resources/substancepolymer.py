...
class AutoMapperElasticSearchSubstancePolymer(AutoMapperDataTypeComplexBase):
    """
    Todo.
    """
    ...
    def __init__(
        ...
        copolymerConnectivity: Optional[Any] = None,
        modification: Optional[Any] = None,
        monomerSet: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.substancepolymer_monomerset import (
            AutoMapperElasticSearchSubstancePolymer_MonomerSet as SubstancePolymer_MonomerSetSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.substancepolymer_repeat import (
            AutoMapperElasticSearchSubstancePolymer_Repeat as SubstancePolymer_RepeatSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("SubstancePolymer") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["SubstancePolymer"]
        schema = StructType(
            [
                ...
                StructField(
                    "monomerSet",
                    ArrayType(
                        SubstancePolymer_MonomerSetSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "repeat",
                    ArrayType(
                        SubstancePolymer_RepeatSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
