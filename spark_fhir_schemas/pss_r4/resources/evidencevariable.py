...
class AutoMapperElasticSearchEvidenceVariable(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        identifier: A formal identifier that is used to identify this evidence variable when it is
            represented in other formats, or referenced in a specification, model, design
            or an instance.

        version: The identifier that is used to identify this version of the evidence variable
        ...
        name: A natural language name identifying the evidence variable. This name should be
        ...
        subtitle: An explanatory or alternate title for the EvidenceVariable giving additional
            information about its content.

        status: The status of this evidence variable. Enables tracking the life-cycle of the
            content.

        date: The date  (and optionally time) when the evidence variable was published. The
        ...
        from spark_fhir_schemas.pss_r4.complex_types.evidencevariable_characteristic import (
            AutoMapperElasticSearchEvidenceVariable_Characteristic as EvidenceVariable_CharacteristicSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("EvidenceVariable") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["EvidenceVariable"]
        schema = StructType(
            [
                ...
                StructField(
                    "characteristic",
                    ArrayType(
                        EvidenceVariable_CharacteristicSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
