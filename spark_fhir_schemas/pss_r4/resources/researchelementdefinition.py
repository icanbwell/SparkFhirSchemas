...
class AutoMapperElasticSearchResearchElementDefinition(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        variableType: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.researchelementdefinition_characteristic import (
            AutoMapperElasticSearchResearchElementDefinition_Characteristic as ResearchElementDefinition_CharacteristicSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("ResearchElementDefinition") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["ResearchElementDefinition"]
        schema = StructType(
            [
                ...
                StructField(
                    "characteristic",
                    ArrayType(
                        ResearchElementDefinition_CharacteristicSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
