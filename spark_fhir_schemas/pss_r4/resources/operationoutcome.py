...
class AutoMapperElasticSearchOperationOutcome(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.operationoutcome_issue import (
            AutoMapperElasticSearchOperationOutcome_Issue as OperationOutcome_IssueSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "issue",
                    ArrayType(
                        OperationOutcome_IssueSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
