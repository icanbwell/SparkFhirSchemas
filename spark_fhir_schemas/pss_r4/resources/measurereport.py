...
class AutoMapperElasticSearchMeasureReport(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        evaluatedResource: Optional[Any] = None,
    ) -> None:
        super().__init__(
    ...
    def schema(
        ...
        type: The type of measure report. This may be an individual report, which provides
        ...
        improvementNotation: Whether improvement in the measure is noted by an increase or decrease in the
            measure score.
        ...
        from spark_fhir_schemas.pss_r4.complex_types.measurereport_group import (
            AutoMapperElasticSearchMeasureReport_Group as MeasureReport_GroupSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "group",
                    ArrayType(
                        MeasureReport_GroupSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
