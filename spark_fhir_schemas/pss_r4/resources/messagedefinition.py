...
class AutoMapperElasticSearchMessageDefinition(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        responseRequired: Optional[Any] = None,
        allowedResponse: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.messagedefinition_focus import (
            AutoMapperElasticSearchMessageDefinition_Focus as MessageDefinition_FocusSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.messagedefinition_allowedresponse import (
            AutoMapperElasticSearchMessageDefinition_AllowedResponse as MessageDefinition_AllowedResponseSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "focus",
                    ArrayType(
                        MessageDefinition_FocusSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "allowedResponse",
                    ArrayType(
                        MessageDefinition_AllowedResponseSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
