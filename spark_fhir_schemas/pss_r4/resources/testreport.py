...
class AutoMapperElasticSearchTestReport(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.testreport_participant import (
            AutoMapperElasticSearchTestReport_Participant as TestReport_ParticipantSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.testreport_setup import (
            AutoMapperElasticSearchTestReport_Setup as TestReport_SetupSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.testreport_test import (
            AutoMapperElasticSearchTestReport_Test as TestReport_TestSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.testreport_teardown import (
            AutoMapperElasticSearchTestReport_Teardown as TestReport_TeardownSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "participant",
                    ArrayType(
                        TestReport_ParticipantSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "teardown",
                    TestReport_TeardownSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
