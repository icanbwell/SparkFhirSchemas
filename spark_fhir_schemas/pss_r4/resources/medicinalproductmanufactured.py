...
class AutoMapperElasticSearchMedicinalProductManufactured(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        manufacturedDoseForm: Optional[Any] = None,
        ...
        otherCharacteristics: Optional[Any] = None,
    ) -> None:
        super().__init__(
    ...
    def schema(
        ...
        manufacturer: Manufacturer of the item (Note that this should be named "manufacturer" but it
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductManufactured")
            >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["MedicinalProductManufactured"]
        schema = StructType(
            [
