...
class AutoMapperElasticSearchMedicinalProductAuthorization(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        statusDate: Optional[Any] = None,
        restoreDate: Optional[Any] = None,
        validityPeriod: Optional[Any] = None,
        dataExclusivityPeriod: Optional[Any] = None,
        dateOfFirstAuthorization: Optional[Any] = None,
        internationalBirthDate: Optional[Any] = None,
        legalBasis: Optional[Any] = None,
        jurisdictionalAuthorization: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.medicinalproductauthorization_jurisdictionalauthorization import (
            AutoMapperElasticSearchMedicinalProductAuthorization_JurisdictionalAuthorization as MedicinalProductAuthorization_JurisdictionalAuthorizationSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.medicinalproductauthorization_procedure import (
            AutoMapperElasticSearchMedicinalProductAuthorization_Procedure as MedicinalProductAuthorization_ProcedureSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    ArrayType(
                        MedicinalProductAuthorization_JurisdictionalAuthorizationSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "procedure",
                    MedicinalProductAuthorization_ProcedureSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
