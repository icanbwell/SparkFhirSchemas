...
class AutoMapperElasticSearchLibrary(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        subjectCodeableConcept: A code or group definition that describes the intended subject of the contents
            of the library.

        subjectReference: A code or group definition that describes the intended subject of the contents
            of the library.
        ...
        purpose: Explanation of why this library is needed and why it has been designed as it
            has.
