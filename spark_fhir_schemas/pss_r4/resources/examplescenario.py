...
class AutoMapperElasticSearchExampleScenario(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.examplescenario_actor import (
            AutoMapperElasticSearchExampleScenario_Actor as ExampleScenario_ActorSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.examplescenario_instance import (
            AutoMapperElasticSearchExampleScenario_Instance as ExampleScenario_InstanceSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "actor",
                    ArrayType(
                        ExampleScenario_ActorSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "instance",
                    ArrayType(
                        ExampleScenario_InstanceSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
