...
class AutoMapperElasticSearchSubstance(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.substance_instance import (
            AutoMapperElasticSearchSubstance_Instance as Substance_InstanceSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.substance_ingredient import (
            AutoMapperElasticSearchSubstance_Ingredient as Substance_IngredientSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "instance",
                    ArrayType(
                        Substance_InstanceSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "ingredient",
                    ArrayType(
                        Substance_IngredientSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
