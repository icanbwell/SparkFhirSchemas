...
class AutoMapperElasticSearchOrganization(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.organization_contact import (
            AutoMapperElasticSearchOrganization_Contact as Organization_ContactSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "contact",
                    ArrayType(
                        Organization_ContactSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
