...
class AutoMapperElasticSearchSpecimen(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        accessionIdentifier: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.specimen_collection import (
            AutoMapperElasticSearchSpecimen_Collection as Specimen_CollectionSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.specimen_processing import (
            AutoMapperElasticSearchSpecimen_Processing as Specimen_ProcessingSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.specimen_container import (
            AutoMapperElasticSearchSpecimen_Container as Specimen_ContainerSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "collection",
                    Specimen_CollectionSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "processing",
                    ArrayType(
                        Specimen_ProcessingSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "container",
                    ArrayType(
                        Specimen_ContainerSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
