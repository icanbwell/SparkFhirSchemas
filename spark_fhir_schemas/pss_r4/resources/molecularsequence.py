...
class AutoMapperElasticSearchMolecularSequence(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.molecularsequence_referenceseq import (
            AutoMapperElasticSearchMolecularSequence_ReferenceSeq as MolecularSequence_ReferenceSeqSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.molecularsequence_variant import (
            AutoMapperElasticSearchMolecularSequence_Variant as MolecularSequence_VariantSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.molecularsequence_quality import (
            AutoMapperElasticSearchMolecularSequence_Quality as MolecularSequence_QualitySchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.molecularsequence_repository import (
            AutoMapperElasticSearchMolecularSequence_Repository as MolecularSequence_RepositorySchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.molecularsequence_structurevariant import (
            AutoMapperElasticSearchMolecularSequence_StructureVariant as MolecularSequence_StructureVariantSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "referenceSeq",
                    MolecularSequence_ReferenceSeqSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "variant",
                    ArrayType(
                        MolecularSequence_VariantSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "quality",
                    ArrayType(
                        MolecularSequence_QualitySchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "repository",
                    ArrayType(
                        MolecularSequence_RepositorySchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "structureVariant",
                    ArrayType(
                        MolecularSequence_StructureVariantSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
