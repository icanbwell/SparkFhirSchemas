...
class AutoMapperElasticSearchSpecimenDefinition(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        typeCollected: Optional[Any] = None,
        patientPreparation: Optional[Any] = None,
        timeAspect: Optional[Any] = None,
        collection: Optional[Any] = None,
        typeTested: Optional[Any] = None,
    ) -> None:
        super().__init__(
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.specimendefinition_typetested import (
            AutoMapperElasticSearchSpecimenDefinition_TypeTested as SpecimenDefinition_TypeTestedSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("SpecimenDefinition") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["SpecimenDefinition"]
        schema = StructType(
            [
                ...
                StructField(
                    "typeTested",
                    ArrayType(
                        SpecimenDefinition_TypeTestedSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
