...
class AutoMapperElasticSearchMedicinalProductInteraction(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        interactant: Optional[Any] = None,
        type_: Optional[Any] = None,
        effect: Optional[Any] = None,
        incidence: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.medicinalproductinteraction_interactant import (
            AutoMapperElasticSearchMedicinalProductInteraction_Interactant as MedicinalProductInteraction_InteractantSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "interactant",
                    ArrayType(
                        MedicinalProductInteraction_InteractantSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
