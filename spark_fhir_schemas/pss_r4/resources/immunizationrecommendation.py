...
class AutoMapperElasticSearchImmunizationRecommendation(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.immunizationrecommendation_recommendation import (
            AutoMapperElasticSearchImmunizationRecommendation_Recommendation as ImmunizationRecommendation_RecommendationSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "recommendation",
                    ArrayType(
                        ImmunizationRecommendation_RecommendationSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
