...
class AutoMapperElasticSearchRelatedPerson(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.relatedperson_communication import (
            AutoMapperElasticSearchRelatedPerson_Communication as RelatedPerson_CommunicationSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "communication",
                    ArrayType(
                        RelatedPerson_CommunicationSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
