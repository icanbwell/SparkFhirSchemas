...
class AutoMapperElasticSearchPerson(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.person_link import (
            AutoMapperElasticSearchPerson_Link as Person_LinkSchema,
        )
