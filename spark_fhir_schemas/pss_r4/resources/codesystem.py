...
class AutoMapperElasticSearchCodeSystem(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        caseSensitive: Optional[Any] = None,
        valueSet: Optional[Any] = None,
        hierarchyMeaning: Optional[Any] = None,
        compositional: Optional[Any] = None,
        versionNeeded: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.codesystem_filter import (
            AutoMapperElasticSearchCodeSystem_Filter as CodeSystem_FilterSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.codesystem_property import (
            AutoMapperElasticSearchCodeSystem_Property as CodeSystem_PropertySchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.codesystem_concept import (
            AutoMapperElasticSearchCodeSystem_Concept as CodeSystem_ConceptSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "filter",
                    ArrayType(
                        CodeSystem_FilterSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "property",
                    ArrayType(
                        CodeSystem_PropertySchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
