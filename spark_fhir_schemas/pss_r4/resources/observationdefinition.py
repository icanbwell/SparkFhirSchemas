...
class AutoMapperElasticSearchObservationDefinition(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        permittedDataType: Optional[Any] = None,
        multipleResultsAllowed: Optional[Any] = None,
        method: Optional[Any] = None,
        preferredReportName: Optional[Any] = None,
        quantitativeDetails: Optional[Any] = None,
        qualifiedInterval: Optional[Any] = None,
        validCodedValueSet: Optional[Any] = None,
        normalCodedValueSet: Optional[Any] = None,
        abnormalCodedValueSet: Optional[Any] = None,
        criticalCodedValueSet: Optional[Any] = None,
    ) -> None:
        super().__init__(
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.observationdefinition_quantitativedetails import (
            AutoMapperElasticSearchObservationDefinition_QuantitativeDetails as ObservationDefinition_QuantitativeDetailsSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.observationdefinition_qualifiedinterval import (
            AutoMapperElasticSearchObservationDefinition_QualifiedInterval as ObservationDefinition_QualifiedIntervalSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "quantitativeDetails",
                    ObservationDefinition_QuantitativeDetailsSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "qualifiedInterval",
                    ArrayType(
                        ObservationDefinition_QualifiedIntervalSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
