...
class AutoMapperElasticSearchMedicinalProductUndesirableEffect(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        symptomConditionEffect: Optional[Any] = None,
        classification: Optional[Any] = None,
        frequencyOfOccurrence: Optional[Any] = None,
    ...
    def schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductUndesirableEffect")
            >= max_recursion_limit
