...
class AutoMapperElasticSearchPractitionerRole(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        healthcareService: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.practitionerrole_availabletime import (
            AutoMapperElasticSearchPractitionerRole_AvailableTime as PractitionerRole_AvailableTimeSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.practitionerrole_notavailable import (
            AutoMapperElasticSearchPractitionerRole_NotAvailable as PractitionerRole_NotAvailableSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "availableTime",
                    ArrayType(
                        PractitionerRole_AvailableTimeSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "notAvailable",
                    ArrayType(
                        PractitionerRole_NotAvailableSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
