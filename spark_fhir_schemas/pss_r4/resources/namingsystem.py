...
class AutoMapperElasticSearchNamingSystem(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.namingsystem_uniqueid import (
            AutoMapperElasticSearchNamingSystem_UniqueId as NamingSystem_UniqueIdSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "uniqueId",
                    ArrayType(
                        NamingSystem_UniqueIdSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
