...
class AutoMapperElasticSearchSupplyDelivery(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        suppliedItem: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.supplydelivery_supplieditem import (
            AutoMapperElasticSearchSupplyDelivery_SuppliedItem as SupplyDelivery_SuppliedItemSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "suppliedItem",
                    SupplyDelivery_SuppliedItemSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
