...
class AutoMapperElasticSearchSupplyRequest(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        deliverFrom: Optional[Any] = None,
        deliverTo: Optional[Any] = None,
    ) -> None:
        super().__init__(
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.supplyrequest_parameter import (
            AutoMapperElasticSearchSupplyRequest_Parameter as SupplyRequest_ParameterSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "parameter",
                    ArrayType(
                        SupplyRequest_ParameterSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
