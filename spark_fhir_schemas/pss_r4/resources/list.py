...
class AutoMapperElasticSearchList(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.list_entry import (
            AutoMapperElasticSearchList_Entry as List_EntrySchema,
        )
