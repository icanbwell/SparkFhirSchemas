...
class AutoMapperElasticSearchExplanationOfBenefit_Detail(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.explanationofbenefit_subdetail import (
            AutoMapperElasticSearchExplanationOfBenefit_SubDetail as ExplanationOfBenefit_SubDetailSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "subDetail",
                    ArrayType(
                        ExplanationOfBenefit_SubDetailSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
