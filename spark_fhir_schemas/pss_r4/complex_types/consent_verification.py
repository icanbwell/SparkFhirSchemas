...
class AutoMapperElasticSearchConsent_Verification(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        verifiedWith: Optional[Any] = None,
        verificationDate: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
    ...
    def schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Consent_Verification") >= max_recursion_limit
