...
class AutoMapperElasticSearchTiming(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.timing_repeat import (
            AutoMapperElasticSearchTiming_Repeat as Timing_RepeatSchema,
        )
