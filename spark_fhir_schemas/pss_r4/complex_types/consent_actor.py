...
class AutoMapperElasticSearchConsent_Actor(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        reference: The resource that identifies the actor. To identify actors by type, use group
