...
class AutoMapperElasticSearchSubstanceSourceMaterial_Hybrid(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        maternalOrganismId: Optional[Any] = None,
        maternalOrganismName: Optional[Any] = None,
        paternalOrganismId: Optional[Any] = None,
        paternalOrganismName: Optional[Any] = None,
        hybridType: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
