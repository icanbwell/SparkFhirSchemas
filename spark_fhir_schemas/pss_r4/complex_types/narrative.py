...
class AutoMapperElasticSearchNarrative(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.simple_types.xhtml import (
            AutoMapperElasticSearchxhtml as xhtmlSchema,
        )
