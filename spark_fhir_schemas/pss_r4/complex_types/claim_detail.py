...
class AutoMapperElasticSearchClaim_Detail(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.claim_subdetail import (
            AutoMapperElasticSearchClaim_SubDetail as Claim_SubDetailSchema,
        )
