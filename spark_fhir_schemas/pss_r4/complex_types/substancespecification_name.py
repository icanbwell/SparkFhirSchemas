...
class AutoMapperElasticSearchSubstanceSpecification_Name(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.substancespecification_official import (
            AutoMapperElasticSearchSubstanceSpecification_Official as SubstanceSpecification_OfficialSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "synonym",
                    ArrayType(
                        SubstanceSpecification_NameSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "official",
                    ArrayType(
                        SubstanceSpecification_OfficialSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
