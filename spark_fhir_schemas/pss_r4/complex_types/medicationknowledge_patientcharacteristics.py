...
class AutoMapperElasticSearchMedicationKnowledge_PatientCharacteristics(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        characteristicCodeableConcept: Optional[Any] = None,
        characteristicQuantity: Optional[Any] = None,
    ...
    def schema(
        ...
        characteristicCodeableConcept: Specific characteristic that is relevant to the administration guideline (e.g.
            height, weight, gender).

        characteristicQuantity: Specific characteristic that is relevant to the administration guideline (e.g.
            height, weight, gender).
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicationKnowledge_PatientCharacteristics")
            >= max_recursion_limit
