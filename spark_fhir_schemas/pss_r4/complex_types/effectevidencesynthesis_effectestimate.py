...
class AutoMapperElasticSearchEffectEvidenceSynthesis_EffectEstimate(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        variantState: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.effectevidencesynthesis_precisionestimate import (
            AutoMapperElasticSearchEffectEvidenceSynthesis_PrecisionEstimate as EffectEvidenceSynthesis_PrecisionEstimateSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("EffectEvidenceSynthesis_EffectEstimate")
            >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "precisionEstimate",
                    ArrayType(
                        EffectEvidenceSynthesis_PrecisionEstimateSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
