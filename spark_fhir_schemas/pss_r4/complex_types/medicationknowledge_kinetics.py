...
class AutoMapperElasticSearchMedicationKnowledge_Kinetics(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        areaUnderCurve: Optional[Any] = None,
        lethalDose50: Optional[Any] = None,
        halfLifePeriod: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
