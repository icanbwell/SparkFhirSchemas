...
class AutoMapperElasticSearchMedicinalProductIngredient_Substance(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.medicinalproductingredient_strength import (
            AutoMapperElasticSearchMedicinalProductIngredient_Strength as MedicinalProductIngredient_StrengthSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "strength",
                    ArrayType(
                        MedicinalProductIngredient_StrengthSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
