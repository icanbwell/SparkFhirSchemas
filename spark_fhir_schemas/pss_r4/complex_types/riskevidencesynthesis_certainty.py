...
class AutoMapperElasticSearchRiskEvidenceSynthesis_Certainty(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.riskevidencesynthesis_certaintysubcomponent import (
            AutoMapperElasticSearchRiskEvidenceSynthesis_CertaintySubcomponent as RiskEvidenceSynthesis_CertaintySubcomponentSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    ArrayType(
                        RiskEvidenceSynthesis_CertaintySubcomponentSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
