...
class AutoMapperElasticSearchVerificationResult_PrimarySource(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        validationStatus: Optional[Any] = None,
        validationDate: Optional[Any] = None,
        canPushUpdates: Optional[Any] = None,
        pushTypeAvailable: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
