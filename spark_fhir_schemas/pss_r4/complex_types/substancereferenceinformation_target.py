...
class AutoMapperElasticSearchSubstanceReferenceInformation_Target(
    AutoMapperDataTypeComplexBase
):
    """
    Todo.
    ...
    def __init__(
        ...
        organismType: Optional[Any] = None,
    ...
    def schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubstanceReferenceInformation_Target")
            >= max_recursion_limit
