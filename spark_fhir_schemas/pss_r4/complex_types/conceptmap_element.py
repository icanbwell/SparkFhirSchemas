...
class AutoMapperElasticSearchConceptMap_Element(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.conceptmap_target import (
            AutoMapperElasticSearchConceptMap_Target as ConceptMap_TargetSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "target",
                    ArrayType(
                        ConceptMap_TargetSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
