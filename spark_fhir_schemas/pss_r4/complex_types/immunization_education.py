...
class AutoMapperElasticSearchImmunization_Education(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        presentationDate: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
    ...
    def schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Immunization_Education") >= max_recursion_limit
