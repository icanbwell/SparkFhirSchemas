...
class AutoMapperElasticSearchMeasure_Stratifier(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.measure_component import (
            AutoMapperElasticSearchMeasure_Component as Measure_ComponentSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "component",
                    ArrayType(
                        Measure_ComponentSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
