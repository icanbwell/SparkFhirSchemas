...
class AutoMapperElasticSearchInsurancePlan_Plan(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        generalCost: Optional[Any] = None,
        specificCost: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.insuranceplan_generalcost import (
            AutoMapperElasticSearchInsurancePlan_GeneralCost as InsurancePlan_GeneralCostSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.insuranceplan_specificcost import (
            AutoMapperElasticSearchInsurancePlan_SpecificCost as InsurancePlan_SpecificCostSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "generalCost",
                    ArrayType(
                        InsurancePlan_GeneralCostSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "specificCost",
                    ArrayType(
                        InsurancePlan_SpecificCostSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
