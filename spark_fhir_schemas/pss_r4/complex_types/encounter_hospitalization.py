...
class AutoMapperElasticSearchEncounter_Hospitalization(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        preAdmissionIdentifier: Optional[Any] = None,
        origin: Optional[Any] = None,
        admitSource: Optional[Any] = None,
        reAdmission: Optional[Any] = None,
        dietPreference: Optional[Any] = None,
        specialCourtesy: Optional[Any] = None,
        specialArrangement: Optional[Any] = None,
        destination: Optional[Any] = None,
        dischargeDisposition: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
