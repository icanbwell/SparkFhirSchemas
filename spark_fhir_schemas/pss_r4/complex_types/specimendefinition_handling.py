...
class AutoMapperElasticSearchSpecimenDefinition_Handling(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        temperatureQualifier: Optional[Any] = None,
        temperatureRange: Optional[Any] = None,
        maxDuration: Optional[Any] = None,
