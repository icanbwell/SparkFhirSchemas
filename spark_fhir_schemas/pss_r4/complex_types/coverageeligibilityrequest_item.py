...
class AutoMapperElasticSearchCoverageEligibilityRequest_Item(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        supportingInfoSequence: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.coverageeligibilityrequest_diagnosis import (
            AutoMapperElasticSearchCoverageEligibilityRequest_Diagnosis as CoverageEligibilityRequest_DiagnosisSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "diagnosis",
                    ArrayType(
                        CoverageEligibilityRequest_DiagnosisSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
