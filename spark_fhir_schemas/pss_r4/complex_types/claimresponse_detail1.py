...
class AutoMapperElasticSearchClaimResponse_Detail1(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.claimresponse_subdetail1 import (
            AutoMapperElasticSearchClaimResponse_SubDetail1 as ClaimResponse_SubDetail1Schema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("ClaimResponse_Detail1") >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "subDetail",
                    ArrayType(
                        ClaimResponse_SubDetail1Schema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
