...
class AutoMapperElasticSearchExampleScenario_Instance(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        containedInstance: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.examplescenario_version import (
            AutoMapperElasticSearchExampleScenario_Version as ExampleScenario_VersionSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "version",
                    ArrayType(
                        ExampleScenario_VersionSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
