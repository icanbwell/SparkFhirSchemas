...
class AutoMapperElasticSearchObservationDefinition_QuantitativeDetails(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        customaryUnit: Optional[Any] = None,
        unit: Optional[Any] = None,
        conversionFactor: Optional[Any] = None,
        decimalPrecision: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
    ...
    def schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("ObservationDefinition_QuantitativeDetails")
            >= max_recursion_limit
