...
class AutoMapperElasticSearchMedicationDispense_Substitution(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        wasSubstituted: Optional[Any] = None,
        type_: Optional[Any] = None,
        reason: Optional[Any] = None,
        responsibleParty: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
    ...
    def schema(
        ...
        my_nesting_list: List[str] = nesting_list + ["MedicationDispense_Substitution"]
        schema = StructType(
            [
