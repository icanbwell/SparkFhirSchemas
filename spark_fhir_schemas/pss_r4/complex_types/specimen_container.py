...
class AutoMapperElasticSearchSpecimen_Container(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        specimenQuantity: Optional[Any] = None,
        additiveCodeableConcept: Optional[Any] = None,
        additiveReference: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
