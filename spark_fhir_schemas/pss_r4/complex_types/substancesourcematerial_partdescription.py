...
class AutoMapperElasticSearchSubstanceSourceMaterial_PartDescription(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        partLocation: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
    ...
    def schema(
        ...
        partLocation: The detailed anatomic location when the part can be extracted from different
