...
class AutoMapperElasticSearchMedicinalProductAuthorization_Procedure(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        datePeriod: Optional[Any] = None,
        dateDateTime: Optional[Any] = None,
    ...
    def schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductAuthorization_Procedure")
            >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                # Date of procedure.
                StructField("dateDateTime", TimestampType(), True),
