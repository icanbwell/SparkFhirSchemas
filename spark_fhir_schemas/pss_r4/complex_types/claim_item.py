...
class AutoMapperElasticSearchClaim_Item(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        careTeamSequence: Optional[Any] = None,
        diagnosisSequence: Optional[Any] = None,
        procedureSequence: Optional[Any] = None,
        informationSequence: Optional[Any] = None,
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.claim_detail import (
            AutoMapperElasticSearchClaim_Detail as Claim_DetailSchema,
        )
