...
class AutoMapperElasticSearchAdverseEvent_SuspectEntity(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.adverseevent_causality import (
            AutoMapperElasticSearchAdverseEvent_Causality as AdverseEvent_CausalitySchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "causality",
                    ArrayType(
                        AdverseEvent_CausalitySchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
