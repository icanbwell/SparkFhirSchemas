...
class AutoMapperElasticSearchGraphDefinition_Target(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.graphdefinition_compartment import (
            AutoMapperElasticSearchGraphDefinition_Compartment as GraphDefinition_CompartmentSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.graphdefinition_link import (
            AutoMapperElasticSearchGraphDefinition_Link as GraphDefinition_LinkSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "compartment",
                    ArrayType(
                        GraphDefinition_CompartmentSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "link",
                    ArrayType(
                        GraphDefinition_LinkSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
