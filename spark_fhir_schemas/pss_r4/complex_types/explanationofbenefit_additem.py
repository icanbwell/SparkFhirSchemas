...
class AutoMapperElasticSearchExplanationOfBenefit_AddItem(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.explanationofbenefit_detail1 import (
            AutoMapperElasticSearchExplanationOfBenefit_Detail1 as ExplanationOfBenefit_Detail1Schema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "detail",
                    ArrayType(
                        ExplanationOfBenefit_Detail1Schema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
