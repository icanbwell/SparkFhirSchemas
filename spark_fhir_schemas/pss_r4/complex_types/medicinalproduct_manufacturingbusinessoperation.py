...
class AutoMapperElasticSearchMedicinalProduct_ManufacturingBusinessOperation(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        authorisationReferenceNumber: Optional[Any] = None,
        effectiveDate: Optional[Any] = None,
        confidentialityIndicator: Optional[Any] = None,
    ...
    def schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProduct_ManufacturingBusinessOperation")
            >= max_recursion_limit
