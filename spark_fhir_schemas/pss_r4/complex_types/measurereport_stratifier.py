...
class AutoMapperElasticSearchMeasureReport_Stratifier(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.measurereport_stratum import (
            AutoMapperElasticSearchMeasureReport_Stratum as MeasureReport_StratumSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "stratum",
                    ArrayType(
                        MeasureReport_StratumSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
