...
class AutoMapperElasticSearchClinicalImpression_Finding(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        itemCodeableConcept: Specific text or code for finding or diagnosis, which may include ruled-out or
            resolved conditions.
