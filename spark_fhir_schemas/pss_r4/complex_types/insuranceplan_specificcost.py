...
class AutoMapperElasticSearchInsurancePlan_SpecificCost(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.insuranceplan_benefit1 import (
            AutoMapperElasticSearchInsurancePlan_Benefit1 as InsurancePlan_Benefit1Schema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "benefit",
                    ArrayType(
                        InsurancePlan_Benefit1Schema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
