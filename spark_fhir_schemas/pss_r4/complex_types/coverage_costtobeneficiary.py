...
class AutoMapperElasticSearchCoverage_CostToBeneficiary(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.coverage_exception import (
            AutoMapperElasticSearchCoverage_Exception as Coverage_ExceptionSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "exception",
                    ArrayType(
                        Coverage_ExceptionSchema.schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
