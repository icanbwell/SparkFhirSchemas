...
class AutoMapperElasticSearchPopulation(AutoMapperDataTypeComplexBase):
    """
    ...
    def __init__(
        ...
        ageCodeableConcept: Optional[Any] = None,
        gender: Optional[Any] = None,
        race: Optional[Any] = None,
        physiologicalCondition: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
    ...
    def schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Population") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Population"]
        schema = StructType(
            [
