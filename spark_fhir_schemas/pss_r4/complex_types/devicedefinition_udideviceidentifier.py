...
class AutoMapperElasticSearchDeviceDefinition_UdiDeviceIdentifier(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def schema(
        ...
        deviceIdentifier: The identifier that is to be associated with every Device that references this
        ...
        if (
            max_recursion_limit
            and nesting_list.count("DeviceDefinition_UdiDeviceIdentifier")
            >= max_recursion_limit
