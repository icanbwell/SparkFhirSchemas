...
class AutoMapperElasticSearchBiologicallyDerivedProduct_Manipulation(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def __init__(
        ...
        timeDateTime: Optional[Any] = None,
        timePeriod: Optional[Any] = None,
    ) -> None:
        super().__init__(
            id_=id_,
            extension=extension,
    ...
    def schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("BiologicallyDerivedProduct_Manipulation")
            >= max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField("timeDateTime", TimestampType(), True),
                # Time of manipulation.
                StructField(
                    "timePeriod",
                    PeriodSchema.schema(
