...
class AutoMapperElasticSearchMedicinalProduct_SpecialDesignation(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProduct_SpecialDesignation")
            >= max_recursion_limit
