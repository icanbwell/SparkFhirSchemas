...
class AutoMapperElasticSearchMolecularSequence_StructureVariant(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.molecularsequence_outer import (
            AutoMapperElasticSearchMolecularSequence_Outer as MolecularSequence_OuterSchema,
        )
        from spark_fhir_schemas.pss_r4.complex_types.molecularsequence_inner import (
            AutoMapperElasticSearchMolecularSequence_Inner as MolecularSequence_InnerSchema,
        )
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "outer",
                    MolecularSequence_OuterSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "inner",
                    MolecularSequence_InnerSchema.schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
