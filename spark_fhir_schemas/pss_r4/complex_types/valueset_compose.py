...
class AutoMapperElasticSearchValueSet_Compose(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        from spark_fhir_schemas.pss_r4.complex_types.valueset_include import (
            AutoMapperElasticSearchValueSet_Include as ValueSet_IncludeSchema,
        )
