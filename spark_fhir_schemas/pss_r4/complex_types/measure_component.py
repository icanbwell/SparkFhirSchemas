...
class AutoMapperElasticSearchMeasure_Component(AutoMapperDataTypeComplexBase):
    """
    ...
    def schema(
        ...
        code: Indicates a meaning for the stratifier component. This can be as simple as a
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Measure_Component") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Measure_Component"]
        schema = StructType(
            [
