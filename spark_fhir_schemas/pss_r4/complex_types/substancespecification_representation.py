...
class AutoMapperElasticSearchSubstanceSpecification_Representation(
    AutoMapperDataTypeComplexBase
):
    """
    ...
    def schema(
        ...
        representation: The structural representation as text string in a format e.g. InChI, SMILES,
            MOLFILE, CDX.
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubstanceSpecification_Representation")
            >= max_recursion_limit
