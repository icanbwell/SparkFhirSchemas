...
class ContractSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.contract_contentdefinition import (
            Contract_ContentDefinitionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.contract_term import (
            Contract_TermSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.contract_signer import (
            Contract_SignerSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.contract_friendly import (
            Contract_FriendlySchema,
        )
        from spark_fhir_schemas.r4b.complex_types.contract_legal import (
            Contract_LegalSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.contract_rule import (
            Contract_RuleSchema,
        )
        ...
        my_parent_path = parent_path + ".contract" if parent_path else "contract"
        schema = StructType(
            [
