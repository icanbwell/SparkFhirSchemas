...
class EvidenceReportSchema:
    ...
    def get_schema(
        ...
        type: Specifies the kind of report, such as grouping of classifiers, search results,
        ...
        from spark_fhir_schemas.r4b.complex_types.evidencereport_subject import (
            EvidenceReport_SubjectSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.contactdetail import (
            ContactDetailSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.evidencereport_relatesto import (
            EvidenceReport_RelatesToSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.evidencereport_section import (
            EvidenceReport_SectionSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("EvidenceReport") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["EvidenceReport"]
        my_parent_path = (
            parent_path + ".evidencereport" if parent_path else "evidencereport"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "subject",
                    EvidenceReport_SubjectSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "relatesTo",
                    ArrayType(
                        EvidenceReport_RelatesToSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "section",
                    ArrayType(
                        EvidenceReport_SectionSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
