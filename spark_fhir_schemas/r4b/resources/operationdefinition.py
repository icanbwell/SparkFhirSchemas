...
class OperationDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.operationdefinition_parameter import (
            OperationDefinition_ParameterSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.operationdefinition_overload import (
        ...
        my_parent_path = (
            parent_path + ".operationdefinition"
            if parent_path
            else "operationdefinition"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    canonicalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".base",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    canonicalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".inputprofile",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    canonicalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".outputprofile",
                    ),
                    True,
                ),
