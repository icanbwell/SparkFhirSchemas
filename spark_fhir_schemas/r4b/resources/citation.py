...
class CitationSchema:
    ...
    def get_schema(
        ...
        url: An absolute URI that is used to identify this citation when it is referenced
        ...
        version: The identifier that is used to identify this version of the citation when it
        ...
        name: A natural language name identifying the citation. This name should be usable
        ...
        date: The date  (and optionally time) when the citation was published. The date must
        ...
        purpose: Explanation of why this citation is needed and why it has been designed as it
            has.
        ...
        effectivePeriod: The period during which the citation content was or is planned to be in active
            use.
        ...
        from spark_fhir_schemas.r4b.complex_types.citation_summary import (
            Citation_SummarySchema,
        )
        from spark_fhir_schemas.r4b.complex_types.citation_classification import (
            Citation_ClassificationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.annotation import AnnotationSchema
        from spark_fhir_schemas.r4b.complex_types.citation_statusdate import (
            Citation_StatusDateSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.citation_relatesto import (
            Citation_RelatesToSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.citation_citedartifact import (
            Citation_CitedArtifactSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("Citation") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Citation"]
        my_parent_path = parent_path + ".citation" if parent_path else "citation"
        schema = StructType(
            [
                ...
                StructField(
                    "summary",
                    ArrayType(
                        Citation_SummarySchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "classification",
                    ArrayType(
                        Citation_ClassificationSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "statusDate",
                    ArrayType(
                        Citation_StatusDateSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "relatesTo",
                    ArrayType(
                        Citation_RelatesToSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "citedArtifact",
                    Citation_CitedArtifactSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
