...
class MeasureSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.measure_group import (
            Measure_GroupSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.measure_supplementaldata import (
        ...
        my_parent_path = parent_path + ".measure" if parent_path else "measure"
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    markdownSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".disclaimer",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    markdownSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".rationale",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    markdownSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".clinicalrecommendationstatement",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    markdownSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".guidance",
                    ),
                    True,
                ),
