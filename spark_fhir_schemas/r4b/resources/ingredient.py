...
class IngredientSchema:
    ...
    def get_schema(
        ...
        role: A classification of the ingredient identifying its purpose within the product,
            e.g. active, inactive.

        function: A classification of the ingredient identifying its precise purpose(s) in the
        ...
        manufacturer: The organization(s) that manufacture this ingredient. Can be used to indicate:
        ...
        from spark_fhir_schemas.r4b.complex_types.ingredient_manufacturer import (
            Ingredient_ManufacturerSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.ingredient_substance import (
            Ingredient_SubstanceSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("Ingredient") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Ingredient"]
        my_parent_path = parent_path + ".ingredient" if parent_path else "ingredient"
        schema = StructType(
            [
                ...
                StructField(
                    "manufacturer",
                    ArrayType(
                        Ingredient_ManufacturerSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "substance",
                    Ingredient_SubstanceSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
