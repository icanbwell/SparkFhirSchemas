...
class MedicationDispenseSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.medicationdispense_performer import (
        ...
        from spark_fhir_schemas.r4b.complex_types.medicationdispense_substitution import (
        ...
        my_parent_path = (
            parent_path + ".medicationdispense" if parent_path else "medicationdispense"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".whenprepared",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".whenhandedover",
                    ),
                    True,
                ),
