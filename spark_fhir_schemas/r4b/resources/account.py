...
class AccountSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.account_coverage import (
            Account_CoverageSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.account_guarantor import (
        ...
        my_parent_path = parent_path + ".account" if parent_path else "account"
        schema = StructType(
            [
