...
class AllergyIntoleranceSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.allergyintolerance_reaction import (
        ...
        my_parent_path = (
            parent_path + ".allergyintolerance" if parent_path else "allergyintolerance"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    codeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".criticality",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".lastoccurrence",
                    ),
                    True,
                ),
