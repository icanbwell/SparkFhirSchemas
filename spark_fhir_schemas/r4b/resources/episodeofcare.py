...
class EpisodeOfCareSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.episodeofcare_statushistory import (
            EpisodeOfCare_StatusHistorySchema,
        )
        from spark_fhir_schemas.r4b.complex_types.codeableconcept import (
            CodeableConceptSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.episodeofcare_diagnosis import (
        ...
        my_parent_path = (
            parent_path + ".episodeofcare" if parent_path else "episodeofcare"
        )
        schema = StructType(
            [
