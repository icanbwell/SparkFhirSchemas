...
class LocationSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.location_position import (
            Location_PositionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.reference import ReferenceSchema
        from spark_fhir_schemas.r4b.complex_types.location_hoursofoperation import (
        ...
        my_parent_path = parent_path + ".location" if parent_path else "location"
        schema = StructType(
            [
