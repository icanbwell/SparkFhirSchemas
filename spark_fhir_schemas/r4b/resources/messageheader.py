...
class MessageHeaderSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.messageheader_destination import (
            MessageHeader_DestinationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.reference import ReferenceSchema
        from spark_fhir_schemas.r4b.complex_types.messageheader_source import (
            MessageHeader_SourceSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.codeableconcept import (
            CodeableConceptSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.messageheader_response import (
        ...
        my_parent_path = (
            parent_path + ".messageheader" if parent_path else "messageheader"
        )
        schema = StructType(
            [
