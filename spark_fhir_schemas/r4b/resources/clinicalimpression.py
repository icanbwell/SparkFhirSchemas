...
class ClinicalImpressionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.clinicalimpression_investigation import (
            ClinicalImpression_InvestigationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.clinicalimpression_finding import (
        ...
        my_parent_path = (
            parent_path + ".clinicalimpression" if parent_path else "clinicalimpression"
        )
        schema = StructType(
            [
