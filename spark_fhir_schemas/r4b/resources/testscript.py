...
class TestScriptSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.testscript_origin import (
            TestScript_OriginSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.testscript_destination import (
            TestScript_DestinationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.testscript_metadata import (
            TestScript_MetadataSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.testscript_fixture import (
            TestScript_FixtureSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.reference import ReferenceSchema
        from spark_fhir_schemas.r4b.complex_types.testscript_variable import (
            TestScript_VariableSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.testscript_setup import (
            TestScript_SetupSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.testscript_test import (
            TestScript_TestSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.testscript_teardown import (
        ...
        my_parent_path = parent_path + ".testscript" if parent_path else "testscript"
        schema = StructType(
            [
