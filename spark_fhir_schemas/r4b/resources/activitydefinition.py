...
class ActivityDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.activitydefinition_participant import (
        ...
        from spark_fhir_schemas.r4b.complex_types.activitydefinition_dynamicvalue import (
        ...
        my_parent_path = (
            parent_path + ".activitydefinition" if parent_path else "activitydefinition"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    canonicalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".profile",
                    ),
                    True,
                ),
