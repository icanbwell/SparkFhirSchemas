...
class ValueSetSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.valueset_compose import (
            ValueSet_ComposeSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.valueset_expansion import (
        ...
        my_parent_path = parent_path + ".valueset" if parent_path else "valueset"
        schema = StructType(
            [
