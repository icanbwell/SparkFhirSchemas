...
class StructureMapSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.structuremap_structure import (
            StructureMap_StructureSchema,
        )
        from spark_fhir_schemas.r4b.simple_types.canonical import canonicalSchema
        from spark_fhir_schemas.r4b.complex_types.structuremap_group import (
        ...
        my_parent_path = (
            parent_path + ".structuremap" if parent_path else "structuremap"
        )
        schema = StructType(
            [
