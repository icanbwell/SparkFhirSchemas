...
class SubscriptionStatusSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.subscriptionstatus_notificationevent import (
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubscriptionStatus") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["SubscriptionStatus"]
        my_parent_path = (
            parent_path + ".subscriptionstatus" if parent_path else "subscriptionstatus"
        )
        schema = StructType(
            [
                ...
                # many have been successfully communicated.  This number is NOT incremented for
                # handshake and heartbeat notifications.
                StructField("eventsSinceSubscriptionStart", StringType(), True),
                # Detailed information about events relevant to this subscription notification.
                StructField(
                    "notificationEvent",
                    ArrayType(
                        SubscriptionStatus_NotificationEventSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    ...
                    canonicalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".topic",
                    ),
                    True,
                ),
