...
class PlanDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.plandefinition_goal import (
            PlanDefinition_GoalSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.plandefinition_action import (
        ...
        my_parent_path = (
            parent_path + ".plandefinition" if parent_path else "plandefinition"
        )
        schema = StructType(
            [
