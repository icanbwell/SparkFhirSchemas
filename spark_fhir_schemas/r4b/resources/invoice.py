...
class InvoiceSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.invoice_participant import (
            Invoice_ParticipantSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.invoice_lineitem import (
            Invoice_LineItemSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.invoice_pricecomponent import (
        ...
        my_parent_path = parent_path + ".invoice" if parent_path else "invoice"
        schema = StructType(
            [
                ...
                StructField(
                    "participant",
                    ArrayType(
                        Invoice_ParticipantSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "lineItem",
                    ArrayType(
                        Invoice_LineItemSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    ...
                    markdownSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".paymentterms",
                    ),
                    True,
                ),
