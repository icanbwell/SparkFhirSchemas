...
class MedicationKnowledgeSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_relatedmedicationknowledge import (
            MedicationKnowledge_RelatedMedicationKnowledgeSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_monograph import (
            MedicationKnowledge_MonographSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_ingredient import (
            MedicationKnowledge_IngredientSchema,
        )
        from spark_fhir_schemas.r4b.simple_types.markdown import markdownSchema
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_cost import (
            MedicationKnowledge_CostSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_monitoringprogram import (
            MedicationKnowledge_MonitoringProgramSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_administrationguidelines import (
            MedicationKnowledge_AdministrationGuidelinesSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_medicineclassification import (
            MedicationKnowledge_MedicineClassificationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_packaging import (
            MedicationKnowledge_PackagingSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_drugcharacteristic import (
            MedicationKnowledge_DrugCharacteristicSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_regulatory import (
            MedicationKnowledge_RegulatorySchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_kinetics import (
        ...
        my_parent_path = (
            parent_path + ".medicationknowledge"
            if parent_path
            ...
            [
                ...
                StructField(
                    ...
                    markdownSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".preparationinstruction",
                    ),
                    True,
                ),
