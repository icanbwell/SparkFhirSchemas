...
class MeasureReportSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.measurereport_group import (
        ...
        my_parent_path = (
            parent_path + ".measurereport" if parent_path else "measurereport"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    canonicalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".measure",
                    ),
                    True,
                ),
