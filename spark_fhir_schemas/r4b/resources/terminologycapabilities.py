...
class TerminologyCapabilitiesSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.terminologycapabilities_software import (
            TerminologyCapabilities_SoftwareSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.terminologycapabilities_implementation import (
            TerminologyCapabilities_ImplementationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.terminologycapabilities_codesystem import (
            TerminologyCapabilities_CodeSystemSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.terminologycapabilities_expansion import (
            TerminologyCapabilities_ExpansionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.terminologycapabilities_validatecode import (
            TerminologyCapabilities_ValidateCodeSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.terminologycapabilities_translation import (
            TerminologyCapabilities_TranslationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.terminologycapabilities_closure import (
        ...
        my_parent_path = (
            parent_path + ".terminologycapabilities"
            if parent_path
            else "terminologycapabilities"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    codeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".codesearch",
                    ),
                    True,
                ),
