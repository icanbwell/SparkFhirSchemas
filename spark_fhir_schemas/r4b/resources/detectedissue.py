...
class DetectedIssueSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.detectedissue_evidence import (
            DetectedIssue_EvidenceSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.detectedissue_mitigation import (
        ...
        my_parent_path = (
            parent_path + ".detectedissue" if parent_path else "detectedissue"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    uriSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".reference",
                    ),
                    True,
                ),
