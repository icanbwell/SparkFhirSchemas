...
class BiologicallyDerivedProductSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.biologicallyderivedproduct_collection import (
            BiologicallyDerivedProduct_CollectionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.biologicallyderivedproduct_processing import (
            BiologicallyDerivedProduct_ProcessingSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.biologicallyderivedproduct_manipulation import (
            BiologicallyDerivedProduct_ManipulationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.biologicallyderivedproduct_storage import (
        ...
        my_parent_path = (
            parent_path + ".biologicallyderivedproduct"
            if parent_path
            else "biologicallyderivedproduct"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    codeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".productcategory",
                    ),
                    True,
                ),
