...
class MedicationAdministrationSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.medicationadministration_performer import (
            MedicationAdministration_PerformerSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.annotation import AnnotationSchema
        from spark_fhir_schemas.r4b.complex_types.medicationadministration_dosage import (
