...
class CatalogEntrySchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.catalogentry_relatedentry import (
        ...
        my_parent_path = (
            parent_path + ".catalogentry" if parent_path else "catalogentry"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".validto",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".lastupdated",
                    ),
                    True,
                ),
