...
class ObservationDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.observationdefinition_quantitativedetails import (
            ObservationDefinition_QuantitativeDetailsSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.observationdefinition_qualifiedinterval import (
