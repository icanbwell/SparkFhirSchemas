...
class EvidenceSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.evidence_variabledefinition import (
            Evidence_VariableDefinitionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.codeableconcept import (
            CodeableConceptSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.evidence_statistic import (
            Evidence_StatisticSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.evidence_certainty import (
        ...
        my_parent_path = parent_path + ".evidence" if parent_path else "evidence"
        schema = StructType(
            [
