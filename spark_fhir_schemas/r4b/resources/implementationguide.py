...
class ImplementationGuideSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.implementationguide_dependson import (
            ImplementationGuide_DependsOnSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.implementationguide_global import (
            ImplementationGuide_GlobalSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.implementationguide_definition import (
            ImplementationGuide_DefinitionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.implementationguide_manifest import (
        ...
        my_parent_path = (
            parent_path + ".implementationguide"
            if parent_path
            else "implementationguide"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    idSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".packageid",
                    ),
                    True,
                ),
