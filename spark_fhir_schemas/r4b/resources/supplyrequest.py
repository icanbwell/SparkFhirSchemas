...
class SupplyRequestSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.supplyrequest_parameter import (
            SupplyRequest_ParameterSchema,
        )
        ...
        my_parent_path = (
            parent_path + ".supplyrequest" if parent_path else "supplyrequest"
        )
        schema = StructType(
            [
