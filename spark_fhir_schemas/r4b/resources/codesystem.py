...
class CodeSystemSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.codesystem_filter import (
            CodeSystem_FilterSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.codesystem_property import (
            CodeSystem_PropertySchema,
        )
        from spark_fhir_schemas.r4b.complex_types.codesystem_concept import (
        ...
        my_parent_path = parent_path + ".codesystem" if parent_path else "codesystem"
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    canonicalSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".supplements",
                    ),
                    True,
                ),
