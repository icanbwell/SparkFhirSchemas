...
class DocumentReferenceSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.documentreference_relatesto import (
            DocumentReference_RelatesToSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.documentreference_content import (
            DocumentReference_ContentSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.documentreference_context import (
