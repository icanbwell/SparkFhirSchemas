...
class SubstanceSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.substance_instance import (
            Substance_InstanceSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.substance_ingredient import (
        ...
        my_parent_path = parent_path + ".substance" if parent_path else "substance"
        schema = StructType(
            [
