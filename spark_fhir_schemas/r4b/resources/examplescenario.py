...
class ExampleScenarioSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.examplescenario_actor import (
            ExampleScenario_ActorSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.examplescenario_instance import (
            ExampleScenario_InstanceSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.examplescenario_process import (
        ...
        my_parent_path = (
            parent_path + ".examplescenario" if parent_path else "examplescenario"
        )
        schema = StructType(
            [
