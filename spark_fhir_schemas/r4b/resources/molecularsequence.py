...
class MolecularSequenceSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.molecularsequence_referenceseq import (
            MolecularSequence_ReferenceSeqSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.molecularsequence_variant import (
            MolecularSequence_VariantSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.molecularsequence_quality import (
            MolecularSequence_QualitySchema,
        )
        from spark_fhir_schemas.r4b.complex_types.molecularsequence_repository import (
            MolecularSequence_RepositorySchema,
        )
        from spark_fhir_schemas.r4b.complex_types.molecularsequence_structurevariant import (
