...
class ClaimResponseSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.claimresponse_item import (
            ClaimResponse_ItemSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.claimresponse_additem import (
            ClaimResponse_AddItemSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.claimresponse_adjudication import (
            ClaimResponse_AdjudicationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.claimresponse_total import (
            ClaimResponse_TotalSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.claimresponse_payment import (
            ClaimResponse_PaymentSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.attachment import AttachmentSchema
        from spark_fhir_schemas.r4b.complex_types.claimresponse_processnote import (
            ClaimResponse_ProcessNoteSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.claimresponse_insurance import (
            ClaimResponse_InsuranceSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.claimresponse_error import (
        ...
        my_parent_path = (
            parent_path + ".claimresponse" if parent_path else "claimresponse"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "total",
                    ArrayType(
                        ClaimResponse_TotalSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
