...
class ResearchElementDefinitionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.researchelementdefinition_characteristic import (
        ...
        my_parent_path = (
            parent_path + ".researchelementdefinition"
            if parent_path
            else "researchelementdefinition"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    codeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".variabletype",
                    ),
                    True,
                ),
                ...
                StructField(
                    "characteristic",
                    ArrayType(
                        ResearchElementDefinition_CharacteristicSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
