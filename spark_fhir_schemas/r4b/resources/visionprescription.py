...
class VisionPrescriptionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.visionprescription_lensspecification import (
        ...
        my_parent_path = (
            parent_path + ".visionprescription" if parent_path else "visionprescription"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".datewritten",
                    ),
                    True,
                ),
