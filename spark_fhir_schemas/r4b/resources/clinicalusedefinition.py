...
class ClinicalUseDefinitionSchema:
    """
    ...
    def get_schema(
        ...
        undesirableEffect: Describe the possible undesirable effects (negative outcomes) from the use of
            the medicinal product as treatment.

        warning: A critical piece of information about environmental, health or physical risks
        ...
        from spark_fhir_schemas.r4b.complex_types.clinicalusedefinition_contraindication import (
            ClinicalUseDefinition_ContraindicationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.clinicalusedefinition_indication import (
            ClinicalUseDefinition_IndicationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.clinicalusedefinition_interaction import (
            ClinicalUseDefinition_InteractionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.clinicalusedefinition_undesirableeffect import (
            ClinicalUseDefinition_UndesirableEffectSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.clinicalusedefinition_warning import (
            ClinicalUseDefinition_WarningSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("ClinicalUseDefinition") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["ClinicalUseDefinition"]
        my_parent_path = (
            parent_path + ".clinicalusedefinition"
            if parent_path
            else "clinicalusedefinition"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "contraindication",
                    ClinicalUseDefinition_ContraindicationSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "indication",
                    ClinicalUseDefinition_IndicationSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "interaction",
                    ClinicalUseDefinition_InteractionSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "undesirableEffect",
                    ClinicalUseDefinition_UndesirableEffectSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "warning",
                    ClinicalUseDefinition_WarningSchema.get_schema(
                        max_nesting_depth=max_nesting_depth,
                        nesting_depth=nesting_depth + 1,
                        nesting_list=my_nesting_list,
                        max_recursion_limit=max_recursion_limit,
