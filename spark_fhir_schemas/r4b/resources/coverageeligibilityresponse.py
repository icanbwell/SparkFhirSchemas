...
class CoverageEligibilityResponseSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.coverageeligibilityresponse_insurance import (
            CoverageEligibilityResponse_InsuranceSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.codeableconcept import (
            CodeableConceptSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.coverageeligibilityresponse_error import (
            CoverageEligibilityResponse_ErrorSchema,
        )
        ...
        my_parent_path = (
            parent_path + ".coverageeligibilityresponse"
            if parent_path
            else "coverageeligibilityresponse"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "insurance",
                    ArrayType(
                        CoverageEligibilityResponse_InsuranceSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "error",
                    ArrayType(
                        CoverageEligibilityResponse_ErrorSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
