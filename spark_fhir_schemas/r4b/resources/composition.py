...
class CompositionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.composition_attester import (
            Composition_AttesterSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.composition_relatesto import (
            Composition_RelatesToSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.composition_event import (
            Composition_EventSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.composition_section import (
