...
class SpecimenSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.specimen_collection import (
            Specimen_CollectionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.specimen_processing import (
            Specimen_ProcessingSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.specimen_container import (
        ...
        my_parent_path = parent_path + ".specimen" if parent_path else "specimen"
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    dateTimeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".receivedtime",
                    ),
                    True,
                ),
