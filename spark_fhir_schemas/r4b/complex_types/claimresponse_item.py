...
class ClaimResponse_ItemSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.claimresponse_detail import (
        ...
        my_parent_path = (
            parent_path + ".claimresponse_item" if parent_path else "claimresponse_item"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    positiveIntSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".itemsequence",
                    ),
                    True,
                ),
