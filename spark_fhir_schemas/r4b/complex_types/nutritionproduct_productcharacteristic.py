...
class NutritionProduct_ProductCharacteristicSchema:
    """
    ...
    def get_schema(
        ...
        type: A code specifying which characteristic of the product is being described (for
        ...
        if (
            max_recursion_limit
            and nesting_list.count("NutritionProduct_ProductCharacteristic")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".nutritionproduct_productcharacteristic"
            if parent_path
            else "nutritionproduct_productcharacteristic"
        )
        schema = StructType(
            [
