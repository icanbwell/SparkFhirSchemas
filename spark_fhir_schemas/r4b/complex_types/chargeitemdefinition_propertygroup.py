...
class ChargeItemDefinition_PropertyGroupSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.chargeitemdefinition_pricecomponent import (
        ...
        my_parent_path = (
            parent_path + ".chargeitemdefinition_propertygroup"
            if parent_path
            else "chargeitemdefinition_propertygroup"
        )
        schema = StructType(
            [
