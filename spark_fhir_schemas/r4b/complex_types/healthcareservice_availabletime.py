...
class HealthcareService_AvailableTimeSchema:
    ...
    def get_schema(
        ...
        my_parent_path = (
            parent_path + ".healthcareservice_availabletime"
            if parent_path
            else "healthcareservice_availabletime"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    timeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".availablestarttime",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    timeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".availableendtime",
                    ),
                    True,
                ),
            ]
