...
class StructureMap_GroupSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.structuremap_input import (
            StructureMap_InputSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.structuremap_rule import (
        ...
        my_parent_path = (
            parent_path + ".structuremap_group" if parent_path else "structuremap_group"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    idSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".extends",
                    ),
                    True,
                ),
