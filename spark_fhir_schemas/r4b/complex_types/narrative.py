...
class NarrativeSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.simple_types.xhtml import xhtmlSchema
        ...
        my_parent_path = parent_path + ".narrative" if parent_path else "narrative"
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    xhtmlSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".div",
                    ),
                    True,
                ),
            ]
