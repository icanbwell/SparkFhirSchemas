...
class MedicinalProductDefinition_CountryLanguageSchema:
    """
    ...
    def get_schema(
        ...
        jurisdiction: Jurisdiction code for where this name applies. A jurisdiction may be a sub- or
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductDefinition_CountryLanguage")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".medicinalproductdefinition_countrylanguage"
            if parent_path
            else "medicinalproductdefinition_countrylanguage"
        )
        schema = StructType(
            [
