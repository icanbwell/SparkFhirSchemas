...
class MedicinalProductDefinition_CharacteristicSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductDefinition_Characteristic")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".medicinalproductdefinition_characteristic"
            if parent_path
            else "medicinalproductdefinition_characteristic"
        )
        schema = StructType(
            [
