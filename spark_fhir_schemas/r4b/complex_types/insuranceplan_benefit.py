...
class InsurancePlan_BenefitSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.insuranceplan_limit import (
            InsurancePlan_LimitSchema,
        )
        ...
        my_parent_path = (
            parent_path + ".insuranceplan_benefit"
            if parent_path
            else "insuranceplan_benefit"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "limit",
                    ArrayType(
                        InsurancePlan_LimitSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
