...
class Location_HoursOfOperationSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.simple_types.time import timeSchema
        ...
        my_parent_path = (
            parent_path + ".location_hoursofoperation"
            if parent_path
            else "location_hoursofoperation"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    timeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".openingtime",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    timeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".closingtime",
                    ),
                    True,
                ),
            ]
