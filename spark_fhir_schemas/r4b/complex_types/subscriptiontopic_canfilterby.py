...
class SubscriptionTopic_CanFilterBySchema:
    """
    ...
    def get_schema(
        ...
        resource: URL of the Resource that is the type used in this filter. This is the "focus"
        ...
        modifier: Allowable operators to apply when determining matches (Search Modifiers).  If
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubscriptionTopic_CanFilterBy")
            >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["SubscriptionTopic_CanFilterBy"]
        my_parent_path = (
            parent_path + ".subscriptiontopic_canfilterby"
            if parent_path
            else "subscriptiontopic_canfilterby"
        )
        schema = StructType(
            [
                ...
                # "http://hl7.org/fhir/SearchParameter/encounter-patient") or topic-defined
                # parameter (like "hub.event") which is a label for the filter.
                StructField("filterParameter", StringType(), True),
                # Either the canonical URL to a search parameter (like
                # "http://hl7.org/fhir/SearchParameter/encounter-patient") or the officially-
                # defined URI for a shared filter concept (like
                # "http://example.org/concepts/shared-common-event").
                StructField(
                    ...
                    uriSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".filterdefinition",
                    ),
                    True,
                ),
