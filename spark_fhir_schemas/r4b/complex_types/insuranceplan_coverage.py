...
class InsurancePlan_CoverageSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.insuranceplan_benefit import (
            InsurancePlan_BenefitSchema,
        )
        ...
        my_parent_path = (
            parent_path + ".insuranceplan_coverage"
            if parent_path
            else "insuranceplan_coverage"
        )
        schema = StructType(
            [
