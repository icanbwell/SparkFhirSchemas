...
class ExplanationOfBenefit_DetailSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.explanationofbenefit_subdetail import (
        ...
        my_parent_path = (
            parent_path + ".explanationofbenefit_detail"
            if parent_path
            else "explanationofbenefit_detail"
        )
        schema = StructType(
            [
