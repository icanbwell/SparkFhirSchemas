...
class SubstanceDefinition_NameSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.substancedefinition_official import (
            SubstanceDefinition_OfficialSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.reference import ReferenceSchema

        if (
            max_recursion_limit
            and nesting_list.count("SubstanceDefinition_Name") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["SubstanceDefinition_Name"]
        my_parent_path = (
            parent_path + ".substancedefinition_name"
            if parent_path
            else "substancedefinition_name"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "official",
                    ArrayType(
                        SubstanceDefinition_OfficialSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
