...
class SubscriptionTopic_QueryCriteriaSchema:
    """
    ...
    def get_schema(
        ...
        previous: The FHIR query based rules are applied to the previous resource state (e.g.,
        ...
        resultForDelete: For "delete" interactions, should the "current" criteria count as an automatic
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubscriptionTopic_QueryCriteria")
            >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["SubscriptionTopic_QueryCriteria"]
        my_parent_path = (
            parent_path + ".subscriptiontopic_querycriteria"
            if parent_path
            else "subscriptiontopic_querycriteria"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    codeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".resultforcreate",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    codeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".resultfordelete",
                    ),
                    True,
                ),
                ...
                # trigger a notification for this topic.  Otherwise a notification for this
                # topic will be triggered if either one evaluates to true.
                StructField("requireBoth", BooleanType(), True),
            ]
        )
