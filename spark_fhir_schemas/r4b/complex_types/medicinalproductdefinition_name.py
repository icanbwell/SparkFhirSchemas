...
class MedicinalProductDefinition_NameSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.medicinalproductdefinition_namepart import (
            MedicinalProductDefinition_NamePartSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicinalproductdefinition_countrylanguage import (
            MedicinalProductDefinition_CountryLanguageSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductDefinition_Name")
            >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["MedicinalProductDefinition_Name"]
        my_parent_path = (
            parent_path + ".medicinalproductdefinition_name"
            if parent_path
            else "medicinalproductdefinition_name"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "namePart",
                    ArrayType(
                        MedicinalProductDefinition_NamePartSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "countryLanguage",
                    ArrayType(
                        MedicinalProductDefinition_CountryLanguageSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
