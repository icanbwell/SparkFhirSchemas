...
class Citation_PartSchema:
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Citation_Part") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Citation_Part"]
        my_parent_path = (
            parent_path + ".citation_part" if parent_path else "citation_part"
        )
        schema = StructType(
            [
