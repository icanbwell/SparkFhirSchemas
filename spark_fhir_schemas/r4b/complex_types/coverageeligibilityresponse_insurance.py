...
class CoverageEligibilityResponse_InsuranceSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.coverageeligibilityresponse_item import (
        ...
        my_parent_path = (
            parent_path + ".coverageeligibilityresponse_insurance"
            if parent_path
            else "coverageeligibilityresponse_insurance"
        )
        schema = StructType(
            [
