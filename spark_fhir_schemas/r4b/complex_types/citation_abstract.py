...
class Citation_AbstractSchema:
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Citation_Abstract") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Citation_Abstract"]
        my_parent_path = (
            parent_path + ".citation_abstract" if parent_path else "citation_abstract"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    markdownSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".text",
                    ),
                    True,
                ),
