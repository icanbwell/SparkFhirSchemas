...
class ClinicalUseDefinition_InteractionSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.clinicalusedefinition_interactant import (
            ClinicalUseDefinition_InteractantSchema,
        )
        ...
        if (
            max_recursion_limit
            and nesting_list.count("ClinicalUseDefinition_Interaction")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".clinicalusedefinition_interaction"
            if parent_path
            else "clinicalusedefinition_interaction"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "interactant",
                    ArrayType(
                        ClinicalUseDefinition_InteractantSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
