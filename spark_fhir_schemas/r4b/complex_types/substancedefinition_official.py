...
class SubstanceDefinition_OfficialSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubstanceDefinition_Official")
            >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["SubstanceDefinition_Official"]
        my_parent_path = (
            parent_path + ".substancedefinition_official"
            if parent_path
            else "substancedefinition_official"
        )
        schema = StructType(
            [
