...
class TerminologyCapabilities_VersionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.terminologycapabilities_filter import (
        ...
        my_parent_path = (
            parent_path + ".terminologycapabilities_version"
            if parent_path
            else "terminologycapabilities_version"
        )
        schema = StructType(
            [
