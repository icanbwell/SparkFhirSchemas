...
class CapabilityStatement_RestSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.capabilitystatement_security import (
            CapabilityStatement_SecuritySchema,
        )
        from spark_fhir_schemas.r4b.complex_types.capabilitystatement_resource import (
            CapabilityStatement_ResourceSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.capabilitystatement_interaction1 import (
            CapabilityStatement_Interaction1Schema,
        )
        from spark_fhir_schemas.r4b.complex_types.capabilitystatement_searchparam import (
            CapabilityStatement_SearchParamSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.capabilitystatement_operation import (
        ...
        my_parent_path = (
            parent_path + ".capabilitystatement_rest"
            if parent_path
            else "capabilitystatement_rest"
        )
        schema = StructType(
            [
