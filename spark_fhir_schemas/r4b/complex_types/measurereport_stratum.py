...
class MeasureReport_StratumSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.measurereport_component import (
            MeasureReport_ComponentSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.measurereport_population1 import (
        ...
        my_parent_path = (
            parent_path + ".measurereport_stratum"
            if parent_path
            else "measurereport_stratum"
        )
        schema = StructType(
            [
