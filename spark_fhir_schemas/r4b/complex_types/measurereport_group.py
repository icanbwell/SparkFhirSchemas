...
class MeasureReport_GroupSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.measurereport_population import (
            MeasureReport_PopulationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.quantity import QuantitySchema
        from spark_fhir_schemas.r4b.complex_types.measurereport_stratifier import (
        ...
        my_parent_path = (
            parent_path + ".measurereport_group"
            if parent_path
            else "measurereport_group"
        )
        schema = StructType(
            [
