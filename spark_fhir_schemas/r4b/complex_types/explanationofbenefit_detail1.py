...
class ExplanationOfBenefit_Detail1Schema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.explanationofbenefit_subdetail1 import (
            ExplanationOfBenefit_SubDetail1Schema,
        )
        ...
        my_parent_path = (
            parent_path + ".explanationofbenefit_detail1"
            if parent_path
            else "explanationofbenefit_detail1"
        )
        schema = StructType(
            [
