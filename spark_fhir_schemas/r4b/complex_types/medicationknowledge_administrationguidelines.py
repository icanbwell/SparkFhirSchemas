...
class MedicationKnowledge_AdministrationGuidelinesSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_dosage import (
        ...
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_patientcharacteristics import (
