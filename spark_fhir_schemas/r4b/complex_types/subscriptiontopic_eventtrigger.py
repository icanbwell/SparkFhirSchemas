...
class SubscriptionTopic_EventTriggerSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubscriptionTopic_EventTrigger")
            >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["SubscriptionTopic_EventTrigger"]
        my_parent_path = (
            parent_path + ".subscriptiontopic_eventtrigger"
            if parent_path
            else "subscriptiontopic_eventtrigger"
        )
        schema = StructType(
            [
