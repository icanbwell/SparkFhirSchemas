...
class MedicinalProductDefinition_OperationSchema:
    """
    ...
    def get_schema(
        ...
        type: The type of manufacturing operation e.g. manufacturing itself, re-packaging.
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductDefinition_Operation")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".medicinalproductdefinition_operation"
            if parent_path
            else "medicinalproductdefinition_operation"
        )
        schema = StructType(
            [
