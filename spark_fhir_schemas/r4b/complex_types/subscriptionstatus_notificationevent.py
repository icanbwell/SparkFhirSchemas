...
class SubscriptionStatus_NotificationEventSchema:
    """
    ...
    def get_schema(
        ...
        focus: The focus of this event. While this will usually be a reference to the focus
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubscriptionStatus_NotificationEvent")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".subscriptionstatus_notificationevent"
            if parent_path
            else "subscriptionstatus_notificationevent"
        )
        schema = StructType(
            [
