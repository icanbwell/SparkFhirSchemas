...
class Contract_TermSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.contract_securitylabel import (
            Contract_SecurityLabelSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.contract_offer import (
            Contract_OfferSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.contract_asset import (
            Contract_AssetSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.contract_action import (
        ...
        my_parent_path = (
            parent_path + ".contract_term" if parent_path else "contract_term"
        )
        schema = StructType(
            [
