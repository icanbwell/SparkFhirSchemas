...
class TestScript_MetadataSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.testscript_link import (
            TestScript_LinkSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.testscript_capability import (
        ...
        my_parent_path = (
            parent_path + ".testscript_metadata"
            if parent_path
            else "testscript_metadata"
        )
        schema = StructType(
            [
