...
class PackagedProductDefinition_ContainedItemSchema:
    """
    ...
    def get_schema(
        ...
        item: The actual item(s) of medication, as manufactured, or a device (typically, but
        ...
        if (
            max_recursion_limit
            and nesting_list.count("PackagedProductDefinition_ContainedItem")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".packagedproductdefinition_containeditem"
            if parent_path
            else "packagedproductdefinition_containeditem"
        )
        schema = StructType(
            [
