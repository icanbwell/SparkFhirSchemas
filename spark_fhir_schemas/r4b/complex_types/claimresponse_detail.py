...
class ClaimResponse_DetailSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.claimresponse_subdetail import (
        ...
        my_parent_path = (
            parent_path + ".claimresponse_detail"
            if parent_path
            else "claimresponse_detail"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    positiveIntSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".detailsequence",
                    ),
                    True,
                ),
                ...
                StructField(
                    "subDetail",
                    ArrayType(
                        ClaimResponse_SubDetailSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
