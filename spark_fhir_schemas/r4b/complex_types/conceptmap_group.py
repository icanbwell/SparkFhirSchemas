...
class ConceptMap_GroupSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.conceptmap_element import (
            ConceptMap_ElementSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.conceptmap_unmapped import (
        ...
        my_parent_path = (
            parent_path + ".conceptmap_group" if parent_path else "conceptmap_group"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    uriSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".source",
                    ),
                    True,
                ),
                ...
                StructField(
                    ...
                    uriSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".target",
                    ),
                    True,
                ),
                # The specific version of the code system, as determined by the code system
