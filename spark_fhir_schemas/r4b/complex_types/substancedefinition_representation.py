...
class SubstanceDefinition_RepresentationSchema:
    """
    ...
    def get_schema(
        ...
        format: The format of the representation e.g. InChI, SMILES, MOLFILE, CDX, SDF, PDB,
            mmCIF. The logical content type rather than the physical file format of a
            document.

        document: An attached file with the structural representation or characterization e.g. a
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubstanceDefinition_Representation")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".substancedefinition_representation"
            if parent_path
            else "substancedefinition_representation"
        )
        schema = StructType(
            [
