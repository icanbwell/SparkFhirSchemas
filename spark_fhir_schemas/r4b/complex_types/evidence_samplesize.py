...
class Evidence_SampleSizeSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Evidence_SampleSize") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Evidence_SampleSize"]
        my_parent_path = (
            parent_path + ".evidence_samplesize"
            if parent_path
            else "evidence_samplesize"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    unsignedIntSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".knowndatacount",
                    ),
                    True,
                ),
            ]
