...
class AdministrableProductDefinition_RouteOfAdministrationSchema:
    """
    ...
    def get_schema(
        ...
        firstDose: The first dose (dose quantity) administered can be specified for the product,
            using a numerical value and its unit of measurement.

        maxSingleDose: The maximum single dose that can be administered, specified using a numerical
        ...
        from spark_fhir_schemas.r4b.complex_types.administrableproductdefinition_targetspecies import (
            AdministrableProductDefinition_TargetSpeciesSchema,
        )
        ...
        my_parent_path = (
            parent_path + ".administrableproductdefinition_routeofadministration"
            if parent_path
            else "administrableproductdefinition_routeofadministration"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "targetSpecies",
                    ArrayType(
                        AdministrableProductDefinition_TargetSpeciesSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
