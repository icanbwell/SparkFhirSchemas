...
class PlanDefinition_ActionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.plandefinition_condition import (
            PlanDefinition_ConditionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.datarequirement import (
            DataRequirementSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.plandefinition_relatedaction import (
        ...
        from spark_fhir_schemas.r4b.complex_types.plandefinition_participant import (
            PlanDefinition_ParticipantSchema,
        )
        from spark_fhir_schemas.r4b.simple_types.canonical import canonicalSchema
        from spark_fhir_schemas.r4b.complex_types.plandefinition_dynamicvalue import (
        ...
        my_parent_path = (
            parent_path + ".plandefinition_action"
            if parent_path
            else "plandefinition_action"
        )
        schema = StructType(
            [
