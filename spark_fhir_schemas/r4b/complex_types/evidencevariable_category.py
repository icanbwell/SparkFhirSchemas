...
class EvidenceVariable_CategorySchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("EvidenceVariable_Category") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["EvidenceVariable_Category"]
        my_parent_path = (
            parent_path + ".evidencevariable_category"
            if parent_path
            else "evidencevariable_category"
        )
        schema = StructType(
            [
