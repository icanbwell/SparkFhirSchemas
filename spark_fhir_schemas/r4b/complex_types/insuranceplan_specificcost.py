...
class InsurancePlan_SpecificCostSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.insuranceplan_benefit1 import (
        ...
        my_parent_path = (
            parent_path + ".insuranceplan_specificcost"
            if parent_path
            else "insuranceplan_specificcost"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "benefit",
                    ArrayType(
                        InsurancePlan_Benefit1Schema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
