...
class MedicationKnowledge_RegulatorySchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_substitution import (
            MedicationKnowledge_SubstitutionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_schedule import (
            MedicationKnowledge_ScheduleSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.medicationknowledge_maxdispense import (
        ...
        my_parent_path = (
            parent_path + ".medicationknowledge_regulatory"
            if parent_path
            else "medicationknowledge_regulatory"
        )
        schema = StructType(
            [
