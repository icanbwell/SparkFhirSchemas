...
class ClinicalUseDefinition_OtherTherapySchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("ClinicalUseDefinition_OtherTherapy")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".clinicalusedefinition_othertherapy"
            if parent_path
            else "clinicalusedefinition_othertherapy"
        )
        schema = StructType(
            [
