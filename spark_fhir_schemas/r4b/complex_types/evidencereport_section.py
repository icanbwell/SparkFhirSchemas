...
class EvidenceReport_SectionSchema:
    """
    ...
    def get_schema(
        ...
        focusReference: A definitional Resource identifying the kind of content contained within the
        ...
        entryReference: A reference to the actual resource from which the narrative in the section is
            derived.
        ...
        if (
            max_recursion_limit
            and nesting_list.count("EvidenceReport_Section") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["EvidenceReport_Section"]
        my_parent_path = (
            parent_path + ".evidencereport_section"
            if parent_path
            else "evidencereport_section"
        )
        schema = StructType(
            [
