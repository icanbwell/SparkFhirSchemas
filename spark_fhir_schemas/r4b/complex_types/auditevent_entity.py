...
class AuditEvent_EntitySchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.auditevent_detail import (
        ...
        my_parent_path = (
            parent_path + ".auditevent_entity" if parent_path else "auditevent_entity"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    base64BinarySchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".query",
                    ),
                    True,
                ),
