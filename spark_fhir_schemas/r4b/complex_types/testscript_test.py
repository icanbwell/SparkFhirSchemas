...
class TestScript_TestSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.testscript_action1 import (
        ...
        my_parent_path = (
            parent_path + ".testscript_test" if parent_path else "testscript_test"
        )
        schema = StructType(
            [
