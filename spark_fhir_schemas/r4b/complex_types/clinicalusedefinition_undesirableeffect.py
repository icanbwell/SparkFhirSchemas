...
class ClinicalUseDefinition_UndesirableEffectSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("ClinicalUseDefinition_UndesirableEffect")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".clinicalusedefinition_undesirableeffect"
            if parent_path
            else "clinicalusedefinition_undesirableeffect"
        )
        schema = StructType(
            [
