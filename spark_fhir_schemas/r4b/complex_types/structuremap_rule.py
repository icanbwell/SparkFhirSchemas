...
class StructureMap_RuleSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.structuremap_source import (
            StructureMap_SourceSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.structuremap_target import (
            StructureMap_TargetSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.structuremap_dependent import (
