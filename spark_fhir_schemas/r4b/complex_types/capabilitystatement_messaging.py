...
class CapabilityStatement_MessagingSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.capabilitystatement_endpoint import (
        ...
        from spark_fhir_schemas.r4b.complex_types.capabilitystatement_supportedmessage import (
        ...
        my_parent_path = (
            parent_path + ".capabilitystatement_messaging"
            if parent_path
            else "capabilitystatement_messaging"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    unsignedIntSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".reliablecache",
                    ),
                    True,
                ),
