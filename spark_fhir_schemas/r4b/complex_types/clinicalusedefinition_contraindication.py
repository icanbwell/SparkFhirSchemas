...
class ClinicalUseDefinition_ContraindicationSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("ClinicalUseDefinition_Contraindication")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".clinicalusedefinition_contraindication"
            if parent_path
            else "clinicalusedefinition_contraindication"
        )
        schema = StructType(
            [
