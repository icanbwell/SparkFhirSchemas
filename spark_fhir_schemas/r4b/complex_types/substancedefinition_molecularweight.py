...
class SubstanceDefinition_MolecularWeightSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubstanceDefinition_MolecularWeight")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".substancedefinition_molecularweight"
            if parent_path
            else "substancedefinition_molecularweight"
        )
        schema = StructType(
            [
