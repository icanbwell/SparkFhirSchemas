...
class AdministrableProductDefinition_TargetSpeciesSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.administrableproductdefinition_withdrawalperiod import (
            AdministrableProductDefinition_WithdrawalPeriodSchema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("AdministrableProductDefinition_TargetSpecies")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".administrableproductdefinition_targetspecies"
            if parent_path
            else "administrableproductdefinition_targetspecies"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "withdrawalPeriod",
                    ArrayType(
                        AdministrableProductDefinition_WithdrawalPeriodSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
