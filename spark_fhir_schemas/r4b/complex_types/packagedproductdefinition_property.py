...
class PackagedProductDefinition_PropertySchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("PackagedProductDefinition_Property")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".packagedproductdefinition_property"
            if parent_path
            else "packagedproductdefinition_property"
        )
        schema = StructType(
            [
