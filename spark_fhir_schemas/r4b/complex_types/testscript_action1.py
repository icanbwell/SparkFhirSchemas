...
class TestScript_Action1Schema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.testscript_operation import (
            TestScript_OperationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.testscript_assert import (
        ...
        my_parent_path = (
            parent_path + ".testscript_action1" if parent_path else "testscript_action1"
        )
        schema = StructType(
            [
