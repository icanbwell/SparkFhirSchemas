...
class Bundle_EntrySchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.bundle_search import (
            Bundle_SearchSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.bundle_request import (
            Bundle_RequestSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.bundle_response import (
        ...
        my_parent_path = (
            parent_path + ".bundle_entry" if parent_path else "bundle_entry"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    uriSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".fullurl",
                    ),
                    True,
                ),
