...
class NutritionOrder_OralDietSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.nutritionorder_nutrient import (
            NutritionOrder_NutrientSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.nutritionorder_texture import (
        ...
        my_parent_path = (
            parent_path + ".nutritionorder_oraldiet"
            if parent_path
            else "nutritionorder_oraldiet"
        )
        schema = StructType(
            [
