...
class ExampleScenario_InstanceSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.examplescenario_version import (
            ExampleScenario_VersionSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.examplescenario_containedinstance import (
        ...
        my_parent_path = (
            parent_path + ".examplescenario_instance"
            if parent_path
            else "examplescenario_instance"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    codeSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".resourcetype",
                    ),
                    True,
                ),
