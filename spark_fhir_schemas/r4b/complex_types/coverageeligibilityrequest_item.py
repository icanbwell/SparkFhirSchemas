...
class CoverageEligibilityRequest_ItemSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.coverageeligibilityrequest_diagnosis import (
        ...
        my_parent_path = (
            parent_path + ".coverageeligibilityrequest_item"
            if parent_path
            else "coverageeligibilityrequest_item"
        )
        schema = StructType(
            [
