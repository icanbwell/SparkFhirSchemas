...
class Citation_Summary1Schema:
    ...
    def get_schema(
        ...
        value: The display string for the author list, contributor list, or contributorship
            statement.
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Citation_Summary1") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Citation_Summary1"]
        my_parent_path = (
            parent_path + ".citation_summary1" if parent_path else "citation_summary1"
        )
        schema = StructType(
            [
