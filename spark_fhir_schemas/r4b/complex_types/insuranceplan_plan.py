...
class InsurancePlan_PlanSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.insuranceplan_generalcost import (
            InsurancePlan_GeneralCostSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.insuranceplan_specificcost import (
        ...
        my_parent_path = (
            parent_path + ".insuranceplan_plan" if parent_path else "insuranceplan_plan"
        )
        schema = StructType(
            [
