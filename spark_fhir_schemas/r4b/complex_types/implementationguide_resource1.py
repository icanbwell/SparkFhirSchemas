...
class ImplementationGuide_Resource1Schema:
    """
    ...
    def get_schema(
        ...
        my_parent_path = (
            parent_path + ".implementationguide_resource1"
            if parent_path
            else "implementationguide_resource1"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    urlSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".relativepath",
                    ),
                    True,
                ),
            ]
