...
class ValueSet_ExpansionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.valueset_parameter import (
            ValueSet_ParameterSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.valueset_contains import (
        ...
        my_parent_path = (
            parent_path + ".valueset_expansion" if parent_path else "valueset_expansion"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    uriSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".identifier",
                    ),
                    True,
                ),
