...
class SpecimenDefinition_TypeTestedSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.specimendefinition_container import (
            SpecimenDefinition_ContainerSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.duration import DurationSchema
        from spark_fhir_schemas.r4b.complex_types.specimendefinition_handling import (
        ...
        my_parent_path = (
            parent_path + ".specimendefinition_typetested"
            if parent_path
            else "specimendefinition_typetested"
        )
        schema = StructType(
            [
