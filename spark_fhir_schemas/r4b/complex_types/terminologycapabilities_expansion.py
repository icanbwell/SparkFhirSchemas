...
class TerminologyCapabilities_ExpansionSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.terminologycapabilities_parameter import (
        ...
        my_parent_path = (
            parent_path + ".terminologycapabilities_expansion"
            if parent_path
            else "terminologycapabilities_expansion"
        )
        schema = StructType(
            [
                ...
                StructField(
                    ...
                    markdownSchema.get_schema(
                        ...
                        include_modifierExtension=include_modifierExtension,
                        use_date_for=use_date_for,
                        parent_path=my_parent_path + ".textfilter",
                    ),
                    True,
                ),
            ]
