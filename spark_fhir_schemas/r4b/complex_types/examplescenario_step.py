...
class ExampleScenario_StepSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.examplescenario_operation import (
            ExampleScenario_OperationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.examplescenario_alternative import (
        ...
        my_parent_path = (
            parent_path + ".examplescenario_step"
            if parent_path
            else "examplescenario_step"
        )
        schema = StructType(
            [
