...
class Ingredient_ReferenceStrengthSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Ingredient_ReferenceStrength")
            >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Ingredient_ReferenceStrength"]
        my_parent_path = (
            parent_path + ".ingredient_referencestrength"
            if parent_path
            else "ingredient_referencestrength"
        )
        schema = StructType(
            [
