...
class MedicinalProductDefinition_ContactSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductDefinition_Contact")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".medicinalproductdefinition_contact"
            if parent_path
            else "medicinalproductdefinition_contact"
        )
        schema = StructType(
            [
