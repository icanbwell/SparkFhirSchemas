...
class RegulatedAuthorization_CaseSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("RegulatedAuthorization_Case") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["RegulatedAuthorization_Case"]
        my_parent_path = (
            parent_path + ".regulatedauthorization_case"
            if parent_path
            else "regulatedauthorization_case"
        )
        schema = StructType(
            [
