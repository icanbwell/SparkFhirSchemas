...
class Citation_ContributorshipSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.citation_entry import (
            Citation_EntrySchema,
        )
        from spark_fhir_schemas.r4b.complex_types.citation_summary1 import (
            Citation_Summary1Schema,
        )

        if (
            max_recursion_limit
            and nesting_list.count("Citation_Contributorship") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Citation_Contributorship"]
        my_parent_path = (
            parent_path + ".citation_contributorship"
            if parent_path
            else "citation_contributorship"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "entry",
                    ArrayType(
                        Citation_EntrySchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
                ...
                StructField(
                    "summary",
                    ArrayType(
                        Citation_Summary1Schema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
