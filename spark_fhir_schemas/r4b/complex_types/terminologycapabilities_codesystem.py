...
class TerminologyCapabilities_CodeSystemSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.terminologycapabilities_version import (
            TerminologyCapabilities_VersionSchema,
        )
        ...
        my_parent_path = (
            parent_path + ".terminologycapabilities_codesystem"
            if parent_path
            else "terminologycapabilities_codesystem"
        )
        schema = StructType(
            [
                ...
                StructField(
                    "version",
                    ArrayType(
                        TerminologyCapabilities_VersionSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
