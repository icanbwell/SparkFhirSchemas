...
class MolecularSequence_StructureVariantSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.molecularsequence_outer import (
            MolecularSequence_OuterSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.molecularsequence_inner import (
        ...
        my_parent_path = (
            parent_path + ".molecularsequence_structurevariant"
            if parent_path
            else "molecularsequence_structurevariant"
        )
        schema = StructType(
            [
