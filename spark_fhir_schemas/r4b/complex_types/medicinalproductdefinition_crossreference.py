...
class MedicinalProductDefinition_CrossReferenceSchema:
    """
    ...
    def get_schema(
        ...
        product: Reference to another product, e.g. for linking authorised to investigational
            product.

        type: The type of relationship, for instance branded to generic, virtual to actual
        ...
        if (
            max_recursion_limit
            and nesting_list.count("MedicinalProductDefinition_CrossReference")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".medicinalproductdefinition_crossreference"
            if parent_path
            else "medicinalproductdefinition_crossreference"
        )
        schema = StructType(
            [
