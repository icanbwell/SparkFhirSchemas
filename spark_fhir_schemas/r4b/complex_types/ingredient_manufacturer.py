...
class Ingredient_ManufacturerSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Ingredient_Manufacturer") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Ingredient_Manufacturer"]
        my_parent_path = (
            parent_path + ".ingredient_manufacturer"
            if parent_path
            else "ingredient_manufacturer"
        )
        schema = StructType(
            [
