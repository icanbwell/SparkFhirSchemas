...
class Measure_GroupSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.measure_population import (
            Measure_PopulationSchema,
        )
        from spark_fhir_schemas.r4b.complex_types.measure_stratifier import (
        ...
        my_parent_path = (
            parent_path + ".measure_group" if parent_path else "measure_group"
        )
        schema = StructType(
            [
