...
class Evidence_CertaintySchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("Evidence_Certainty") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["Evidence_Certainty"]
        my_parent_path = (
            parent_path + ".evidence_certainty" if parent_path else "evidence_certainty"
        )
        schema = StructType(
            [
                ...
                StructField("rater", StringType(), True),
