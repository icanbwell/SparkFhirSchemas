...
class Contract_OfferSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.contract_party import (
        ...
        from spark_fhir_schemas.r4b.complex_types.contract_answer import (
        ...
        my_parent_path = (
            parent_path + ".contract_offer" if parent_path else "contract_offer"
        )
        schema = StructType(
            [
