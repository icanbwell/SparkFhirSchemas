...
class PackagedProductDefinition_ShelfLifeStorageSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("PackagedProductDefinition_ShelfLifeStorage")
            >= max_recursion_limit
        ...
        my_parent_path = (
            parent_path + ".packagedproductdefinition_shelflifestorage"
            if parent_path
            else "packagedproductdefinition_shelflifestorage"
        )
        schema = StructType(
            [
                ...
                # be specified in accordance with ISO 11240 and the resulting terminology The
                # symbol and the symbol identifier shall be used.
                StructField("periodString", StringType(), True),
