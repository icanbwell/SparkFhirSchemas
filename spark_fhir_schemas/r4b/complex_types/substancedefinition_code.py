...
class SubstanceDefinition_CodeSchema:
    """
    ...
    def get_schema(
        ...
        if (
            max_recursion_limit
            and nesting_list.count("SubstanceDefinition_Code") >= max_recursion_limit
        ) or (max_nesting_depth and nesting_depth >= max_nesting_depth):
            return StructType([StructField("id", StringType(), True)])
        # add my name to recursion list for later
        my_nesting_list: List[str] = nesting_list + ["SubstanceDefinition_Code"]
        my_parent_path = (
            parent_path + ".substancedefinition_code"
            if parent_path
            else "substancedefinition_code"
        )
        schema = StructType(
            [
