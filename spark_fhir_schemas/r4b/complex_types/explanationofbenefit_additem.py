...
class ExplanationOfBenefit_AddItemSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.r4b.complex_types.explanationofbenefit_detail1 import (
        ...
        my_parent_path = (
            parent_path + ".explanationofbenefit_additem"
            if parent_path
            else "explanationofbenefit_additem"
        )
        schema = StructType(
            [
