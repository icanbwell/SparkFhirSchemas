...
class TestScript_MetadataSchema:
    ...
    def get_schema(
        ...
        """
        from spark_fhir_schemas.stu3.complex_types.testscript_link import TestScript_LinkSchema
        from spark_fhir_schemas.stu3.complex_types.testscript_capability import TestScript_CapabilitySchema
        if (
