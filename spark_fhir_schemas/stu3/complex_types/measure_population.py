...
class Measure_PopulationSchema:
    """
    ...
    def get_schema(
        ...
        identifier: A unique identifier for the population criteria. This identifier is used to
        ...
        criteria: The name of a valid referenced CQL expression (may be namespaced) that defines
