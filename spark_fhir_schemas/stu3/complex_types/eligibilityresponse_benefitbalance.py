...
class EligibilityResponse_BenefitBalanceSchema:
    """
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.stu3.complex_types.eligibilityresponse_financial import EligibilityResponse_FinancialSchema
        if (
            max_recursion_limit
            and nesting_list.count("EligibilityResponse_BenefitBalance") >=
            max_recursion_limit
        ...
        schema = StructType(
            [
                ...
                StructField(
                    "financial",
                    ArrayType(
                        EligibilityResponse_FinancialSchema.get_schema(
                            max_nesting_depth=max_nesting_depth,
                            nesting_depth=nesting_depth + 1,
                            nesting_list=my_nesting_list,
                            max_recursion_limit=max_recursion_limit,
