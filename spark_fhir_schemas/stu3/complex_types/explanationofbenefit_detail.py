...
class ExplanationOfBenefit_DetailSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.stu3.complex_types.explanationofbenefit_subdetail import ExplanationOfBenefit_SubDetailSchema
        if (
            max_recursion_limit
            and nesting_list.count("ExplanationOfBenefit_Detail") >=
            max_recursion_limit
