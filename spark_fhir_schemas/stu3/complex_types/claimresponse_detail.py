...
class ClaimResponse_DetailSchema:
    ...
    def get_schema(
        ...
        from spark_fhir_schemas.stu3.complex_types.claimresponse_subdetail import ClaimResponse_SubDetailSchema
        if (
            max_recursion_limit and
            nesting_list.count("ClaimResponse_Detail") >= max_recursion_limit
